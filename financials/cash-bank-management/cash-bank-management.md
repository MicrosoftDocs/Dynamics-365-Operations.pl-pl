---
title: "Strona główna modułu Zarządzanie gotówką i bankami"
description: "Moduł Zarządzanie gotówką i bankami służy do obsługi kont bankowych firmy i instrumentów finansowych skojarzonych z tym kontami."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: index-page
...
-   [Akredytywy i inkasa eksportowe](letters-of-credit-import-collections.md)
-   [Poręczenie](letters-of-guarantee.md)
-   [Zaawansowanego uzgodnienia konta bankowego — omówienie](advanced-bank-reconciliation-overview.md)
...
-   [Konfigurowanie reguł uzgadniania wyciągów bankowych](set-up-bank-reconciliation-matching-rules.md)
...
-   [Scenariusz: Obsługa rabatu gotówkowego dla nadpłaty](../cash-bank-management/cash-discount-handling-overpayments.md)

...
| **Pole**                             | **Opis**             |
|---------------------------------------|--------------------------------------------------------------------------------------|
|**Minimalna liczba godzin dla diety**           | Umożliwia wprowadzenie minimalnej liczby godzin, które pracownik musi przepracować w ciągu dnia, aby kwalifikować się do otrzymania diety na wydatki związane z wyjazdem.                                                                                      |

...
## <a name="setup-pages-for-accounts-payable"></a>Ustawienia strony dla rozrachunków z dostawcami
...
## <a name="optional-setup-pages-for-accounts-payable"></a>Instalacja opcjonalna stron dla rozrachunków z dostawcami
...
-   Na stronie grupy dostawców opłaty za tworzenie i Obsługa grup opłat dla dostawców.
...
-   Na **pola formularza 1099** strony, sprawdzić i zaktualizować minimalnych kwot, które należy podać do wewnętrznych przychodów Service (IRS), oparte na najnowszymi wymaganiami urzędu Skarbowego.

## <a name="optional-setup-for-other-modules"></a>**Instalacja opcjonalna dla innych modułów**

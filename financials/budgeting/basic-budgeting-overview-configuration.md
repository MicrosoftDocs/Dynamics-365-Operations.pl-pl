...
description: "Prawie każda firma, która używa funkcji finansowych w programie Microsoft Dynamics 365 for Operations, będzie musiała mieć możliwość tworzenia raportów porównujących kwoty budżetowe z rzeczywistymi. Ten artykuł wyjaśnia minimalną konfigurację niezbędną do tworzenia budżetów w programie Dynamics 365 for Operations lub ich wczytywania z innych programów."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Istnieje wiele metod tworzenia wpisów do rejestru budżetu w programie Dynamics 365 for Operations:

...
description: "Ten artykuł zawiera omówienie funkcji autoryzacji kart kredytowych w systemie Microsoft Dynamics AX. Znajdują się tu informacje o konfigurowaniu usługi płatności, dodawaniu karty kredytowej do zamówienia sprzedaży oraz o unieważnianiu autoryzacji."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article

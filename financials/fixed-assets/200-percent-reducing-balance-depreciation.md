...
Opcja **Kalendarzowy** aktualizuje podstawę amortyzacji w dniu 1 stycznia każdego roku. Amortyzacja jest zazwyczaj wartość księgową netto minus wartość likwidacji. W poniższych przykładach podstawa amortyzacji stanowi kolejny numer w pierwszym wyrażeniu w obliczeniach w kolumnie Obliczenia. 
...
> [!NOTE] 
> Zazwyczaj, gdy kwota, która jest obliczana przy użyciu 200% zmniejszenie metody amortyzacji degresywnej staje się mniej niż kwota, która może być obliczona za pomocą metody liniowej jest konwersja do metody liniowej za pozostały okres użytkowania.

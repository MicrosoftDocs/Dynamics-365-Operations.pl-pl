...
Jak sprawdzić, czy występują duplikaty rekordów?
...
## Czy można zbiorczo dodać lub usunąć rekordy stron z książki adresowej?
...
## Czy można zmienić typ rekordu strony czy też należy usunąć stary rekord i utworzyć nowy?
...
## Jak zmienić nazwę adres rekordu strony?
...
## Czy można scalić dwa lub więcej rekordów stron w jeden rekord?
...
## Czy należy utworzyć rekord strony w globalnej książce adresowej lub w innym miejscu, takim jak strony Odbiorca lub Dostawca?
...
## Czy można tłumaczyć informacje adresowe dla rekordów stron?

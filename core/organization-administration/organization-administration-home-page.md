...
description: "W tym temacie wymieniono zasoby, które pomogą korzystać z rozwiązania Microsoft Dynamics 365 for Operations w organizacji."
author: sericks007
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
W tym temacie wymieniono zasoby, które pomogą korzystać z rozwiązania Microsoft Dynamics 365 for Operations w organizacji.

<a name="number-sequences"></a>Sekwencje identyfikatorów
----------------

-   [Przegląd sekwencji numerów](number-sequence-overview.md)

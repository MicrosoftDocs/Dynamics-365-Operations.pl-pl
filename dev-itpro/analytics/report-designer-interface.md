...
| Wyświetl raport                       | Otwórz najbardziej aktualną wersję wygenerowany raport w usłudze Dynamics 365 dla operacji. To polecenie jest dostępne z definicji raportu po wygenerowaniu co najmniej jednego raportu.                                 |
...
| Importuj hierarchię zestawu wymiarów         | Otwieranie okna dialogowego **Hierarchia zestawu wymiarów**, w których można importować hierarchię zestawu wymiarów z danych finansowych. To polecenie jest dostępne z definicji drzewa raportowania dla... \financial-dimensions\dimension-based system.  |
...
| Polecenie | opis                                                  |
|---------|--------------------------------------------------------------|
| Pomoc    | Otwórz 365 Dynamics dla operacji pomocy strona typu wiki w sprawozdawczości finansowej. |
|         |                                                              |
...
| Przycisk                                                                                                                                                                                   | Opis                                                                                                                                                                            |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [![New button](./media/rowc130389.png)](./media/rowc130389.png)                              | Utwórz nową (pustą) definicję raportu, definicję wiersza, definicję kolumny lub definicję drzewa raportowania.                                                                               |
...
| [![Wstawianie przycisku wiersz](./media/insertrowc130389.png)](./media/insertrowc130389.png)           | Wstawianie pustego wiersza na w definicji wiersza lub pustego wiersza nagłówka w definicji kolumny. Ten przycisk jest dostępny z definicji wiersza lub definicji kolumny.                    |
| [![Wstaw przycisk kolumny](./media/insertcolumnc130389.png)](./media/insertcolumnc130389.png)  | Wstawianie pustej kolumny w definicji kolumny. Ten przycisk jest dostępny z definicji kolumny.                                                                                  |
| [![Przycisk blokady](./media/lockc130389.png)](./media/lockc130389.png)                           | Umożliwia zabezpieczenie bieżącego bloku konstrukcyjnego hasłem. Ten przycisk jest dostępny dla użytkowników, którzy mają role **Projektant** lub **Administrator**.                                                 |
| [![Przycisk Połącz wiersz](./media/rowlinkc130389.png)](./media/rowlinkc130389.png)                 | Otwieranie okna dialogowego **Łącza wiersza**, w którym można określić źródła dla łącza danych w definicje wierszy i raportowania drzewa. Ten przycisk jest dostępny z definicji wiersza. |
| [![Wspieranie przycisku](./media/promotec130389.png)](./media/promotec130389.png)                  | Podnieś poziom jednostki w definicji drzewa raportowania. Po wybraniu jednostki podrzędnej i kliknięciu przycisku **Podnieś poziom** jednostka podrzędna jest przenoszona na ten sam poziom co jednostka nadrzędna.                |
| [![Obniż poziom przycisk](./media/demotec130389.png)](./media/demotec130389.png)                     | Obliż poziom jednostki raportowania drzewa definicji. Po wybraniu jednostki i kliknięciu przycisku **Obniż poziom** jednostka staje się podrzędna względem jednostka która jest przed nią.                               |
...
| [![Podkreślenie przycisku](./media/underlinec130389.png)](./media/underlinec130389.png)                            | Podkreśl bieżący tekst.                             |
...
| [![Przycisku kolor czcionki](./media/fontcolorc130389.png)](./media/fontcolorc130389.png)                           | Zmiana koloru bieżącego tekstu.                   |
...
| Przycisk                                                                                                                                                                                          | Opis                                                                                                                                                                  |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [![Przycisk definicji raportu](./media/reportc130389.png)](./media/reportc130389.png)                 | Wyświetlanie definicji raportu, która jest wyświetlana w menu **Okno**.                                                                                                            |
| [![Przycisk definicji wiersza](./media/rowc130389.png)](./media/rowc130389.png)                          | Umożliwia wyświetlenie definicji wiersza, która jest przypisana do definicji aktywnego raportu.                                                                                                    |
...
| [![Zgłoszenie przycisk definicji drzewo](./media/treec130389.png)](./media/treec130389.png)             | Umożliwia wyświetlenie definicji drzewa raportowania, która jest przypisana do definicji aktywnego raportu.                                                                                         |
| [![Przycisk Podgląd raportu](./media/reportviewerc130389.png)](./media/reportviewerc130389.png)         | Uruchom Report Viewer i pokaż najnowszą wersję generowanego raportu. Ten przycisk jest dostępny z definicji raportu po wygenerowaniu co najmniej jednego raportu. |
| [![Generowanie raportu przycisk](./media/generate-to-ddvc130389.png)](./media/generate-to-ddvc130389.png) | Generowanie raportu z definicji aktywnego raportu. Ten przycisk jest dostępny z definicji raportu.                                                                      |

...
---
# <a name="prepare-data-model-to-use-document-management-files-in-format-outputs-for-electronic-reporting-er"></a>Przygotowywanie modelu danych w celu używania plików zarządzania dokumentami w danych wyjściowych formatu na potrzeby raportowania elektronicznego (ER)
...
3. W polu Nazwa wpisz „Model faktur sprzedaży (niestandardowy)”.
    * Model faktur sprzedaży (niestandardowy)  

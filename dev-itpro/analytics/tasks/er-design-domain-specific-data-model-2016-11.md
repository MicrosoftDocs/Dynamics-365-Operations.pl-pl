...
---
# <a name="design-a-domain-specific-data-model-for-electronic-reporting-er"></a>Projektowanie modelu danych specyficznego dla domeny na potrzeby raportowania elektronicznego (ER)

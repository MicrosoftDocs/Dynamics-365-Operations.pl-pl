...
| Tworzenie i obsługa wydatków, które nie są dołączone do raportu z wydatków.    | Teraz można tworzyć wydatki i nimi zarządzać (na przykład przez dołączanie lub uszczegóławianie paragonów albo przypisywanie gości) bez uprzedniego utworzenia raportu z wydatków. Jeden lub więcej wydatków można wybrać i dodać do nowego raportu z wydatków w celu przesłania do zatwierdzenia. Nowa strona dla utrzymania kosztów jest dostępna w **wydatków za zarządzanie**&gt;**moje wydatki**&gt;**wydatki**.                                                                                                                                                                                                                                                       |
...
| Dostęp do pięciu nowych pakietów zawartości Power BI dla zasobów ludzkich                                     | Nowe pakiety zawartości umożliwiają organizacji i kadr zarządzających zasobami ludzkimi do analizowania następujące: kryteriów demograficznych • metryki pracowników według wieku, płci i stanu cywilnego • porównywanie wyczerpanie cena rok do roku i zobacz listy pracowników dały opuszczenia organizacji • widok listy otwartych pozycji, a także Porównanie otwartej do zamkniętej pozycji odszkodowania i korzyści • porównywanie co godzinę powodów i pracowników etatowych • umożliwia wyświetlanie liczby pracowników zarejestrowanych w dostępnych korzyści • widok pracowników według rodzaju zatrudnienia • Rekrutacja Analizuj kandydatów na podstawie liczby wnioskodawców, w przypadku gdy są one pochodzą z, i stanowiska, jakie ubiegają dla organizacji szkolenia • rejestracji kursu przez lokalizację • Dania frekwencji przez stan • Lista pracowników zarejestrowane kursy pracownika kompetencji i rozwoju • lista umiejętności posiadanych przez pracowników • podział typów umiejętności przez członka zespołu |
...
<td>Pozostałe LC banku Format alokacji opłat dla Arabii Saudyjskiej</td>
</tr>
<tr class="odd">
...
### <a name="personalized-product-recommendations"></a>Produkt spersonalizowane rekomendacje

| Co można zrobić                                                                                                                                                                                                                                                                        | Dlaczego to jest ważne                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Wyświetlanie spersonalizowanej o wielu wpisywanych znaków na sprzedaży (POS) do określenia przez klienta może być zainteresowany w oparciu o ich historii zakupów, elementy w ich życzeń i elementy, które inni klienci kupić online i w sklepach z cegły i zaprawy | Dla sprzedawców o dużych katalogów spersonalizowane rekomendacje pomocy klientom z odnajdywaniem produktu i upoważnić associates sklepu z clienteling inteligentne. Przez formacie prezentującym produkty ukierunkowane na klienta interesy i nawyki kupujących zalecenia produktów może pomóc sprzedawców detalicznych z opcję Sprzedaż proaktywna i może zwiększyć zatrzymania odbiorcy. W usłudze Dynamics 365 dla operacji - sprzedaż detaliczna, zalecenia produktu są zasilane przez usługi poznawcze i uczenie maszynowe Microsoft Azure. |
...
| Uzyskiwanie dodatkowych informacji o obsłudze konsygnacji w programie Dynamics 365 for Operations.                                                                                                         | Aby uzyskać więcej informacji na temat pomocy technicznej dla procesów przesyłki, zobacz [przesyłki](/dynamics365/operations/scm/inventory/consignment), [Konfigurowanie przesyłki](/dynamics365/operations/scm/inventory/set-up-consignment), [Tworzenie zamówienia zakupu uzupełniającego przesyłki (zadanie guide)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/), i [zmienić własność zapasów przesyłki oparte na zapotrzebowanie produkcyjne (zadanie guide)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
<tbody>
<tr class="odd">
<td>Definiowanie — bezpośrednio w wierszach zamówienia sprzedaży — źródła popytu i sposobu jego zaspokojenia. <strong>Przykład</strong> Utwórz wiersz zamówienia sprzedaży i określić jako typ dostawy Dostawa bezpośrednia. Główny dostawca zostanie dodany do wiersza zamówienia sprzedaży jako punkt pozyskiwania.</td>
...
<tr class="even">
<td>Tworzenie promesy zamówienia bezpośrednio z wierszy zamówienia sprzedaży. <strong>Przykład</strong> utworzyć wiersz zamówienia sprzedaży, który jest odczytywany z dostawcą międzyfirmowym. Wyjdź z wiersza. Daty dostaw zostaną obliczone na podstawie dostępności w firmie zaopatrującej.</td>

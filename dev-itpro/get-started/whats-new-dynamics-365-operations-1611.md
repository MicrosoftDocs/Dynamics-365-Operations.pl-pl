...
# Nowości i zmiany w programie Dynamics 365 for Operations w wersji 1611 (listopad 2016)
...
### Zaawansowane zarządzanie magazynem w sklepie sieci sprzedaży
...
### Korzystanie z bezproblemowego handlu wielokanałowego.
...
### Rejestrator zadań w punkcie sprzedaży
...
### System sklepu: zintegrowana funkcjonalność sklepu stacjonarnego
...
### Aplikacja Retail Modern POS na platformę uniwersalną systemu Windows
...
| Uzyskiwanie dodatkowych informacji o obsłudze konsygnacji w programie Dynamics 365 for Operations.                                                                                                         | Aby uzyskać więcej informacji o obsłudze procesów konsygnacji, zobacz tematy [Konsygnacja](/dynamics365/unified-operations/supply-chain/inventory/consignment), [Konfigurowanie konsygnacji](/dynamics365/unified-operations/supply-chain/inventory/set-up-consignment), [Tworzenie zamówienia uzupełnienia zapasów konsygnacyjnych (przewodnik po zadaniu)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/) i [Zmiana własności zapasów konsygnacyjnych w oparciu o zapotrzebowanie produkcyjne](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |

### Portal współpracy z dostawcami (znany wcześniej jako portal dostawców)
...
### Ulepszenia w obsłudze magazynu dla centów dystrybucyjnych o dużej przepustowości
...
### Ulepszenia w dziedzinie obsługi magazynu
...
### Drobne ulepszenia funkcji w module Zarządzanie łańcuchem dostaw

...
## <a name="pos--microsoft-dynamics-ax-retail"></a>POS – systemu Microsoft Dynamics AX sieci sprzedaży
|                                |                                                                                                                                                                                         |
|--------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Co można zrobić?**           | **Dlaczego to jest ważne?**                                                                                                                                                              |
...
|---------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Co można zrobić?**                                                | **Dlaczego to jest ważne?**                                                                                                                                                                                                                                                                                         |
| Odbudowa składniki danych aplikacji Raportowanie finansowe.                          | Podczas przenoszenia baz danych systemu Dynamics AX między środowiskiem lub wprowadzić inne zmiany inwazyjność w środowisku bazy danych raportowania finansowego może wymagają przebudowania. Skrypt programu Windows PowerShell znajduje się teraz, aby odbudować bazę danych.                                                                |
| Nie można już wybierać nieprawidłowych opcji projektanta raportów. | Niektóre opcje projektanta raportów, które były używane w lokalnych wersjach programu Management Reporter, nie mają zastosowania w tej wersji systemu Dynamics AX. Opcje te dotyczyły projekt raportu finansowego, danych wyjściowych i łączenie. Opcje te zostały usunięte z projektant raportu finansowego, aby zapobiec błędom użytkowników. |
...
| Obliczyć oddzielne poziomy BOM-ów do planowania zasobów materiałowych i kosztów obliczenia: • planowania zasobu materiałowego, poziomy BOM są obliczane w nowym **ReqItemLevel** tabeli. Zakończone zlecenia produkcyjne są ignorowane w obliczeniach. • W przypadku kosztów produkcji poziomy BOM są obliczane w tabeli **InventTable**. Zakończone zlecenia produkcyjne są uwzględniane w obliczeniach. | • Podczas planowania zasobów materiałowych, na przykład tworzenia i rozwijania planu w ramach planowania głównego, konieczność ponownego obliczania istnieje tylko dla poziomów BOM używanych do planowania zasobów materiałowych. Innymi słowy nie trzeba obliczać poziomów BOM używanych do obliczania wyceny produkcji. • Podczas operacji wyceny, na przykład w celu zamknięcia magazynu, trzeba ponownie obliczać tylko poziomy BOM używane do obliczania wyceny produkcji. |
...
[Nowe lub zaktualizowane zadanie linie pomocnicze (maja 2016)](new-updated-task-guides-available-may-2016.md)

---
title: Co to jest nowe lub zmienione w Dynamics AX 7.0 (luty 2016)
...
# <a name="whats-new-or-changed-in-dynamics-ax-70-february-2016"></a>Co to jest nowe lub zmienione w Dynamics AX 7.0 (luty 2016)
...
| Automatyczne kompilowanie, testowanie i wdrażanie.                                                                            | Dostępne częściowo                                                                                                                                                                                | Do wdrażania topologii dla deweloperów służą wirtualne maszyny do programowania i kompilacji. Automatyczne konfigurowanie wirtualnej maszyny kompilacji do wykrywania, tworzenia modułów z programu Visual Studio Online (VSO) i testowania. C\# i moduł kompilacji kodu X ++ i odwołania są obsługiwane. | Zwiększa to wydajność pracy deweloperów poprzez zmniejszenie kosztów i nakładów pracy do testowania i weryfikacji.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| Korzystanie z programu Business Connector to tworzenia logiki biznesowej i obsługi scenariuszy integracji.         | Program business connector jest dostępny dla wywołania wewnątrz kodu X ++ z kodu zarządzanego. Zaleca się używać programu business connector tylko do autora logiki biznesowej w C\#, a nie dla scenariuszy integracji. | Business Connector nie jest już obsługiwany. Funkcja tworzenia jest zapewniania dzięki wkompilopwaniu X ++ do kodu zarządzanego. To ułatwia międzyoperacyjność. Scenariusze integracji są realizowane za pomocą OData.       | Od teraz nie można już korzystać z Business Connector.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
<td>Nowa strona **Eksplorator źródeł księgowania** oraz opcje przechodzenia do niej ze strony listy **Bilans próbny** i strony **Transakcje na załączniku**.</td>
...
<td>Opcje raportu dodano tak, że różne filtry mogą być stosowane, gdy użytkownik wyświetla raport. Nowy raport jest następnie generowany w oparciu tych filtrów.</td>
...
<td>Analizowanie danych finansowych za pomocą zawartości "Monitorowanie wyników finansowych" Power BI.</td>
<td>Niedostępne</td>
...
<td>System pomocy w bieżącej wersji systemu Dynamics AX służy do wyświetlania przewodników po zadaniach zapisanych w Microsoft Dynamics Lifecycle Services (LCS) BPM. System pomocy wyświetla też tematy z zasobów Wiki firmy Microsoft. Aby uzyskać więcej informacji, zobacz [pomoc Dynamics AX — wprowadzenie do](help-overview.md) i [nowego zadania przewodniki dostępne (luty 2016)](new-task-guides-available-february-2016.md).</td>
...
<td>Funkcja został zaimplementowany jako elektroniczne konfiguracji raportowania. Ta funkcjonalność jest dostępna w Niemczech i Austrii.</td>
...
<td>Zestawienie bilansowe z grupy konta sumy raportu jest zaimplementowany jako raportu SSRS (LedgerAccountSum\_FR).</td>
...
<td>Odrębny wykaz kodów asortymentu Intrastat są scalane z hierarchii produktów typu kod towaru.</td>
...
<td>Kod asortymentu Intrastat ma pole tekstowe do identyfikacji dodatkowych jednostek i wytwarzanie produktu ** karta ma pole do identyfikowania liczba dodatkowych jednostek w kilogramach.</td>
...
<tr class="even">
<td>Wykonywanie inteligentnych analiz za pomocą raportów BI z poziomu Microsoft Dynamics AX i aplikacji klienckiej w punkcie sprzedaży.</td>
...
<tr class="odd">
<td>Analizować dane o sprzedaży detalicznej kanału za pomocą zawartości Power BI "Performance Monitor kanału sprzedaży detalicznej".</td>
<td>Niedostępne</td>
...
<li>Oferuje on pakietów "gotowe" dostawy alternatywnych, takich jak kombinacja witryny/składu/wariantu/środka transportu, na podstawie najszybszy kryterium dostawy (data najwcześniejszej dostępności) użytkownik może wybrać spośród.</li>

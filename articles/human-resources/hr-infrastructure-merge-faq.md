...
- Te zmiany eliminują zamieszanie powodowane przez wiele zestawów funkcji zasobów ludzkich (HR) w Dynamics 365.
...
- Zapewniają spójność między Dynamics 365 Human Resources a innymi aplikacjami Finanse i Działania w zakresie zarządzania cyklem życia aplikacji (ALM), usług Microsoft Dynamics Lifecycle Services (LCS), dostępności geograficznej, rozszerzalności i nie tylko.
- Umożliwiają one korzystanie z usług współdzielonych i narzędzi oraz pomagają obniżyć koszty.

### <a name="my-organization-uses-the-human-resources-module-in-dynamics-365-finance-supply-chain-management-commerce-or-project-operations-what-benefits-will-we-see-from-these-changes"></a>Moja organizacja używa modułu Human Resources w Dynamics 365 Finance, Supply Chain Management, Commerce lub Project Operations. Jakie korzyści odniesiemy z tych zmian?
...
### <a name="how-does-this-change-affect-me-if-i-am-an-existing-customer-and-i-use-both-the-hr-module-on-the-finance-and-operations-infrastructure-and-dynamics-365-human-resources-through-custom-integrations"></a>Jak ta zmiana wpłynie na mnie, jeśli jestem istniejącym klientem i używam zarówno modułu HR w infrastrukturze Finanse i Działania, jak i Dynamics 365 Human Resources poprzez niestandardowe integracje?

Niestandardowe integracje między Dynamics 365 Human Resources a modułem HR w Dynamics 365 Finance nie będą już wymagane. Wszystkie dane HR będą znajdowały się w tej samej bazie danych, co inne aplikacje Finanse i Działania.

## <a name="migration-from-dynamics-365-human-resources-to-finance-and-operations-apps"></a>Migracja z systemu Dynamics 365 Human Resources do rozwiązania Finanse i Działania
...
Jeśli Twoja organizacja korzysta zarówno z Dynamics 365 Human Resources, jak i innych aplikacji Finanse i Działania, należy zaplanować więcej czasu na weryfikację, aby upewnić się, że dane są poprawnie migrowane do nowego środowiska. Migracja do nowej infrastruktury spowoduje scalenie danych ze środowiska Human Resources ze środowiskiem Finanse i Działania. Dane powodujące konflikt będą wymagać danych wejściowych użytkownika, aby określić, jak konflikt powinien zostać rozwiązany. Użytkownicy i administratorzy będą musieli zarządzać mapowaniami danych tam, gdzie występują konflikty i testować migrację w środowiskach piaskownicy przed migracją środowisk produkcyjnych.

### <a name="my-organization-uses-the-human-resources-module-in-dynamics-365-finance-supply-chain-management-commerce-or-project-operations-what-do-we-have-to-plan-for-to-migrate-to-the-new-experience"></a>Moja organizacja używa modułu Human Resources w Dynamics 365 Finance, Supply Chain Management, Commerce lub Project Operations. Co musimy zaplanować, aby przejść na nowe środowisko?

W przypadku organizacji, które korzystają z modułu HR w aplikacjach Finanse i Działania, nowa funkcja z Dynamics 365 Human Resources zostanie zastosowana w Twoim środowisku za pośrednictwem standardowego procesu aktualizacji jednej wersji. Możesz spodziewać się pojawienia się nowej funkcjonalności w swoim środowisku, gdy będzie ona dostępna w każdej aktualizacji. Nowe funkcje można włączać za pomocą zarządzania funkcjami, ale należy planować sprawdzanie ich poprawności. Postępuj zgodnie z istniejącymi procesami sprawdzania poprawności innych aktualizacji środowiska. Aby uzyskać więcej informacji o sposobie stosowania aktualizacji do aplikacji Finanse i Działania, zobacz [Omówienie jednej wersji](../fin-ops-core/dev-itpro/lifecycle-services/oneversion-overview.md).
...
- Organizacje, które obecnie korzystają z modułu HR w aplikacjach Finanse i Działania, otrzymają funkcje HR Dynamics 365 Human Resources w ramach zwykłego procesu aktualizacji jednej wersji. Planujemy, że nowe funkcje będą ogólnie dostępne od stycznia 2022 r.
- Organizacje, które używają tylko Dynamics 365 Human Resources, będą miały dostęp do narzędzi do migracji, dzięki czemu będą mogły rozpocząć testowanie i rozpocząć migrację począwszy od połowy 2022 roku. Data, do której migracja do nowej infrastruktury musi zostać zakończona, nie została jeszcze ustalona. Jednak minie co najmniej rok od daty udostępnienia narzędzi do migracji.
- Organizacje, które obecnie używają zarówno Dynamics 365 Human Resources, jak i innych aplikacji Finanse i Działania, będą miały dostęp do narzędzi do migracji, dzięki czemu będą mogły rozpocząć testowanie i rozpocząć migrację od końca 2022 roku. Data, do której migracja do nowej infrastruktury musi zostać zakończona, nie została jeszcze ustalona. Jednak minie co najmniej rok od daty udostępnienia narzędzi do migracji.
...
### <a name="my-organization-has-not-yet-gone-live-on-dynamics-365-human-resources-should-we-go-live-with-the-human-resources-module-in-the-finance-and-operations-apps-or-with-the-dynamics-365-human-resources-app-on-the-legacy-infrastructure"></a>Moja organizacja nie korzysta jeszcze z Dynamics 365 Human Resources w środowisku produkcyjnym. Czy możemy używać modułu Human Resources w środowisku produkcyjnym w aplikacjach Finanse i Działania lub z aplikacją Dynamics 365 Human Resources w infrastrukturze starego typu?

Ważne elementy, które należy uwzględnić, to, jakie funkcje HR są potrzebne, i kiedy te funkcje będą dostępne w nowej infrastruktury. Jeśli organizacja wymaga podstawowych funkcji zarządzania pracownikami, które są obecnie dostępne w module HR aplikacji Finanse i Działania w nowej infrastrukturze. Równoważność funkcji między modułem HR w aplikacjach Finanse i Działania i aplikacji Dynamics 365 Human Resources jest oczekiwana w wersji 10.0.25, która ma być ogólnie dostępna w marcu 2022. Funkcje integracji, takie jak integracja aplikacji Teams i jednostek Dataverse, będą dostępne w kolejnych wersjach.

Jeśli funkcje HR potrzebne organizacji będą dostępne w nowej infrastruktury w czasie, w którym organizacja będzie przenosiła je do środowiska produkcyjnego, może być łatwiej wprowadzić moduł Human Resources do środowiska produkcyjnego w aplikacjach Finanse i Działania. Ułatwi to migrację, ponieważ będzie to standardowe uaktualnienie aplikacji do aplikacji Dynamics 365 Human Resources i użytkownik już będzie w nowej infrastrukturze. Jeśli organizacja zdecyduje się na wdrożenie do środowiska produkcyjnego Dynamics 365 Human Resources na infrastrukturze starego typu, do przejścia na nową infrastrukturę będzie potrzebna migracja środowiska. Aby tego uniknąć, należy przeprowadzić wdrożenie do środowiska produkcyjnego na nowej infrastrukturze.
...
Tak, wszystkie moduły Dynamics 365 Human Resources będą działać bez zmian w aplikacjach Finanse i Działania i będzie mieć 100-procentową parzystość funkcji. W ramach ogólnej strategii migracji dla klientów, którzy obecnie korzystają z tych funkcji w dziale HR, dane klientów zostaną zmigrowane, aby nadal działały w infrastrukturze Finanse i Działania.

### <a name="i-use-the-new-dynamics-365-human-resources-benefits-management-capabilities-ive-built-custom-integrations-with-the-hr-module-on-the-finance-and-operations-infrastructure-so-that-i-can-take-advantage-of-the-payroll-capabilities-by-using-benefits-data-will-these-custom-integrations-be-required-going-forward"></a>Korzystam z nowych możliwości zarządzania korzyściami Dynamics 365 Human Resources. Zbudowałem niestandardowe integracje z modułem HR w infrastrukturze Finanse i Działania, dzięki czemu mogę korzystać z funkcji płacowych przy użyciu danych dotyczących świadczeń. Czy te niestandardowe integracje będą wymagane w przyszłości?

W ramach scalania infrastruktury dane zasobów ludzkich są wprowadzane do tej samej bazy danych co inne aplikacje Finanse i Działania. Integracja między modułami w aplikacjach Finanse i Działania nie będzie już wymagana.
...
Nie, integracja LinkedIn Talent Hub nie będzie działać po migracji do nowej infrastruktury. Usługa integracji LinkedIn Talent Hub zostanie wycofana wraz ze starszą infrastrukturą Dynamics 365 Human Resources.
...
### <a name="we-are-using-data-integrator-to-move-data-between-dynamics-365-human-resources-and-finance-and-operations-apps-how-will-the-data-that-is-currently-being-integrated-be-affected"></a>Używamy integratora danych do przenoszenia danych między Dynamics 365 Human Resources i aplikacjami Finanse i Działania. W jaki sposób będzie to dotyczyć danych, które są obecnie integrowane?

Dane HR, które obecnie znajdują się w Dynamics 365 Human Resources są synchronizowane z Dataverse. Integrator danych może być następnie używany do synchronizacji jednokierunkowej z aplikacjami Finanse i Działania. Po migracji do nowej infrastruktury dane HR będą natywne dla aplikacji Finanse i Działania. Integrator danych nie będzie już wymagany do synchronizowania danych między aplikacjami Finanse i Działania i Human Resources.
...
Zależy to od punktu końcowego integracji. Aby uzyskać więcej informacji o technologiach integracji dostępnych w aplikacjach Finanse i Działania oraz o tym, jak wybrać najlepszą technologię integracji, zobacz [Omówienie integracji](../fin-ops-core/dev-itpro/data-entities/integration-overview.md).
...
Jeśli środowiska Dynamics 365 Human Resources oraz Finanse i Działania, które zostaną połączone w środowisku nowej infrastruktury, są połączone z tym samym środowiskiem Dataverse, po migracji obie aplikacje będą nadal połączone z tym samym środowiskiem Dataverse. Migracja nie będzie wymagana dla żadnych rozszerzeń Dataverse.

Jeśli jednak środowiska Dynamics 365 Human Resources i Finanse i Działania są obecnie połączone z oddzielnymi środowiskami Dataverse, oba środowiska Dataverse będą musiały zostać połączone tak, aby były połączone z jednym środowiskiem w nowej infrastrukturze. W przypadku tej migracji Dataverse tabele Dataverse, które są standardem w rozwiązaniach HR, można połączyć i ponownie zsynchronizować z nowym środowiskiem Dataverse. Żadne rozszerzenia do środowiska Dataverse nie będą migrowane automatycznie, ale muszą zostać ponownie wdrożone w nowym środowisku. Zalecamy korzystanie z zarządzanych rozwiązań do zarządzania rozszerzeniami Dataverse. Aby uzyskać więcej informacji, zobacz [Wprowadzenie do rozwiązań](/powerapps/developer/data-platform/introduction-solutions).

### <a name="we-have-utilized-the-custom-field-functionality-within-dynamics-365-human-resources-will-those-custom-fields-migrate-automatically"></a>Korzystaliśmy z funkcji pól własnych w Dynamics 365 Human Resources, czy te pola będą migrowane automatycznie?
Tak, pola niestandardowe, które zostały dodane, zostaną przeniesione do nowej infrastruktury.
...
Oczekuje się, że podczas migracji środowisko Human Resources zwykle pozostanie w tym samym regionie platformy Azure. Jedyny wyjątek występuje wtedy, gdy środowisko Human Resources zostanie scalone ze środowiskiem Finanse i Działania znajdującym się w innym regionie. W takim przypadku środowisko Human Resources zostanie zmigrowane do regionu platformy Azure środowiska Finanse i Działania.
...
Integracja z Ceridian zostanie przeniesiona do integracji opartej na Payroll API. Integracja oparta na plikach, która obecnie istnieje w Dynamics 365 Human Resources, nie zostanie zmigrowana do infrastruktury Finanse i Działania. Aby uzyskać więcej informacji, zobacz [Wprowadzenie interfejsu API listy płac](./hr-admin-integration-payroll-api-introduction.md).
...
Migracja do nowej infrastruktury przeniesie zarządzanie Twoimi środowiskami Dynamics 365 Human Resources do projektu wdrożenia Finanse i Działania w LCS. Jeśli migracja scala Dynamics 365 Human Resources z istniejącym środowiskiem Finanse i Działania, Twój projekt Human Resources LCS zostanie scalony z projektem implementacji LCS dla aplikacji Finanse i Działania. Jeśli obecnie używasz tylko Dynamics 365 Human Resources, zostanie utworzony nowy projekt implementacji LCS, a Twój istniejący projekt Human Resources LCS zostanie przeniesiony do nowego projektu.

Nowy projekt będzie tego samego typu, z którego korzystają aplikacje Finanse i Działania. Będzie miał te same funkcje i funkcjonalność do zarządzania środowiskiem. Aby uzyskać więcej informacji, zobacz [Zasoby w Lifecycle Services (LCS)](../fin-ops-core/dev-itpro/lifecycle-services/lcs.md).
...
Zarówno opcje rozszerzalności Microsoft Power Platform, jak i opcje rozszerzalności Finanse i Działania będą dostępne i mogą być używane do programowania. Aby uzyskać więcej informacji, zobacz [Ipracowywanie i dostosowywanie strony głównej](../fin-ops-core/dev-itpro/dev-tools/developer-home-page.md).
...
Każdy eksport, który jest obecnie skonfigurowany dla usługi Azure Data Lake Storage w aplikacjach Finanse i Działania, zachowa tę samą konfigurację po migracji.
...
Tak. Dynamics 365 Human Resources zostanie uwzględniony w scalonej bazie kodów i infrastruktury aplikacji Finanse i Działania. Uaktualnienie z Dynamics AX 2012 do Dynamics 365 Human Resources będzie korzystać z tej samej ścieżki uaktualnienia i narzędzi, które są używane do uaktualniania do najnowszej wersji aplikacji Finanse i Działania.

...
description: Ten artykuł zawiera przykładowe zapytanie dotyczące jednostki Wniosek o rekrutację w Dynamics 365 Human Resources.
author: jaredha
ms.date: 02/05/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8858222"
---
# <a name="example-query-for-recruiting-request"></a>Przykładowa kwerenda dla wniosku o rekrutację
...
Ten artykuł zawiera przykładowe zapytanie dotyczące jednostki Wniosek o rekrutację w Dynamics 365 Human Resources.

Poniższe zapytanie pokazuje, jak można użyć opcji $ expand query w operacji GET w celu pobrania określonego rekordu żądania rekrutacyjnego oraz wszystkich powiązanych stanowisk, wymaganych umiejętności i wymagań edukacyjnych dla określonego żądania. Przykładowa odpowiedź przedstawia żądanie rekrutacji na dwa stanowiska oraz wymagane umiejętności i wykształcenie na żądanych stanowiskach.

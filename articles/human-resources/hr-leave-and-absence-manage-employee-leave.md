...
## <a name="adjust-leave-balances"></a>Korygowanie sald urlopu

1. W rekordzie pracownika wybierz pozycję **Urlop**.

2. Wybierz pozycję **Konfiguracja urlopów i nieobecności**.

3. Wybierz pozycję **Koryguj saldo**.

4. Wybierz **typ urlopu**.

5. Wprowadź **kwotę korekty**. 

6. Opcjonalnie możesz wybrać **datę**. 

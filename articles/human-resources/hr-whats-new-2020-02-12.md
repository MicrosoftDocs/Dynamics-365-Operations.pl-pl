...
## <a name="delete-employment-from-dataverse-doesnt-work-when-employment-details-arent-active-403193"></a>Usuwanie zatrudnienia z Dataverse nie działa, jeśli szczegóły zatrudnienia nie są aktywne (403193)

Dzięki tej zmianie można teraz usunąć zatrudnienie przez Dataverse, gdy nie istnieją aktywne szczegóły dotyczące zatrudnienia.
...
Aktualizacja platformy 32 będzie wkrótce dostępna. [Więcej informacji o aktualizacji platformy 32 znajdziesz tutaj](../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-32.md).

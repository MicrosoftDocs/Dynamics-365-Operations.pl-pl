...
Zmiany w platformie są uwzględniane w wydaniu z danego tygodnia. Aby uzyskać więcej informacji, zobacz temat [Aktualizacje platformy dla wersji 10.0.10 aplikacji Finance and Operations (maj 2020)](../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-34.md). Ta wersja zawiera poprawki usterek i zmiany w zapisanych widokach.

...
[Konfigurowanie wspólnych parametrów modułu Human Resources](hr-setup-shared-parameters.md)</br>
[Ustawianie przepływów pracy dla modułu zasobów ludzkich](hr-setup-workflows.md)</br>
[Rozumienie pól Data i Godzina](hr-setup-date-time-fields.md)</br>
...
[Rejestrowanie pracowników etatowych w systemie stałych wynagrodzeń](hr-compensation-enroll-employees-fixed.md)</br>
[Rejestrowanie pracowników etatowych w systemie wynagrodzeń o zmiennej wysokości](hr-compensation-enroll-employees-variable.md)</br>
...
[Zapisz pracowników na świadczenia](hr-benefits-enroll-workers.md)</br>
...
[Konfigurowanie parametrów urlopów i nieobecności](hr-leave-and-absence-parameters.md)</br>
[Tworzenie kalendarza czasu pracy](hr-leave-and-absence-working-time-calendar.md)</br>
[Tworzenie przepływu pracy wniosku urlopowego](hr-leave-and-absence-workflow.md)</br>
[Konfigurowanie typów urlopów i nieobecności](hr-leave-and-absence-types.md)</br>
[Tworzenie planu urlopów i nieobecności](hr-leave-and-absence-plans.md)</br>
[Przypisywanie pracowników do planu urlopów](hr-leave-and-absence-enroll.md)</br>
[Naliczanie do planów urlopów i nieobecności](hr-leave-and-absence-accrue.md)</br>
[Wyświetlanie analiz urlopów i nieobecności](hr-leave-and-absence-analytics.md)</br>
[Zarządzanie wnioskami urlopowymi](hr-employee-self-service-manage-requests.md)</br>
[Żądanie czasu wolnego](hr-employee-self-service-request-time-off.md)</br>
[Wyświetlanie kalendarzy zespołów i firmy](hr-employee-self-service-calendar.md)</br>

## <a name="develop-employees"></a>Rozwój pracowników
...
[Dodawanie wpisów do arkusza wydajności](hr-develop-add-performance-journal.md)</br>
...
[Konfigurowanie kursów szkoleniowych](hr-learning-courses.md)</br>
...
[Rozprowadzanie i planowanie kwestionariuszy](hr-learning-distribute-questionnaires.md)</br>
[Dystrybucja kwestionariuszy z wykorzystaniem harmonogramu](hr-learning-distribute-questionnaires-scheduling.md)</br>

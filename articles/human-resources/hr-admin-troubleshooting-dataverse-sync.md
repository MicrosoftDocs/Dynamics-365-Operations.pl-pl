...
description: W tym artykule opisano sposób rozwiązywania problemów z rekordami, które nie synchronizują się prawidłowo między Microsoft Dynamics 365 Human Resources a rozwiązaniem Human capital management (HCM) Common w Microsoft Dataverse.
author: jaredha
ms.date: 09/27/2021
ms.topic: article
ms.prod: ''

...
Ten artykuł zawiera listę tematów pomocy oraz innych zasobów w Microsoft Dynamics 365 Human resources. 

Wybierz obszar funkcji, aby dowiedzieć się więcej na jego temat.

- [Samoobsługa pracownika etatowego](hr-employee-manager-self-service-overview.md)
- [Zarządzanie pracownikami](hr-personnel-departments-jobs-positions.md)
- [Zarządzanie zadaniami](hr-task-mgmt.md)
- [Urlopy i nieobecności](hr-leave-and-absence-overview.md)
- [Świadczenia](hr-benefits-manage-program.md)
- [Zarządzanie świadczeniami](hr-benefits-management-overview.md)
...
Aby uzyskać informacje dotyczące programu Dynamics 365 Finance, zobacz stronę [główną Finance](../finance/index.md).

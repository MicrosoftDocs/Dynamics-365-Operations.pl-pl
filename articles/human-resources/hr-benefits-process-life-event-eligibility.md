...
description: W tym artykule opisano sposób przetwarzania uprawnień zdarzeń zmiany sytuacji życiowej.
author: twheeloc
ms.date: 08/23/2021
ms.topic: article
ms.prod: ''
...
W tym artykule opisano sposób przetwarzania uprawnień do zdarzeń zmiany sytuacji życiowej.
...
2. W oknie dialogowym **Uruchamianie procesu uprawnień do świadczenia z powodu zmiany sytuacji życiowej** określ wartości następujących pól:

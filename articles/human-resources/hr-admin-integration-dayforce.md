...
- <span data-ttu-id="a1f0c-111">Dane kadrowe</span><span class="sxs-lookup"><span data-stu-id="a1f0c-111">Human resources data</span></span>
...
<span data-ttu-id="a1f0c-127">Aby uzyskać więcej informacji o kontach magazynu w usłudze Azure i ciągach połączeń z usługą Azure Storage, zobacz następujące artykuły poświęcone usłudze Azure:</span><span class="sxs-lookup"><span data-stu-id="a1f0c-127">For more information about Azure storage accounts and Azure Storage connection strings, see the following Azure articles:</span></span>
...
## <a name="configure-your-data"></a><span data-ttu-id="a1f0c-141">Konfigurowanie danych</span><span class="sxs-lookup"><span data-stu-id="a1f0c-141">Configure your data</span></span> 
...
##### <a name="benefits"></a><span data-ttu-id="a1f0c-158">Świadczenia</span><span class="sxs-lookup"><span data-stu-id="a1f0c-158">Benefits</span></span>
...
<span data-ttu-id="a1f0c-187">Aby uzyskać więcej informacji o sposobie definiowania programu świadczeń i zarządzania nim, zobacz następujące artykuły:</span><span class="sxs-lookup"><span data-stu-id="a1f0c-187">For more information about how to define and manage a benefits program, see the following articles:</span></span>
...
- <span data-ttu-id="a1f0c-226">Cykl kalkulacji płac (wymagane)</span><span class="sxs-lookup"><span data-stu-id="a1f0c-226">Pay cycle (required)</span></span>
...
#### <a name="pay-cycles-and-pay-periods"></a><span data-ttu-id="a1f0c-241">Cykle płac i okresy płac</span><span class="sxs-lookup"><span data-stu-id="a1f0c-241">Pay cycles and pay periods</span></span>
...
#### <a name="earning-codes"></a><span data-ttu-id="a1f0c-257">Kody zarobków</span><span class="sxs-lookup"><span data-stu-id="a1f0c-257">Earning codes</span></span>
...
#### <a name="contact-information"></a><span data-ttu-id="a1f0c-296">Informacje o kontakcie</span><span class="sxs-lookup"><span data-stu-id="a1f0c-296">Contact information</span></span> 
...
- <span data-ttu-id="a1f0c-358">Podstawowy (wymagane)</span><span class="sxs-lookup"><span data-stu-id="a1f0c-358">Primary (required)</span></span>
...
- <span data-ttu-id="a1f0c-380">Podstawowy (wymagane)</span><span class="sxs-lookup"><span data-stu-id="a1f0c-380">Primary (required)</span></span>
...
<span data-ttu-id="a1f0c-421">Następujące kody przyczyn i opisy są wymagane.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-421">The following reason codes and descriptions are required.</span></span>
...
| <span data-ttu-id="a1f0c-458">Wdowiec/wdowa</span><span class="sxs-lookup"><span data-stu-id="a1f0c-458">Widowed</span></span>                | <span data-ttu-id="a1f0c-459">Wdowiec/wdowa</span><span class="sxs-lookup"><span data-stu-id="a1f0c-459">Widowed</span></span>              |
...
- <span data-ttu-id="a1f0c-486">EACHPAYPERIOD</span><span class="sxs-lookup"><span data-stu-id="a1f0c-486">EACHPAYPERIOD</span></span>
- <span data-ttu-id="a1f0c-487">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="a1f0c-487">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="a1f0c-488">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="a1f0c-488">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="a1f0c-489">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-489">1OFMTH</span></span>
- <span data-ttu-id="a1f0c-490">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-490">LASTOFMTH</span></span>
- <span data-ttu-id="a1f0c-491">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-491">2OFMTH</span></span>
- <span data-ttu-id="a1f0c-492">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-492">3OFMTH</span></span>
- <span data-ttu-id="a1f0c-493">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-493">4OFMTH</span></span>
- <span data-ttu-id="a1f0c-494">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-494">5OFMTH</span></span>
- <span data-ttu-id="a1f0c-495">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-495">1N2OFMTH</span></span>
- <span data-ttu-id="a1f0c-496">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-496">3N4OFMTH</span></span>
- <span data-ttu-id="a1f0c-497">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-497">1N3OFMTH</span></span>
- <span data-ttu-id="a1f0c-498">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-498">1N4OFMTH</span></span>
- <span data-ttu-id="a1f0c-499">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-499">2N3OFMTH</span></span>
- <span data-ttu-id="a1f0c-500">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-500">2N4OFMTH</span></span>
- <span data-ttu-id="a1f0c-501">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-501">1N2N3OFMTH</span></span>
- <span data-ttu-id="a1f0c-502">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-502">1N2N4OFMTH</span></span>
- <span data-ttu-id="a1f0c-503">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-503">1N3N4OFMTH</span></span>
- <span data-ttu-id="a1f0c-504">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-504">2N3N4OFMTH</span></span>
- <span data-ttu-id="a1f0c-505">1N2N3N4OFMTH – 1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-505">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="a1f0c-506">2N3N4N5OFMth – 2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="a1f0c-506">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="a1f0c-507">1OFQTR – 1OFQTR</span><span class="sxs-lookup"><span data-stu-id="a1f0c-507">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="a1f0c-508">LASTOFQTR – LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="a1f0c-508">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="a1f0c-509">LASTMTHOFQTR – LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="a1f0c-509">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="a1f0c-510">1OFYEAR – 1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="a1f0c-510">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="a1f0c-511">LASTOFYEAR – LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="a1f0c-511">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="a1f0c-512">NOVNDECOFYEAR – NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="a1f0c-512">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="a1f0c-513">Adresy</span><span class="sxs-lookup"><span data-stu-id="a1f0c-513">Addresses</span></span>

<span data-ttu-id="a1f0c-514">Identyfikacja określonych kodów kraju lub regionu, województwa i powiatu (gminy) wymaga określonych formatów, które potrafi rozpoznać system Dayforce oraz dostawcy wewnątrz krajów/regionów.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-514">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="a1f0c-515">Co prawda format nazw miejscowości jest elastyczny, ale każda miejscowość musi być skojarzona z województwem.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-515">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="a1f0c-516">Zasoby ludzkie</span><span class="sxs-lookup"><span data-stu-id="a1f0c-516">Human Resources</span></span>          | <span data-ttu-id="a1f0c-517">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a1f0c-517">Dayforce</span></span>              |
|-----------------|-----------------------|
| <span data-ttu-id="a1f0c-518">Kraj/region</span><span class="sxs-lookup"><span data-stu-id="a1f0c-518">Country/Region</span></span>  | <span data-ttu-id="a1f0c-519">Kod kraju</span><span class="sxs-lookup"><span data-stu-id="a1f0c-519">Country Code</span></span>          |
| <span data-ttu-id="a1f0c-520">Kod pocztowy</span><span class="sxs-lookup"><span data-stu-id="a1f0c-520">Zip/Postal Code</span></span> | <span data-ttu-id="a1f0c-521">Kod pocztowy</span><span class="sxs-lookup"><span data-stu-id="a1f0c-521">Postal Code</span></span>           |
| <span data-ttu-id="a1f0c-522">Stanowy</span><span class="sxs-lookup"><span data-stu-id="a1f0c-522">State</span></span>           | <span data-ttu-id="a1f0c-523">Kod województwa</span><span class="sxs-lookup"><span data-stu-id="a1f0c-523">State Code</span></span>            |
| <span data-ttu-id="a1f0c-524">Miejscowość</span><span class="sxs-lookup"><span data-stu-id="a1f0c-524">City</span></span>            | <span data-ttu-id="a1f0c-525">Miejscowość</span><span class="sxs-lookup"><span data-stu-id="a1f0c-525">City</span></span>                  |
| <span data-ttu-id="a1f0c-526">Powiat</span><span class="sxs-lookup"><span data-stu-id="a1f0c-526">County</span></span>          | <span data-ttu-id="a1f0c-527">Powiat (gmina)</span><span class="sxs-lookup"><span data-stu-id="a1f0c-527">County (Municipality)</span></span> |
| <span data-ttu-id="a1f0c-528">Ulica</span><span class="sxs-lookup"><span data-stu-id="a1f0c-528">Street</span></span>          | <span data-ttu-id="a1f0c-529">Wiersz adresu 1</span><span class="sxs-lookup"><span data-stu-id="a1f0c-529">Address Line 1</span></span>        |

### <a name="tax-regions"></a><span data-ttu-id="a1f0c-530">Regiony podatkowe</span><span class="sxs-lookup"><span data-stu-id="a1f0c-530">Tax regions</span></span>

<span data-ttu-id="a1f0c-531">Regiony podatkowe służą do określania odpowiedniej stawki podatkowej stosowanej podczas generowania listy płac.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-531">Tax regions are used to determine the appropriate tax that should be applied during payroll generation.</span></span> <span data-ttu-id="a1f0c-532">Regiony podatkowe są mapowane do systemu Dayforce jako adresy lokalizacji.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-532">Tax regions are mapped to Dayforce as location addresses.</span></span> <span data-ttu-id="a1f0c-533">Domyślny region podatkowy musi być skojarzony z aktywnym stanowiskiem pracownika.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-533">The default tax region must be associated with the worker's active position.</span></span> 

- <span data-ttu-id="a1f0c-534">Region podatkowy (wymagane)</span><span class="sxs-lookup"><span data-stu-id="a1f0c-534">Tax region (required)</span></span>
- <span data-ttu-id="a1f0c-535">Kraj/region (wymagane)</span><span class="sxs-lookup"><span data-stu-id="a1f0c-535">Country/Region (required)</span></span>
- <span data-ttu-id="a1f0c-536">Województwo (wymagane)</span><span class="sxs-lookup"><span data-stu-id="a1f0c-536">State (required)</span></span>
- <span data-ttu-id="a1f0c-537">Powiat</span><span class="sxs-lookup"><span data-stu-id="a1f0c-537">County</span></span> 
- <span data-ttu-id="a1f0c-538">Miejscowość (wymagane)</span><span class="sxs-lookup"><span data-stu-id="a1f0c-538">City (required)</span></span>

## <a name="configure-your-data-to-generate-payroll-in-mexico"></a><span data-ttu-id="a1f0c-539">Konfigurowanie danych w celu generowania listy płac w Meksyku</span><span class="sxs-lookup"><span data-stu-id="a1f0c-539">Configure your data to generate payroll in Mexico</span></span>

<span data-ttu-id="a1f0c-540">Jeśli generujesz płace dla pracowników na terenie Meksyku, należy skonfigurować następujące elementy:</span><span class="sxs-lookup"><span data-stu-id="a1f0c-540">If you're generating pay for employees in Mexico, the following elements must be configured:</span></span>

- <span data-ttu-id="a1f0c-541">Dla stanowisk muszą być określone działy.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-541">Departments are required on positions.</span></span>
- <span data-ttu-id="a1f0c-542">Centra kosztów muszą być ustawione jako wymiary finansowe i muszą być pierwszym elementem w ciągu domyślnych wymiarów finansowych.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-542">Cost centers must be set as financial dimensions and must be the first element in the Default Financial Dimension string.</span></span>

### <a name="job-types"></a><span data-ttu-id="a1f0c-543">Typy stanowisk</span><span class="sxs-lookup"><span data-stu-id="a1f0c-543">Job types</span></span>

<span data-ttu-id="a1f0c-544">Typy funkcji służą do grupowanie podobnych funkcji w kategorie.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-544">Job types are used to group similar jobs into categories.</span></span> <span data-ttu-id="a1f0c-545">Typy funkcji są wymagane w celu przetwarzania listy płac w Meksyku.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-545">Job types are required in order to process payroll in Mexico.</span></span> <span data-ttu-id="a1f0c-546">Przykłady typów funkcji to zatrudnienie w pełnym i niepełnym wymiarze czasu albo wynagrodzenie za etat i za godziny.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-546">Examples of job types include full-time and part-time, or salary and hourly pay.</span></span> <span data-ttu-id="a1f0c-547">Typy funkcji są mapowane do systemu Dayforce jako typy płac, które wskazują, czy pracownik jest na stawce godzinowej, czy stałej pensji.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-547">Job types are mapped to Dayforce as pay types that indicate whether an employee is hourly or salaried.</span></span>

<span data-ttu-id="a1f0c-548">Następujące typy funkcji i opisy są wymagane.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-548">The following job types and descriptions are required.</span></span>

| <span data-ttu-id="a1f0c-549">Typ funkcji</span><span class="sxs-lookup"><span data-stu-id="a1f0c-549">Job type</span></span>   | <span data-ttu-id="a1f0c-550">opis</span><span class="sxs-lookup"><span data-stu-id="a1f0c-550">Description</span></span> |
|------------|-------------|
| <span data-ttu-id="a1f0c-551">Co godzinę</span><span class="sxs-lookup"><span data-stu-id="a1f0c-551">Hourly</span></span>     | <span data-ttu-id="a1f0c-552">MX Co godzinę</span><span class="sxs-lookup"><span data-stu-id="a1f0c-552">MX Hourly</span></span>   |
| <span data-ttu-id="a1f0c-553">Stała pensja</span><span class="sxs-lookup"><span data-stu-id="a1f0c-553">Salaried</span></span>   | <span data-ttu-id="a1f0c-554">MX Stała pensja</span><span class="sxs-lookup"><span data-stu-id="a1f0c-554">MX Salaried</span></span> |

### <a name="position-types"></a><span data-ttu-id="a1f0c-555">Typy stanowisk</span><span class="sxs-lookup"><span data-stu-id="a1f0c-555">Position types</span></span> 

<span data-ttu-id="a1f0c-556">Typy stanowisk służą do opisywania, czy stanowisko jest w pełnym wymiarze czasu, niepełnym wymiarze czasu lub ma inną konfigurację.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-556">You use position types to describe whether the position is full-time, part-time, or something else.</span></span> <span data-ttu-id="a1f0c-557">Typy stanowisk są mapowane do systemu Dayforce jako klasy płac, które wskazują, czy pracownik jest zatrudniony na pełny etat, czy na część etatu.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-557">Position types are mapped to Dayforce as pay classes that indicate whether an employee is full-time or part-time.</span></span>

<span data-ttu-id="a1f0c-558">Następujące typy stanowisk i opisy są wymagane.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-558">The following position types and descriptions are required.</span></span>

| <span data-ttu-id="a1f0c-559">Typ stanowiska</span><span class="sxs-lookup"><span data-stu-id="a1f0c-559">Position type</span></span>   | <span data-ttu-id="a1f0c-560">opis</span><span class="sxs-lookup"><span data-stu-id="a1f0c-560">Description</span></span>        |
|-----------------|--------------------|
| <span data-ttu-id="a1f0c-561">Pełny etat</span><span class="sxs-lookup"><span data-stu-id="a1f0c-561">Full-time</span></span>       | <span data-ttu-id="a1f0c-562">Pracownik etatowy zatrudniony w pełnym wymiarze czasu</span><span class="sxs-lookup"><span data-stu-id="a1f0c-562">Full time employee</span></span> |
| <span data-ttu-id="a1f0c-563">Część etatu</span><span class="sxs-lookup"><span data-stu-id="a1f0c-563">Part-time</span></span>       | <span data-ttu-id="a1f0c-564">Pracownik etatowy zatrudniony w niepełnym wymiarze czasu</span><span class="sxs-lookup"><span data-stu-id="a1f0c-564">Part time employee</span></span> |

### <a name="reason-codes"></a><span data-ttu-id="a1f0c-565">Kody przyczyn</span><span class="sxs-lookup"><span data-stu-id="a1f0c-565">Reason codes</span></span>

<span data-ttu-id="a1f0c-566">Kody przyczyn informują o stanie pracownika.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-566">Reason codes provide information about the status of an employee.</span></span> <span data-ttu-id="a1f0c-567">Kody przyczyn są mapowane do systemu Dayforce jako przyczyny stanu, które wskazują powód zmiany stanowiska lub statusu zatrudnienia pracownika.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-567">Reason codes are mapped to Dayforce as status reasons that indicate the reason for changes to an employee's position or employment status.</span></span>

<span data-ttu-id="a1f0c-568">Następujące kody przyczyn i opisy są wymagane.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-568">The following reason codes and descriptions are required.</span></span>

| <span data-ttu-id="a1f0c-569">Kod przyczyny</span><span class="sxs-lookup"><span data-stu-id="a1f0c-569">Reason code</span></span>            | <span data-ttu-id="a1f0c-570">opis</span><span class="sxs-lookup"><span data-stu-id="a1f0c-570">Description</span></span>                    | <span data-ttu-id="a1f0c-571">Odpowiednie scenariusze</span><span class="sxs-lookup"><span data-stu-id="a1f0c-571">Applicable scenarios</span></span> |
|------------------------|--------------------------------|----------------------|
| <span data-ttu-id="a1f0c-572">DEPARTUREBEFOREPAYMENT</span><span class="sxs-lookup"><span data-stu-id="a1f0c-572">DEPARTUREBEFOREPAYMENT</span></span> | <span data-ttu-id="a1f0c-573">Odejście z pracy przed pierwszą wypłatą</span><span class="sxs-lookup"><span data-stu-id="a1f0c-573">Departure before first payroll</span></span> | <span data-ttu-id="a1f0c-574">Zwalnianie pracownika</span><span class="sxs-lookup"><span data-stu-id="a1f0c-574">Terminate worker</span></span>     |
| <span data-ttu-id="a1f0c-575">RESIGNATION</span><span class="sxs-lookup"><span data-stu-id="a1f0c-575">RESIGNATION</span></span>            | <span data-ttu-id="a1f0c-576">Rezygnacja</span><span class="sxs-lookup"><span data-stu-id="a1f0c-576">Resignation</span></span>                    | <span data-ttu-id="a1f0c-577">Zwalnianie pracownika</span><span class="sxs-lookup"><span data-stu-id="a1f0c-577">Terminate worker</span></span>     |
| <span data-ttu-id="a1f0c-578">PENSION</span><span class="sxs-lookup"><span data-stu-id="a1f0c-578">PENSION</span></span>                | <span data-ttu-id="a1f0c-579">Emerytura</span><span class="sxs-lookup"><span data-stu-id="a1f0c-579">Pension</span></span>                        | <span data-ttu-id="a1f0c-580">Zwalnianie pracownika</span><span class="sxs-lookup"><span data-stu-id="a1f0c-580">Terminate worker</span></span>     |
| <span data-ttu-id="a1f0c-581">TERMINATION</span><span class="sxs-lookup"><span data-stu-id="a1f0c-581">TERMINATION</span></span>            | <span data-ttu-id="a1f0c-582">Przerwanie</span><span class="sxs-lookup"><span data-stu-id="a1f0c-582">Termination</span></span>                    | <span data-ttu-id="a1f0c-583">Zwalnianie pracownika</span><span class="sxs-lookup"><span data-stu-id="a1f0c-583">Terminate worker</span></span>     |
| <span data-ttu-id="a1f0c-584">RETIREMENT</span><span class="sxs-lookup"><span data-stu-id="a1f0c-584">RETIREMENT</span></span>             | <span data-ttu-id="a1f0c-585">Emerytura</span><span class="sxs-lookup"><span data-stu-id="a1f0c-585">Retirement</span></span>                     | <span data-ttu-id="a1f0c-586">Zwalnianie pracownika</span><span class="sxs-lookup"><span data-stu-id="a1f0c-586">Terminate worker</span></span>     |
| <span data-ttu-id="a1f0c-587">ABSENTEE</span><span class="sxs-lookup"><span data-stu-id="a1f0c-587">ABSENTEE</span></span>               | <span data-ttu-id="a1f0c-588">Absencja</span><span class="sxs-lookup"><span data-stu-id="a1f0c-588">Absentee</span></span>                       | <span data-ttu-id="a1f0c-589">Zwalnianie pracownika</span><span class="sxs-lookup"><span data-stu-id="a1f0c-589">Terminate worker</span></span>     |
| <span data-ttu-id="a1f0c-590">INNY</span><span class="sxs-lookup"><span data-stu-id="a1f0c-590">OTHER</span></span>                  | <span data-ttu-id="a1f0c-591">Inne przyczyny</span><span class="sxs-lookup"><span data-stu-id="a1f0c-591">Other Reasons</span></span>                  | <span data-ttu-id="a1f0c-592">Zwalnianie pracownika</span><span class="sxs-lookup"><span data-stu-id="a1f0c-592">Terminate worker</span></span>     |
| <span data-ttu-id="a1f0c-593">CLOSURE</span><span class="sxs-lookup"><span data-stu-id="a1f0c-593">CLOSURE</span></span>                | <span data-ttu-id="a1f0c-594">Zaprzestanie działalności przez firmę</span><span class="sxs-lookup"><span data-stu-id="a1f0c-594">Business Closure</span></span>               | <span data-ttu-id="a1f0c-595">Zwalnianie pracownika</span><span class="sxs-lookup"><span data-stu-id="a1f0c-595">Terminate worker</span></span>     |
| <span data-ttu-id="a1f0c-596">DEATH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-596">DEATH</span></span>                  | <span data-ttu-id="a1f0c-597">Śmierć</span><span class="sxs-lookup"><span data-stu-id="a1f0c-597">Death</span></span>                          | <span data-ttu-id="a1f0c-598">Zwalnianie pracownika</span><span class="sxs-lookup"><span data-stu-id="a1f0c-598">Terminate worker</span></span>     |
| <span data-ttu-id="a1f0c-599">LEAVEOFABSENCE</span><span class="sxs-lookup"><span data-stu-id="a1f0c-599">LEAVEOFABSENCE</span></span>         | <span data-ttu-id="a1f0c-600">Nieobecność</span><span class="sxs-lookup"><span data-stu-id="a1f0c-600">Leave of Absence</span></span>               | <span data-ttu-id="a1f0c-601">Zwalnianie pracownika</span><span class="sxs-lookup"><span data-stu-id="a1f0c-601">Terminate worker</span></span>     |
| <span data-ttu-id="a1f0c-602">CONTRACTEND</span><span class="sxs-lookup"><span data-stu-id="a1f0c-602">CONTRACTEND</span></span>            | <span data-ttu-id="a1f0c-603">Zakończenie umowy</span><span class="sxs-lookup"><span data-stu-id="a1f0c-603">End of Contract</span></span>                | <span data-ttu-id="a1f0c-604">Zwalnianie pracownika</span><span class="sxs-lookup"><span data-stu-id="a1f0c-604">Terminate worker</span></span>     |
| <span data-ttu-id="a1f0c-605">SALARYCHANGE</span><span class="sxs-lookup"><span data-stu-id="a1f0c-605">SALARYCHANGE</span></span>           | <span data-ttu-id="a1f0c-606">Zmiana wynagrodzenia</span><span class="sxs-lookup"><span data-stu-id="a1f0c-606">Change of Salary</span></span>               | <span data-ttu-id="a1f0c-607">Wynagrodzenie</span><span class="sxs-lookup"><span data-stu-id="a1f0c-607">Compensation</span></span>         |

### <a name="terms-of-employment"></a><span data-ttu-id="a1f0c-608">Warunki zatrudnienia</span><span class="sxs-lookup"><span data-stu-id="a1f0c-608">Terms of employment</span></span>

<span data-ttu-id="a1f0c-609">Warunki zatrudnienia służą do tworzenia kategorii warunków zatrudnienia.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-609">Terms of employment are used to create categories of employment terms.</span></span> <span data-ttu-id="a1f0c-610">Warunki są mapowane do systemu Dayforce jako wartości wskaźnika zatrudnienia.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-610">The terms are mapped to Dayforce as employment indicator values.</span></span>

<span data-ttu-id="a1f0c-611">Następujące warunki zatrudnienia i opisy są wymagane.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-611">The following terms of employment and descriptions are required.</span></span>

| <span data-ttu-id="a1f0c-612">Warunki zatrudnienia</span><span class="sxs-lookup"><span data-stu-id="a1f0c-612">Terms of employment</span></span>   | <span data-ttu-id="a1f0c-613">opis</span><span class="sxs-lookup"><span data-stu-id="a1f0c-613">Description</span></span> |
|-----------------------|-------------|
| <span data-ttu-id="a1f0c-614">Normalna</span><span class="sxs-lookup"><span data-stu-id="a1f0c-614">Regular</span></span>               | <span data-ttu-id="a1f0c-615">Normalna</span><span class="sxs-lookup"><span data-stu-id="a1f0c-615">Regular</span></span>     |
| <span data-ttu-id="a1f0c-616">Bezpośredni</span><span class="sxs-lookup"><span data-stu-id="a1f0c-616">Direct</span></span>                | <span data-ttu-id="a1f0c-617">Bezpośredni</span><span class="sxs-lookup"><span data-stu-id="a1f0c-617">Direct</span></span>      |
| <span data-ttu-id="a1f0c-618">Staż</span><span class="sxs-lookup"><span data-stu-id="a1f0c-618">Internship</span></span>            | <span data-ttu-id="a1f0c-619">Staż</span><span class="sxs-lookup"><span data-stu-id="a1f0c-619">Internship</span></span>  |
| <span data-ttu-id="a1f0c-620">Stałe</span><span class="sxs-lookup"><span data-stu-id="a1f0c-620">Permanent</span></span>             | <span data-ttu-id="a1f0c-621">Stałe</span><span class="sxs-lookup"><span data-stu-id="a1f0c-621">Permanent</span></span>   |

### <a name="marital-status"></a><span data-ttu-id="a1f0c-622">Stan cywilny</span><span class="sxs-lookup"><span data-stu-id="a1f0c-622">Marital status</span></span>

<span data-ttu-id="a1f0c-623">Wartości stanu cywilnego są mapowane do systemu Dayforce i w razie potrzeby tłumaczone na akceptowane wartości podczas integracji.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-623">Marital status values are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="a1f0c-624">W poniższej tabeli przedstawiono mapowanie wartości stanu cywilnego do usługi Dayforce.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-624">The following table shows how marital status values are mapped to Dayforce.</span></span>

| <span data-ttu-id="a1f0c-625">Zasoby ludzkie</span><span class="sxs-lookup"><span data-stu-id="a1f0c-625">Human Resources</span></span>                 | <span data-ttu-id="a1f0c-626">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a1f0c-626">Dayforce</span></span>                  |
|------------------------|---------------------------|
| <span data-ttu-id="a1f0c-627">Żonaty/mężatka</span><span class="sxs-lookup"><span data-stu-id="a1f0c-627">Married</span></span>                | <span data-ttu-id="a1f0c-628">Żonaty/mężatka</span><span class="sxs-lookup"><span data-stu-id="a1f0c-628">Married</span></span>                   |
| <span data-ttu-id="a1f0c-629">Niebędący/niebędąca w związku</span><span class="sxs-lookup"><span data-stu-id="a1f0c-629">Single</span></span>                 | <span data-ttu-id="a1f0c-630">Niebędący/niebędąca w związku</span><span class="sxs-lookup"><span data-stu-id="a1f0c-630">Single</span></span>                    |
| <span data-ttu-id="a1f0c-631">Wdowiec/wdowa</span><span class="sxs-lookup"><span data-stu-id="a1f0c-631">Widowed</span></span>                | <span data-ttu-id="a1f0c-632">Wdowiec/wdowa</span><span class="sxs-lookup"><span data-stu-id="a1f0c-632">Widowed</span></span>                   |
| <span data-ttu-id="a1f0c-633">Rozwiedziony/rozwiedziona</span><span class="sxs-lookup"><span data-stu-id="a1f0c-633">Divorced</span></span>               | <span data-ttu-id="a1f0c-634">Rozwiedziony/rozwiedziona</span><span class="sxs-lookup"><span data-stu-id="a1f0c-634">Divorced</span></span>                  |
| <span data-ttu-id="a1f0c-635">Związek zarejestrowany</span><span class="sxs-lookup"><span data-stu-id="a1f0c-635">Registered Partnership</span></span> | <span data-ttu-id="a1f0c-636">Partnerstwo krajowe</span><span class="sxs-lookup"><span data-stu-id="a1f0c-636">Domestic Partnership</span></span>      |
| <span data-ttu-id="a1f0c-637">None</span><span class="sxs-lookup"><span data-stu-id="a1f0c-637">None</span></span>                   | <span data-ttu-id="a1f0c-638">*Nieobsługiwane w Meksyku*</span><span class="sxs-lookup"><span data-stu-id="a1f0c-638">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="a1f0c-639">Konkubinat</span><span class="sxs-lookup"><span data-stu-id="a1f0c-639">Cohabiting</span></span>             | <span data-ttu-id="a1f0c-640">*Nieobsługiwane w Meksyku*</span><span class="sxs-lookup"><span data-stu-id="a1f0c-640">*Not supported by Mexico*</span></span> |

### <a name="gender"></a><span data-ttu-id="a1f0c-641">Rodzaj</span><span class="sxs-lookup"><span data-stu-id="a1f0c-641">Gender</span></span>

<span data-ttu-id="a1f0c-642">Określenia płci są mapowane do systemu Dayforce i w razie potrzeby tłumaczone na akceptowane wartości podczas integracji.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-642">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="a1f0c-643">W poniższej tabeli przedstawiono mapowanie określeń płci do usługi Dayforce.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-643">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="a1f0c-644">Zasoby ludzkie</span><span class="sxs-lookup"><span data-stu-id="a1f0c-644">Human Resources</span></span>       | <span data-ttu-id="a1f0c-645">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a1f0c-645">Dayforce</span></span>                  |
|--------------|---------------------------|
| <span data-ttu-id="a1f0c-646">Mężczyzna</span><span class="sxs-lookup"><span data-stu-id="a1f0c-646">Male</span></span>         | <span data-ttu-id="a1f0c-647">Mężczyzna</span><span class="sxs-lookup"><span data-stu-id="a1f0c-647">Male</span></span>                      |
| <span data-ttu-id="a1f0c-648">Kobieta</span><span class="sxs-lookup"><span data-stu-id="a1f0c-648">Female</span></span>       | <span data-ttu-id="a1f0c-649">Kobieta</span><span class="sxs-lookup"><span data-stu-id="a1f0c-649">Female</span></span>                    |
| <span data-ttu-id="a1f0c-650">Nieokreślone</span><span class="sxs-lookup"><span data-stu-id="a1f0c-650">Non-specific</span></span> | <span data-ttu-id="a1f0c-651">*Nieobsługiwane w Meksyku*</span><span class="sxs-lookup"><span data-stu-id="a1f0c-651">*Not supported by Mexico*</span></span> |

### <a name="payment-method"></a><span data-ttu-id="a1f0c-652">Metoda płatności</span><span class="sxs-lookup"><span data-stu-id="a1f0c-652">Payment method</span></span>

<span data-ttu-id="a1f0c-653">Funkcja metod płatności oferuje pracownikowi i firmie sposób opisania, jak pracownik będzie otrzymywał zapłatę.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-653">Payment methods give the employee and the company a way to describe how employees will be paid.</span></span> <span data-ttu-id="a1f0c-654">Metody płatności są mapowane do systemu Dayforce i w razie potrzeby tłumaczone na akceptowane wartości podczas integracji.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-654">Payment methods are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="a1f0c-655">W poniższej tabeli przedstawiono mapowanie metod płatności do usługi Dayforce.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-655">The following table shows how payment methods are mapped to Dayforce.</span></span>

| <span data-ttu-id="a1f0c-656">Zasoby ludzkie</span><span class="sxs-lookup"><span data-stu-id="a1f0c-656">Human Resources</span></span>             | <span data-ttu-id="a1f0c-657">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a1f0c-657">Dayforce</span></span>                  |
|--------------------|---------------------------|
| <span data-ttu-id="a1f0c-658">Kasa</span><span class="sxs-lookup"><span data-stu-id="a1f0c-658">Cash</span></span>               | <span data-ttu-id="a1f0c-659">Kasa</span><span class="sxs-lookup"><span data-stu-id="a1f0c-659">Cash</span></span>                      |
| <span data-ttu-id="a1f0c-660">Płatność elektroniczna</span><span class="sxs-lookup"><span data-stu-id="a1f0c-660">Electronic Payment</span></span> | <span data-ttu-id="a1f0c-661">Przenoszenie</span><span class="sxs-lookup"><span data-stu-id="a1f0c-661">Transfer</span></span>                  |
| <span data-ttu-id="a1f0c-662">Sprawdzanie</span><span class="sxs-lookup"><span data-stu-id="a1f0c-662">Check</span></span>              | <span data-ttu-id="a1f0c-663">Czek</span><span class="sxs-lookup"><span data-stu-id="a1f0c-663">Cheque</span></span>                    |
| <span data-ttu-id="a1f0c-664">Przekaz bankowy</span><span class="sxs-lookup"><span data-stu-id="a1f0c-664">Bank Draft</span></span>         | <span data-ttu-id="a1f0c-665">*Nieobsługiwane w Meksyku*</span><span class="sxs-lookup"><span data-stu-id="a1f0c-665">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="a1f0c-666">Inna</span><span class="sxs-lookup"><span data-stu-id="a1f0c-666">Other</span></span>              | <span data-ttu-id="a1f0c-667">*Nieobsługiwane w Meksyku*</span><span class="sxs-lookup"><span data-stu-id="a1f0c-667">*Not supported by Mexico*</span></span> |

### <a name="bank-account-type"></a><span data-ttu-id="a1f0c-668">Typ konta bankowego</span><span class="sxs-lookup"><span data-stu-id="a1f0c-668">Bank account type</span></span>

<span data-ttu-id="a1f0c-669">Typy kont bankowych są wykorzystywane w płatnościach elektronicznych dla pracowników.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-669">Bank account types are used for electronic payments to employees.</span></span> <span data-ttu-id="a1f0c-670">Typy kont bankowych są mapowane do systemu Dayforce jako informacje o koncie do przelewów.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-670">Bank account types are mapped to Dayforce as transfer account information.</span></span> <span data-ttu-id="a1f0c-671">Typy kont bankowych są w razie potrzeby tłumaczone na akceptowane wartości podczas integracji.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-671">The bank account types are translated, as appropriate, to the accepted values upon integration.</span></span>

| <span data-ttu-id="a1f0c-672">Zasoby ludzkie</span><span class="sxs-lookup"><span data-stu-id="a1f0c-672">Human Resources</span></span>            | <span data-ttu-id="a1f0c-673">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a1f0c-673">Dayforce</span></span>                  |
|-------------------|---------------------------|
| <span data-ttu-id="a1f0c-674">Konto czekowe</span><span class="sxs-lookup"><span data-stu-id="a1f0c-674">Checking Account</span></span>  | <span data-ttu-id="a1f0c-675">CheckingAccount</span><span class="sxs-lookup"><span data-stu-id="a1f0c-675">CheckingAccount</span></span>           |
| <span data-ttu-id="a1f0c-676">Konto listy płac</span><span class="sxs-lookup"><span data-stu-id="a1f0c-676">Payroll Account</span></span>   | <span data-ttu-id="a1f0c-677">PayrollAccount</span><span class="sxs-lookup"><span data-stu-id="a1f0c-677">PayrollAccount</span></span>            |
| <span data-ttu-id="a1f0c-678">Konto oszczędnościowe</span><span class="sxs-lookup"><span data-stu-id="a1f0c-678">Savings Account</span></span>   | <span data-ttu-id="a1f0c-679">*Nieobsługiwane w Meksyku*</span><span class="sxs-lookup"><span data-stu-id="a1f0c-679">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="a1f0c-680">Konto BankGirot</span><span class="sxs-lookup"><span data-stu-id="a1f0c-680">BankGirot account</span></span> | <span data-ttu-id="a1f0c-681">*Nieobsługiwane w Meksyku*</span><span class="sxs-lookup"><span data-stu-id="a1f0c-681">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="a1f0c-682">Konto PlusGirot</span><span class="sxs-lookup"><span data-stu-id="a1f0c-682">PlusGirot account</span></span> | <span data-ttu-id="a1f0c-683">*Nieobsługiwane w Meksyku*</span><span class="sxs-lookup"><span data-stu-id="a1f0c-683">*Not supported by Mexico*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="a1f0c-684">Kody zarobków</span><span class="sxs-lookup"><span data-stu-id="a1f0c-684">Earning codes</span></span>

<span data-ttu-id="a1f0c-685">Kody zarobków jednoznacznie identyfikują każdy rodzaj dochodów, które otrzymują pracownicy.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-685">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="a1f0c-686">Kody mają różne parametry związane z zarobkami, takie jak reguły księgowania, przepisy podatkowe, wymagania dotyczące raportowania i możliwość zwiększania wartości brutto.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-686">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="a1f0c-687">W razie ustawienia nieobsługiwanej częstotliwości domyślnie w obliczeniu będzie używana częstotliwość **Każda wypłata**.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-687">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="a1f0c-688">Obsługiwane częstotliwości</span><span class="sxs-lookup"><span data-stu-id="a1f0c-688">Supported frequencies</span></span>

- <span data-ttu-id="a1f0c-689">Wszyscy</span><span class="sxs-lookup"><span data-stu-id="a1f0c-689">All</span></span>
- <span data-ttu-id="a1f0c-690">EVERYPAY</span><span class="sxs-lookup"><span data-stu-id="a1f0c-690">EVERYPAY</span></span>
- <span data-ttu-id="a1f0c-691">EACHPAYPERIOD</span><span class="sxs-lookup"><span data-stu-id="a1f0c-691">EACHPAYPERIOD</span></span>
- <span data-ttu-id="a1f0c-692">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="a1f0c-692">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="a1f0c-693">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="a1f0c-693">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="a1f0c-694">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-694">1OFMTH</span></span>
- <span data-ttu-id="a1f0c-695">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-695">LASTOFMTH</span></span>
- <span data-ttu-id="a1f0c-696">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-696">2OFMTH</span></span>
- <span data-ttu-id="a1f0c-697">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-697">3OFMTH</span></span>
- <span data-ttu-id="a1f0c-698">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-698">4OFMTH</span></span>
- <span data-ttu-id="a1f0c-699">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-699">5OFMTH</span></span>
- <span data-ttu-id="a1f0c-700">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-700">1N2OFMTH</span></span>
- <span data-ttu-id="a1f0c-701">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-701">3N4OFMTH</span></span>
- <span data-ttu-id="a1f0c-702">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-702">1N3OFMTH</span></span>
- <span data-ttu-id="a1f0c-703">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-703">1N4OFMTH</span></span>
- <span data-ttu-id="a1f0c-704">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-704">2N3OFMTH</span></span>
- <span data-ttu-id="a1f0c-705">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-705">2N4OFMTH</span></span>
- <span data-ttu-id="a1f0c-706">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-706">1N2N3OFMTH</span></span>
- <span data-ttu-id="a1f0c-707">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-707">1N2N4OFMTH</span></span>
- <span data-ttu-id="a1f0c-708">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-708">1N3N4OFMTH</span></span>
- <span data-ttu-id="a1f0c-709">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-709">2N3N4OFMTH</span></span>
- <span data-ttu-id="a1f0c-710">1N2N3N4OFMTH – 1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="a1f0c-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="a1f0c-711">2N3N4N5OFMth – 2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="a1f0c-711">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="a1f0c-712">1OFQTR – 1OFQTR</span><span class="sxs-lookup"><span data-stu-id="a1f0c-712">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="a1f0c-713">LASTOFQTR – LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="a1f0c-713">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="a1f0c-714">LASTMTHOFQTR – LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="a1f0c-714">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="a1f0c-715">1OFYEAR – 1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="a1f0c-715">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="a1f0c-716">LASTOFYEAR – LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="a1f0c-716">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="a1f0c-717">NOVNDECOFYEAR – NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="a1f0c-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="a1f0c-718">Adresy</span><span class="sxs-lookup"><span data-stu-id="a1f0c-718">Addresses</span></span>

<span data-ttu-id="a1f0c-719">Identyfikacja określonych kodów kraju lub regionu, województwa i powiatu (gminy) wymaga określonych formatów, które potrafi rozpoznać system Dayforce oraz dostawcy wewnątrz krajów/regionów.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-719">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="a1f0c-720">Co prawda format nazw miejscowości jest elastyczny, ale każda miejscowość musi być skojarzona z województwem.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-720">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="a1f0c-721">Zasoby ludzkie</span><span class="sxs-lookup"><span data-stu-id="a1f0c-721">Human Resources</span></span>              | <span data-ttu-id="a1f0c-722">Dayforce</span><span class="sxs-lookup"><span data-stu-id="a1f0c-722">Dayforce</span></span>              |
|---------------------|-----------------------|
| <span data-ttu-id="a1f0c-723">Kraj/region</span><span class="sxs-lookup"><span data-stu-id="a1f0c-723">Country/Region</span></span>      | <span data-ttu-id="a1f0c-724">Kod kraju</span><span class="sxs-lookup"><span data-stu-id="a1f0c-724">Country Code</span></span>          |
| <span data-ttu-id="a1f0c-725">Kod pocztowy</span><span class="sxs-lookup"><span data-stu-id="a1f0c-725">Zip/Postal Code</span></span>     | <span data-ttu-id="a1f0c-726">Kod pocztowy</span><span class="sxs-lookup"><span data-stu-id="a1f0c-726">Postal Code</span></span>           |
| <span data-ttu-id="a1f0c-727">Stanowy</span><span class="sxs-lookup"><span data-stu-id="a1f0c-727">State</span></span>               | <span data-ttu-id="a1f0c-728">Kod województwa</span><span class="sxs-lookup"><span data-stu-id="a1f0c-728">State Code</span></span>            |
| <span data-ttu-id="a1f0c-729">Miejscowość</span><span class="sxs-lookup"><span data-stu-id="a1f0c-729">City</span></span>                | <span data-ttu-id="a1f0c-730">Miejscowość</span><span class="sxs-lookup"><span data-stu-id="a1f0c-730">City</span></span>                  |
| <span data-ttu-id="a1f0c-731">Powiat</span><span class="sxs-lookup"><span data-stu-id="a1f0c-731">County</span></span>              | <span data-ttu-id="a1f0c-732">Powiat (gmina)</span><span class="sxs-lookup"><span data-stu-id="a1f0c-732">County (Municipality)</span></span> |
| <span data-ttu-id="a1f0c-733">Ulica</span><span class="sxs-lookup"><span data-stu-id="a1f0c-733">Street</span></span>              | <span data-ttu-id="a1f0c-734">Wiersz adresu 1</span><span class="sxs-lookup"><span data-stu-id="a1f0c-734">Address Line 1</span></span>        |
| <span data-ttu-id="a1f0c-735">Numer budynku</span><span class="sxs-lookup"><span data-stu-id="a1f0c-735">Street Number</span></span>       | <span data-ttu-id="a1f0c-736">Wiersz adresu 2</span><span class="sxs-lookup"><span data-stu-id="a1f0c-736">Address Line 2</span></span>        |
| <span data-ttu-id="a1f0c-737">Dodatkowe określenie budynku</span><span class="sxs-lookup"><span data-stu-id="a1f0c-737">Building Complement</span></span> | <span data-ttu-id="a1f0c-738">Wiersz adresu 5</span><span class="sxs-lookup"><span data-stu-id="a1f0c-738">Address Line 5</span></span>        |

### <a name="passport-number"></a><span data-ttu-id="a1f0c-739">Numer paszportu</span><span class="sxs-lookup"><span data-stu-id="a1f0c-739">Passport number</span></span>

<span data-ttu-id="a1f0c-740">Pracownicy mogą podać informacje z paszportów.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-740">Employees can declare passport information.</span></span> <span data-ttu-id="a1f0c-741">Te informacje mają typ identyfikacji **Paszport** i są integrowane z systemem Dayforce w ramach danych pracowników specyficznych dla Meksyku.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-741">This information is of the **Passport** identification type and is integrated into Dayforce as part of an employee's Mexico-specific information.</span></span>

- <span data-ttu-id="a1f0c-742">Typ identyfikacji = „Paszport”</span><span class="sxs-lookup"><span data-stu-id="a1f0c-742">Identification Type = "Passport"</span></span>
- <span data-ttu-id="a1f0c-743">Data wystawienia</span><span class="sxs-lookup"><span data-stu-id="a1f0c-743">Issued Date</span></span>
- <span data-ttu-id="a1f0c-744">Data ważności</span><span class="sxs-lookup"><span data-stu-id="a1f0c-744">Expiration Date</span></span>

<span data-ttu-id="a1f0c-745">Pracownicy mogą zadeklarować wiele numerów identyfikacyjnych typu **Paszport**.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-745">Employees can declare multiple identification numbers of the **Passport** identification type.</span></span> <span data-ttu-id="a1f0c-746">Jednak tylko obecnie aktywny wpis paszportu jest integrowany z usługą Dayforce.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-746">However, only the current active passport entry is integrated into Dayforce.</span></span> <span data-ttu-id="a1f0c-747">Jeśli wszystkie wpisy paszportów wygasły, z systemem Dayforce zostanie zintegrowany ostatnio wystawiony paszport.</span><span class="sxs-lookup"><span data-stu-id="a1f0c-747">If all passport entries are expired, the passport that was most recently issued is integrated into Dayforce.</span></span>

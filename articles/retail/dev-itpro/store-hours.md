...
Ta funkcja jest dostępna w Microsoft Dynamics 365 for Retail wersjach 8.1.2 i nowszych.
...
1. Przejdź do opcji **Handel detaliczny** \> **Konfiguracja kanału** \> **Godziny pracy sklepu**.
...
3. W oknie dialogowym **Dodaj zakres** określ zakres dat, godziny sklepu oraz wszelkie wymagane święta.
    ...
    ![Okno dialogowe Dodaj zakres](../dev-itpro/media/Storehours1.png "Okno dialogowe Dodaj zakres")
...
4. Szablonem godzin sklepu należy skojarzyć z magazynami, w których będzie używany. W oknie dialogowym **Wybieranie węzłów organizacji** wybierz sklepy, regiony i organizacje, z którymi szablon ma być skojarzony.
    ...
    ![Okno dialogowe Wybieranie węzłów organizacji](../dev-itpro/media/Storehours2.png "Okno dialogowe Wybieranie węzłów organizacji")

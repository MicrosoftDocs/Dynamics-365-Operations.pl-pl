...
---
# <a name="create-point-of-sale-registers"></a>Tworzenie punktu sprzedaży (kas)
...
1. Wybierz kolejno opcje Handel detaliczny i inny > Ustawienia kanału > Ustawienia punktu sprzedaży > Rejestry.
...
6. W polu Profil sprzętu wprowadź lub wybierz wartość.
    * Profile sprzętu są używane do określania urządzeń peryferyjnych sieci sprzedaży, które będą podłączone do kasy, takich jak szuflada kasowa czy drukarka paragonów.  

...
---
# <a name="configure-payment-method-settings-that-affect-retail-statements"></a>Konfigurowanie ustawień metody płatności wpływających na zestawienia sieci sprzedaży

...
---
# <a name="process-adjustments-of-loyalty-reward-points"></a>Przetwarzanie korekt punktów lojalnościowych
...
1. Przejdź do okna Karty lojalnościowe.
2. Na liście znajdź i zaznacz odpowiedni rekord.
3. Na liście kliknij łącze w wybranym wierszu.
4. Kliknij opcję Transakcje kartą.
    * Na tej stronie można wyświetlić wszystkie transakcje lojalnościowe dla wybranej karty lojalnościowej.  
5. Zamknij stronę.
6. Kliknij opcję Korekty karty.
7. Kliknij przycisk Nowy.
8. W polu Punkty lojalnościowe wprowadź lub wybierz wartość.
9. W polu Kwota lub ilość wprowadź liczbę.
    * Można dodać lub usunąć punkty z karty lojalnościowej przy użyciu kwoty dodatniej lub ujemnej.  
10. W polu Program lojalnościowy wprowadź lub wybierz wartość.
11. W polu Komentarz wpisz wartość.
12. Kliknij przycisk Księguj korektę.
13. Kliknij przycisk Tak.
14. Zamknij stronę.

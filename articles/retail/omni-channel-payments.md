...
ms.locfileid: "2017581"
---
# <a name="omni-channel-payments-overview"></a>Omówienie płatności wielokanałowych

[!include [banner](../includes/banner.md)]

W tym temacie są omówione płatności wielokanałowe w programie Dynamics 365 Retail. Zawiera pełną listę obsługiwanych scenariuszy, informacje o funkcjonalności, konfiguracji i rozwiązywaniu problemów oraz opisy typowych problemów.

...
Aplikacja Retail zawiera szereg opcji konfiguracji i operacji punktu sprzedaży, które wspierają obsługę wielu procesów biznesowych wykonywanych na koniec dnia w punkcie sprzedaży. W tym rozdziale opisano kilka typowych scenariuszy zmian.
...
Wybierz kolejno opcje **Handel detaliczny \> Kanały \> Sklepy sieci sprzedaży \> Wszystkie sklepy sieci sprzedaży \> Zestawienie/zamknięcie**, a następnie dla każdego sklepu w polach **Metoda zestawienia** i **Metoda zamknięcia** ustaw wartość **Zmiana**.
...
Aby uzyskać więcej informacji o metodach tworzenia zestawień i zamykania, zobacz [Konfiguracje sklepu dla zestawień sieci sprzedaży](https://docs.microsoft.com/en-us/dynamics365/unified-operations/retail/tasks/store-configurations-retail-statements).

...
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-november-12-2019"></a>Nowości i zmiany w rozwiązaniu Dynamics 365 Talent (12 listopada 2019 r.)
...
Zmiany opisane w tej części dotyczą kompilacji 8.1.2604. Liczby w nawiasach w niektórych nagłówkach odnoszą się do numerów pomocy w usługach Microsoft Dynamics Lifecycle Services (LCS).

### <a name="office-location-isnt-updated-via-excel-workbook-369727"></a>Lokalizacja biura nie jest aktualizowana przez skoroszyt programu Excel (369727)

W przypadku tej zmiany można teraz zaktualizować lokalizację biura, korzystając z funkcji Projektant skoroszytów pakietu Office.

...
**Kompilacja 8.1.154.0**

W tym temacie opisano nowe i zmienione funkcje dostępne w rozwiązaniu Core HR.

## <a name="leave-and-absence--accrue-time-based-on-hours-worked"></a>Urlopy i nieobecności — naliczanie czasu na podstawie liczby przepracowanych godzin
...
-   W aktualizacji Platform update 18 dla Finance and Operations klient internetowy aplikacji Talent prezentuje obiekty graficzne w sposób zgodny z Microsoft Fluent Design.
    ...
    -   Zmieniono sposób wyświetlania pól w trybie odczytu.

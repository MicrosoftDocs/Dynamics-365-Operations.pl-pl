---
title: Nowości i zmiany w rozwiązaniu Dynamics 365 Talent (14 stycznia 2020 r.)
...
ms.locfileid: "4529121"
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-january-14-2020"></a>Nowości i zmiany w rozwiązaniu Dynamics 365 Talent (14 stycznia 2020 r.)
...
Zmiany opisane w tej części dotyczą kompilacji 8.1.2709. Liczby w nawiasach w niektórych nagłówkach odnoszą się do numerów pomocy w usługach Microsoft Dynamics Lifecycle Services (LCS).

### <a name="system-unable-to-generate-calendar-days-when-importing-through-data-management-framework-381195"></a>System nie może wygenerować dni kalendarzowych podczas importu za pomocą narzędzia do zarządzania danymi (381195)

Ta zmiana koryguje problem polegający na tym, że importowanie dni kalendarzowych generuje błąd **nieprawidłowego formatu daty**. Ten błąd uniemożliwia tworzenie wierszy daty kalendarza pracy.

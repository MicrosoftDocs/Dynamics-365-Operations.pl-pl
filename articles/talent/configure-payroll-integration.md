...
---
# <a name="configure-payroll-integration-between-talent-and-dayforce"></a>Konfigurowanie integracji listy płac między rozwiązaniami Talent i Dayforce
...
W tym temacie opisano czynności, które należy wykonać, aby włączyć integrację. Objaśniono tu także typy danych i szczegóły konfiguracji, których wymaga integracja.
...
| Wybór w aplikacji Talent        | Wynik w systemie Dayforce                            |
|----------------------------|-----------------------------------------------|
| None                       | Nie jest tworzone żadne potrącenie                      |

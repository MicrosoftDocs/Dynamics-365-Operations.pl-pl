...
| | Raporty usługi Power BI Analiza wydatków zakupowych| Tak | Nr |
| Zarządzanie informacjami o produktach | | Tak | Tak |
| Dane produktu głównego| | Tak | Tak|
| Produkcja | | Tak | Tak |
| | Raporty usługi Power BI Wydajność produkcji| Tak | Nr |
| Zarządzanie projektami i ich księgowanie|  | Tak | Tak |
| Sprzedaż| | Tak | Tak |
| | Raporty usługi Power BI dotycząca wyników sprzedaży i rentowności| Tak | Nr |

...
> [!NOTE]
> W programie Finance and Operations do tworzenia certyfikatów i włączania funkcjonalności podpisywania elektronicznego są używane funkcje programu Microsoft SQL Server. Nie jest wymagana żadna dodatkowa infrastruktura certyfikatów czy kluczy publicznych (PKI).

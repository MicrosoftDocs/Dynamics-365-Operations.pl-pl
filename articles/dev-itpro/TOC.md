...
#### [Modyfikowanie właściwości formantu formularza](extensibility/modify-control-properties.md)
...
### [Zarządzanie modelami innych firm i pakietami uruchamiania za pomocą kontroli źródła](dev-tools/manage-runtime-packages.md)
...
## [Korzystanie z diagramów aktywności](lifecycle-services/using-activity-diagrams.md)
## [Synchronizowanie biblioteki BPM z Visual Studio Team Services (VSTS)](lifecycle-services/synchronize-bpm-vsts.md)

...
Należy wdrożyć topologię Microsoft Dynamics 365 for Finance and Operations, która obsługuje ciągłą kompilację. (Aby uzyskać więcej informacji, zobacz [wdrażanie topologii, które obsługują ciągłą kompilację i automatyzację testowania](https://docs.microsoft.com/dynamics365/unified-operations/dev-itpro/perf-test/continuous-build-test-automation).) Musisz mieć dostęp do tej topologii Finance and Operations dla jednej z następujących ról:

- Deweloper raportowania elektronicznego
- Konsultant funkcjonalny raportowania elektronicznego
- Administrator systemu

Ponadto musisz także mieć dostęp do środowiska programowania dla tej topologii Finance and Operations.
...
W bieżącej topologii Finance and Operations [Utwórz nowy format raportowania elektronicznego ](tasks/er-format-configuration-2016-11.md) do generowania dokumentów, dla których chcesz dodać niestandardową lokalizację. Alternatywnie [Zaimportuj istniejący format raportowania elektronicznego do tej topologii](general-electronic-reporting-manage-configuration-lifecycle.md).

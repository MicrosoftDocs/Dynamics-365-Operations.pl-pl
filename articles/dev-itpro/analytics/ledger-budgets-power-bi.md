...
# <a name="actual-vs-budget-power-bi-content"></a><span data-ttu-id="970d7-104">Pakiet zawartości usługi Power BI Wartości rzeczywiste a budżet</span><span class="sxs-lookup"><span data-stu-id="970d7-104">Actual vs budget Power BI content</span></span>
...
|-----------------------------|---------|
| <span data-ttu-id="970d7-117">Wydatki — wartości rzeczywiste a budżet</span><span class="sxs-lookup"><span data-stu-id="970d7-117">Expenses - Actual vs budget</span></span> | <ul><li><span data-ttu-id="970d7-118">Łączne wydatki w roku</span><span class="sxs-lookup"><span data-stu-id="970d7-118">Total expenses this year</span></span></li><li><span data-ttu-id="970d7-119">Łączne zabudżetowane wydatki w roku</span><span class="sxs-lookup"><span data-stu-id="970d7-119">Budget total expenses this year</span></span></li></ul> |
| <span data-ttu-id="970d7-120">Przychody — wartości rzeczywiste a budżet</span><span class="sxs-lookup"><span data-stu-id="970d7-120">Revenue - Actual vs budget</span></span>  | <ul><li><span data-ttu-id="970d7-121">Łączne przychody w roku</span><span class="sxs-lookup"><span data-stu-id="970d7-121">Total revenue this year</span></span></li><li><span data-ttu-id="970d7-122">Łączne zabudżetowane przychody w roku</span><span class="sxs-lookup"><span data-stu-id="970d7-122">Budget total revenue this year</span></span></li><ul> |
| <span data-ttu-id="970d7-123">Wydatki</span><span class="sxs-lookup"><span data-stu-id="970d7-123">Expense</span></span>                     | <ul><li><span data-ttu-id="970d7-124">Łączne wydatki w roku</span><span class="sxs-lookup"><span data-stu-id="970d7-124">Total expenses this year</span></span></li><li><span data-ttu-id="970d7-125">Cel wydatków założony w budżecie</span><span class="sxs-lookup"><span data-stu-id="970d7-125">Goal for expenses based on budget</span></span> </li><ul> |
| <span data-ttu-id="970d7-126">Przychód</span><span class="sxs-lookup"><span data-stu-id="970d7-126">Revenue</span></span>                     | <ul><li><span data-ttu-id="970d7-127">Łączne przychody w roku</span><span class="sxs-lookup"><span data-stu-id="970d7-127">Total revenue this year</span></span></li><li><span data-ttu-id="970d7-128">Cel przychodów założony w budżecie</span><span class="sxs-lookup"><span data-stu-id="970d7-128">Goal for revenue based on budget</span></span> </li><ul> |
...
|---------------------------|----------|
| <span data-ttu-id="970d7-135">Działania na księdze głównej</span><span class="sxs-lookup"><span data-stu-id="970d7-135">General Ledger Activities</span></span> | <span data-ttu-id="970d7-136">Kwoty transakcji w księdze głównej</span><span class="sxs-lookup"><span data-stu-id="970d7-136">Transaction amounts for the general ledger</span></span> |
| <span data-ttu-id="970d7-137">Działania na budżecie</span><span class="sxs-lookup"><span data-stu-id="970d7-137">Budget Activities</span></span>         | <span data-ttu-id="970d7-138">Kwoty transakcji w rejestrze budżetu</span><span class="sxs-lookup"><span data-stu-id="970d7-138">Transaction amounts for the budget register</span></span> |
| <span data-ttu-id="970d7-139">Konta główne</span><span class="sxs-lookup"><span data-stu-id="970d7-139">Main Accounts</span></span>             | <span data-ttu-id="970d7-140">Konta główne, według których będą filtrowane raporty</span><span class="sxs-lookup"><span data-stu-id="970d7-140">Main accounts to filter reports by</span></span> |
| <span data-ttu-id="970d7-141">Kalendarze obrachunkowe</span><span class="sxs-lookup"><span data-stu-id="970d7-141">Fiscal Calendars</span></span>          | <span data-ttu-id="970d7-142">Kalendarze obrachunkowe, według których będą filtrowane raporty</span><span class="sxs-lookup"><span data-stu-id="970d7-142">Fiscal calendars to filter reports by</span></span> |
| <span data-ttu-id="970d7-143">Księgi</span><span class="sxs-lookup"><span data-stu-id="970d7-143">Ledgers</span></span>                   | <span data-ttu-id="970d7-144">Księgi, które można wyfiltrować jako bieżące księgi dla raportu</span><span class="sxs-lookup"><span data-stu-id="970d7-144">Ledgers that can be used to filter the report to the current ledger</span></span> |
| <span data-ttu-id="970d7-145">Kody budżetu</span><span class="sxs-lookup"><span data-stu-id="970d7-145">Budget Codes</span></span>              | <span data-ttu-id="970d7-146">Kody budżetu, według których będą filtrowane raporty</span><span class="sxs-lookup"><span data-stu-id="970d7-146">Budget codes to filter reports by</span></span> |
| <span data-ttu-id="970d7-147">Firmy</span><span class="sxs-lookup"><span data-stu-id="970d7-147">Legal Entities</span></span>            | <span data-ttu-id="970d7-148">Firmy, które można wyfiltrować jako bieżące firmy dla raportu</span><span class="sxs-lookup"><span data-stu-id="970d7-148">Legal entities that can be used to filter the report to the current legal entity</span></span> |

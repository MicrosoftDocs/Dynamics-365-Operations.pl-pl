...
---
# <a name="modify-and-run-format-to-use-document-management-files-in-format-outputs"></a>Modyfikowanie i uruchamianie formatu w celu używania plików zarządzania dokumentami w danych wyjściowych formatu

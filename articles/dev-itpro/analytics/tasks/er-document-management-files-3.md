...
---
# <a name="create-format-to-use-document-management-files-in-format-outputs"></a>Tworzenie formatu w celu używania plików zarządzania dokumentami w danych wyjściowych formatu

--- 
title: "Definiowanie zależności konfiguracji od innych składników"
...
---
# <a name="define-the-dependency-of-configurations-from-other-components"></a>Definiowanie zależności konfiguracji od innych składników 

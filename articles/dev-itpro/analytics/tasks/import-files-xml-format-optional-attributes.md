...
9. W drzewie rozwiń węzeł **format\root: XML Element (root)**.
10. W drzewie wybierz **1format\root: XML Element(root)\document: XML Element 1..* (dokument)**.
11. Kliknij opcję **Powiąż**.
12. W drzewie rozwiń **format\root: XML Element(root)\document: XML Element 1..* (dokument)**.
13. W drzewie wybierz **1format\root: XML Element(root)\document: XML Element 1..* (dokument)\identyfikator**.

...
4. Na otwartej stronie **Zarządzanie adresami** musisz określić poniższe ustawienia:
...
1. Pobierz pliki konfiguracji dla dostawcy dokumentów fiskalnych i łącznika fiskalnego:
    ...
    1. Pobierz plik konfiguracji dostawcy dokumentów fiskalnych z lokalizacji **Configurations \> DocumentProviders \> DocumentProviderFiscalEFRSampleCzech.xml**.
...
> [!NOTE]
> - Przykładowa integracja usługi rejestracji obrachunkowej dla Republiki Czeskiej jest dostępna w zestawie SDK do Commerce w wersji 10.0.29. W wersji Commerce 10.0.28 lub wcześniejszej musisz użyć poprzedniej wersji zestawu SDK do Retail na maszynie wirtualnej dewelopera w usłudze LCS. Aby uzyskać więcej informacji, zobacz [Wskazówki dotyczące wdrażania przykładu integracji fiskalnej dla Republiki Czeskiej (starsza wersja)](emea-cze-fi-sample-sdk.md).

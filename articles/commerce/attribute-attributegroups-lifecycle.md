...
Ustawienia filtrów atrybutów pozwalają określić sposób wyświetlania filtrów atrybutów w POS. Aby uzyskać dostęp do ustawień filtrów atrybutów, na stronie **Atrybuty** zaznacz atrybut, a następnie w okienku akcji wybierz opcję **Ustawienia filtra**.
...
- **Wartość progowa** — to ustawienie jest wymagane, jeśli jako typ sterowania wyświetlaniem wybrano opcję **Zakres**. W celu zdefiniowania wartości można użyć średnika (;) jako separatora.
    ...
    Na przykład dla filtra takiego jak **Objętości worka** pole wartości progowej może zawierać wartości **10; 20; 50; 100; 200; 500; 1000; 5000**. W tym przypadku w POS będą wyświetlane następujące zakresy. Wszystkie zakresy, które w zbiorze wyników nie mają żadnych produktów, będą wyświetlane jako wygaszone.
...
Po zdefiniowaniu atrybutów można je przypisać do grup atrybutów. *Grupa atrybutów* jest używana do grupowania indywidualnych atrybutów składnika lub podskładnika w modelu konfiguracji produktu. Ten sam atrybut można dołączyć do więcej niż jednej grupy atrybutów. Grupy atrybutów mogą pomóc użytkownikom konfigurować produkty, ponieważ różne opcje wyboru są rozmieszczane w określonym kontekście. Grupy atrybutów można przypisywać do kategorii i kanałów.
...
1. Zaloguj się na kliencie narzędzi zaplecza jako kierownik ds. merchandisingu.
2. Wybierz kolejno opcje **Retail i Commerce** &gt; **Zarządzanie kategoriami i produktami** &gt; **Hierarchia produktów Commerce**.
...
>
> - Retail i Commerce &gt; Zarządzanie kategoriami i produktami &gt; Kategorie nawigacji kanału
> - Retail i Commerce &gt; Zarządzanie kategoriami i produktami &gt; Uzupełniające kategorie produktów

### <a name="assign-attribute-groups-to-stores"></a>Przypisywanie grup atrybutów do kategorii sklepów

Można skojarzyć jedną lub kilka grup atrybutów z jednym lub więcej sklepami w hierarchii sklepów. Wtedy gdy produkty zostaną uwzględnione w określonych sklepach, odziedziczą atrybuty włączone do grup atrybutów.

1. Zaloguj się na kliencie narzędzi zaplecza jako kierownik ds. merchandisingu.
2. Wybierz kolejno opcje **Retail i Commerce** &gt; **Ustawienia kanału** &gt; **Kategorie kanału sprzedaży i atrybuty produktów**.
...
Wartości domyślne atrybutów można zastąpić dla poszczególnych produktów na poziomie produktu. Dla poszczególnych produktów można również zastąpić domyślne wartości atrybutów w określonych katalogach kierowanych do konkretnych kanałów.
...
1. Zaloguj się na kliencie narzędzi zaplecza jako kierownik ds. merchandisingu.
2. Wybierz kolejno opcje **Retail i Commerce** &gt; **Zarządzanie kategoriami i produktami** &gt; **Zwolnione produkty według kategorii**.
...
1. Zaloguj się na kliencie narzędzi zaplecza jako kierownik ds. merchandisingu.
2. Wybierz kolejno opcje **Retail i Commerce** &gt; **Zarządzanie katalogami** &gt; **Wszystkie katalogi**.

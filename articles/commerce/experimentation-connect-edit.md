...
W tym temacie opisano sposób łączenia doświadczenia w Commerce i wprowadzania zmian w odmianach, dzięki czemu są one zgodne z hipotezą. Na poniższym diagramie przedstawiono wszystkie kroki związane z konfigurowaniem i przeprowadzaniem eksperymentu na stronie internetowej środowiska handlu elektronicznego w systemie Dynamics 365 Commerce. Dodatkowe kroki są zawarte w odrębnych tematach.
...
1. Aby uruchomić kreatora, wybierz kartę **Eksperymenty** w konstruktorze witryn, a następnie wybierz opcję **Połącz**. Alternatywnie można uzyskać dostęp do kreatora ze strony lub z edytora fragmentów. W trybie edycji wybierz opcję **Połącz eksperyment** na pasku poleceń.

...
description: Ten temat zawiera instrukcje podłączania rozwiązania Azure Data Lake Storage Gen 2 do magazynu encji środowiska Dynamics 365 Commerce. Jest to krok wymagany przed włączeniem rekomendacji produktów.
author: bebeale
ms.date: 08/31/2020
ms.topic: article
ms.prod: ''
...
Ten temat zawiera instrukcje podłączania rozwiązania Azure Data Lake Storage Gen2 do magazynu encji środowiska Dynamics 365 Commerce. Jest to krok wymagany przed włączeniem rekomendacji produktów.

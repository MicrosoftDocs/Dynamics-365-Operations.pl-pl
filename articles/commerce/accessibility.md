...
| Funkcja wideo               | Opis |
|-----------------------------|-------------|
| Napisy      | Tekst, który może być wyświetlany dla dźwięku i opisowych elementów dźwiękowych w filmie wideo, aby pomóc użytkownikom niedosłyszącym |
...
W aplikacji Dynamics 365 Commerce w sekcji **Elementy zawartości** witryny możesz przesyłać zasoby wideo, które mają oddzielne pliki napisów, dźwięku zwykłego i dźwięku opisowego. Napisy mogą być również generowane automatycznie po przekazaniu elementu zawartości wideo.
...
1. Przejdź do obszaru **Elementy zawartości**, wybierz element zawartości wideo, a następnie wybierz pozycję **Edytuj napisy/transkrypcję**. Zostanie wyświetlony edytor zawartości napisów i transkrypcji.
1. Wybierz **Wyewidencjonuj**.
1. Edytuj tekst napisów lub transkrypcji.
1. Po zakończeniu wybierz pozycję **Zapisz**, a następnie wybierz pozycję **Zaewidencjonuj**.
...
1. Przejdź do sekcji **Elementy zawartości**i wybierz element zawartości wideo.
1. Wybierz **Wyewidencjonuj**.

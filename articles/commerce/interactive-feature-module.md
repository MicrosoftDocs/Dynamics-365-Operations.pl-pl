...
1. W oknie dialogowym **Dodawanie modułu** wybierz moduł **Funkcja interaktywna** i wybierz przycisk **OK**.
...
1. W oknie dialogowym **Dodawanie modułu** w obszarze **Wybierz moduły** wybierz moduł **Funkcja interaktywna** i wybierz przycisk **OK**.
...
1. W oknie dialogowym **Dodawanie modułu** wybierz moduł **Element funkcji interaktywnej** i wybierz przycisk **OK**.

...
description: W tym artykule wyjaśniono, jak skonfigurować bufory zapasów i poziomy zapasów, które decydują o dostępności zapasów w witrynach Microsoft Dynamics 365 Commerce.
author: boycezhu
ms.date: 06/01/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8853800"
---
# <a name="configure-inventory-buffers-and-inventory-levels"></a>Konfigurowanie buforów zapasów i poziomów zapasów

[!include [banner](includes/banner.md)]

W tym artykule wyjaśniono, jak skonfigurować bufory zapasów i poziomy zapasów, które decydują o wiadomościach o dostępności zapasów w witrynach Microsoft Dynamics 365 Commerce.

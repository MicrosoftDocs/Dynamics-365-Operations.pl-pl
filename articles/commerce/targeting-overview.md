...
description: W tym artykule opisano sposób tworzenia, edytowania i zarządzania grupami odbiorców i obiektów docelowych w konstruktorze witryn Microsoft Dynamics 365 Commerce przy użyciu informacji o urządzeniach, rynku i geolokalizacji.
author: sushma-rao
ms.date: 02/03/2022
ms.topic: overview
ms.prod: ''

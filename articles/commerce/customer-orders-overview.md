...
Ten temat zawiera informacje o funkcjonalności zamówień odbiorców w Modern POS (MPOS). Zamówienia odbiorców są również nazywane zamówieniami specjalnymi. Temat przedstawia powiązane parametry i przepływy transakcji.
...
Oto kilka parametrów, które można skonfigurować na stronie **Parametry Commerce** w celu zdefiniowania sposobu realizacji zamówień odbiorców:
...
### <a name="create-a-customer-order-in-modern-pos"></a>Utwórz zamówienie odbiorcy w Modern POS

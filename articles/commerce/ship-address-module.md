...
description: W tym artykule omówiono moduł adresu wysyłki i wyjaśniono, jak go skonfigurować w Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 02/11/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9275013"
---
# <a name="shipping-address-module"></a>Moduł adresu wysyłki

[!include [banner](includes/banner.md)]

W tym artykule omówiono moduł adresu wysyłki i wyjaśniono, jak go skonfigurować w Microsoft Dynamics 365 Commerce.

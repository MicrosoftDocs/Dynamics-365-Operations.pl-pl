...
description: W tym artykule opisano, jak pracować z układami predefiniowanymi w Microsoft Dynamics 365 Commerce.
author: phinneyridge
ms.date: 02/03/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9286284"
---
# <a name="work-with-preset-layouts"></a>Praca z układami predefiniowanymi

[!include [banner](includes/banner.md)]

W tym artykule opisano, jak pracować z układami predefiniowanymi w Microsoft Dynamics 365 Commerce.

Przed wykonaniem procedur opisanych w tym artykule należy koniecznie przeczytać [Układ predefiniowany i niestandardowy](templates-layouts-overview.md#preset-and-custom-layouts). Aby zapoznać się z ogólnym omówieniem, zajrzyj do [Omówienie szablonów i układów](templates-layouts-overview.md).

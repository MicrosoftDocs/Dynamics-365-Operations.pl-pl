...
description: W tym artykule wyjaśniono sposób konfigurowania i używania zmian w punkcie sprzedaży detalicznej (POS) Commerce.
author: josaw1
ms.date: 05/10/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9287465"
---
# <a name="shift-and-cash-drawer-management"></a>Zarządzanie zmianami i szufladami kasowymi

[!include [banner](includes/banner.md)]

W tym artykule wyjaśniono sposób konfigurowania i używania zmian w punkcie sprzedaży detalicznej (POS) Commerce.

...
Ten temat zawiera wskazówki dotyczące rozwiązywania problemów, które mogą pomóc w przypadku, gdy sklep detaliczny nie jest wyświetlany na liście sklepów, w których można odbierać towary.
...
[Tworzenie jednostki operacyjnej](https://docs.microsoft.com/dynamics365/fin-ops-core/fin-ops/organization-administration/tasks/create-operating-unit)

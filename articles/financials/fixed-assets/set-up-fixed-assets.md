...
Aby uzyskać więcej informacji, zobacz [Konfigurowanie ksiąg](tasks/set-up-value-models.md).
...
Aby uzyskać więcej informacji, zobacz [Tworzenie środków trwałych](tasks/create-fixed-asset.md).

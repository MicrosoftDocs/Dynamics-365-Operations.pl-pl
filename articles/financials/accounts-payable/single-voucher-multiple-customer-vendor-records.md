...
|             |                  |              |                 |           |            |
|-------------|------------------|--------------|-----------------|-----------|------------|
| **Załącznik** | **Typ konta** | **Konto**  | **Opis** | **Strona debetowa** | **Strona kredytowa** |
...
|             |              |                      |           |            |
|-------------|--------------|----------------------|-----------|------------|
| **Załącznik** | **Konto**  | **Typ księgowania**     | **Strona debetowa** | **Strona kredytowa** |
...
|             |                  |             |                 |           |            |                  |              |
|-------------|------------------|-------------|-----------------|-----------|------------|------------------|--------------|
| **Załącznik** | **Typ konta** | **Konto** | **Opis** | **Strona debetowa** | **Strona kredytowa** | **Typ konta** | **Konto**  |
...
|                    |                  |           |            |
|--------------------|------------------|-----------|------------|
| **Konto finansowe** | **Typ księgowania** | **Strona debetowa** | **Strona kredytowa** |

---
title: Strona listy Transakcja odbiorcy
description: "Ten temat zawiera informacje o stronie listy Transakcja odbiorcy dostępnej w programie Microsoft Dynamics 365 for Finance and Operations."
author: mikefalkner
manager: aolson
ms.date: 08/02/2018
ms.topic: article
...
# <a name="customer-transaction-list-page"></a>Strona listy Transakcja odbiorcy
...
1. Wybierz kolejno opcje **Rozrachunki z odbiorcami \> Odbiorcy**.
2. Wybierz odbiorcę mającego transakcje, a następnie wybierz kolejno opcje **Odbiorca \> Transakcje**.
3. Wybierz transakcję, którą chcesz zbadać.
4. W okienku akcji kliknij kartę **Wyświetl rozliczenia**.

    W oknie dialogowym **Wyświetl rozliczenia** widać wybraną transakcję oraz wszystkie dokumenty, które zostały rozliczone względem niej. To okno dialogowe przypomina widok historii rozliczeń, ale zawiera wszystkich powiązane dokumenty. 

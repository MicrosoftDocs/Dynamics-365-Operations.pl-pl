...
1. Wybierz kolejno opcje Podatek > Ustawienia > Podatek > Kody raportowania podatku.
2. Kliknij przycisk Nowy.
3. Zaznacz układ raportu, do którego odnosi się kod raportowania.
    * Ten układ jest używany do filtrowania dostępnych kodów raportowania dla kodu podatku. Każdy kod podatku należy do okresu rozliczeniowego obowiązującego w urzędzie skarbowym, który wykorzystuje układ raportu.  
4. Wpisz liczbę odwołującą się do pola w raporcie podatku.

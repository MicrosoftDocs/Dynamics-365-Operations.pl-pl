...
# <a name="synchronize-products-directly-from-finance-and-operations-to-products-in-sales"></a>Synchronizowanie produktów bezpośrednio w rozwiązaniu Finance and Operations do produktów w rozwiązaniu Sales
...
Ten temat zawiera omówienie szablonów i podstawowych zadań, które są używane do synchronizowania produktów bezpośrednio między programem Microsoft Dynamics 365 for Finance and Operations Enterprise Edition a programem Microsoft Dynamics 365 for Sales.

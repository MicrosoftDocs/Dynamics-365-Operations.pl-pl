...
description: Artykuł zawiera omówienie szablonów i podstawowych zadań, które są używane do synchronizowania nagłówków i wierszy faktur sprzedaży bezpośrednio między Dynamics 365 Supply Chain Management a Dynamics 365 Sales.
author: Henrikan
ms.date: 10/26/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9103284"
---
# <a name="synchronize-sales-invoice-headers-and-lines-directly-from-finance-and-operations-to-sales"></a>Synchronizowanie nagłówków i wierszy faktur sprzedaży z aplikacji finansowych i operacyjnych bezpośrednio z elementami w rozwiązaniu Sales

[!include [banner](../includes/banner.md)]

Artykuł zawiera omówienie szablonów i podstawowych zadań, które są używane do synchronizowania nagłówków i wierszy faktur sprzedaży bezpośrednio między Dynamics 365 Supply Chain Management a Dynamics 365 Sales.
...
![Mapowanie szablonu w integracji danych dla SalesInvoiceHeader.](./media/sales-invoice-direct-template-mapping-data-integrator-1.png)

### <a name="salesinvoiceline"></a>SalesInvoiceLine

![Mapowanie szablonu w integracji danych dla SalesInvoiceLine.](./media/sales-invoice-direct-template-mapping-data-integrator-2.png)

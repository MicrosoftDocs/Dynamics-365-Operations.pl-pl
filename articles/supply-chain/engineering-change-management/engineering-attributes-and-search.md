...
#### <a name="turn-engineering-attribute-inheritance-on-or-off"></a>Włącz lub wyłącz dziedziczenie atrybutów inżynierskich

Funkcja wymaga włączania w *systemie zarówno zarządzania zmianami inżynieryjnymi*, jak i *Ulepszone dziedziczenie atrybutów dla zarządzania zmianami inżynierskimi*. Aby uzyskać szczegółowe informacje dotyczące sposobu włączanie i wyłączanie tych funkcji, zobacz [omówienie zarządzania zmianami inżynieryjnymi](product-engineering-overview.md).

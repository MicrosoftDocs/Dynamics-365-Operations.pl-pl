...
description: Ten artykuł zawiera informacje dotyczące pojęć związanych z wersjami inżynieryjnymi. Wersje inżynieryjne zapewniają, że różne stany produktu i jego danych są aktualne i przejrzyste oraz że można je wizualizować w systemie.
author: t-benebo
ms.date: 04/07/2022
ms.topic: article
ms.prod: ''

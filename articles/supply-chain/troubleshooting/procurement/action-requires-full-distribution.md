---
title: Akcję zamówienia zakupu można ukończyć tylko dla w pełni rozdzielonych numerów wiersza
description: Akcję zakupu można ukończyć tylko dla w pełni dystrybuowanych numerów wiersza
author: kamaybac
ms.date: 05/31/2021
...
ms.locfileid: "7477346"
---
# <a name="you-can-only-complete-a-purchase-order-action-for-fully-distributed-line-numbers"></a>Akcję zamówienia zakupu można ukończyć tylko dla w pełni rozdzielonych numerów wiersza

## <a name="symptom"></a>Objaw

Akcję zakupu można ukończyć tylko dla w pełni dystrybuowanych numerów wiersza.

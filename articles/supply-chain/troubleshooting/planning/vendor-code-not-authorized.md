...
Aby uzyskać więcej informacji, zobacz [Zatwierdzanie dostawców dla konkretnych produktów](../../procurement/tasks/approve-vendors-specific-products.md).

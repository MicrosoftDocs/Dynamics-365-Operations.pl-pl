...
description: W tym artykule opisano sposób tworzenia zmiennych testowych, których można używać w testach jakościowych w zleceniach kontroli jakości w systemie Microsoft Dynamics 365 Supply Chain Management.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8857642"
---
# <a name="quality-management-test-variables"></a>Zmienne testowe zarządzania jakością

[!include [banner](../includes/banner.md)]

W tym artykule opisano sposób tworzenia zmiennych testowych, których można używać w testach jakościowych w zleceniach kontroli jakości w systemie Microsoft Dynamics 365 Supply Chain Management.

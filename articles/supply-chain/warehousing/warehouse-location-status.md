...
description: Ten artykuł stanowi przegląd funkcji stanu lokalizacji w magazynie.
author: Mirzaab
ms.date: 08/09/2022
ms.topic: article
ms.prod: ''
...
## <a name="turn-the-warehouse-location-status-feature-on-or-off"></a>Włącz lub wyłącz funkcję stanu dodatkowej strefy lokalizacji w magazynie

Aby używać tej funkcji, należy ją włączyć dla systemu. Od wersji 10.0.29 Supply Chain Management funkcja jest obowiązkowa i nie można jej wyłączyć. Jeśli używasz wersji starszej niż 10.0.29, administratorzy mogą włączyć lub wyłączyć tę funkcję, wyszukując funkcję *Stan lokalizacji w magazynie* w obszarze roboczym [Zarządzanie funkcjami](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md).

---
title: Częściowa wysyłka ładunku w transporcie
description: W tym artykule wyjaśniono, jak można częściowo wysłać ładunek i odłożyć planowania pojemności dla ładunku.
author: Mirzaab
ms.date: 03/15/2017
ms.topic: article
ms.prod: ''

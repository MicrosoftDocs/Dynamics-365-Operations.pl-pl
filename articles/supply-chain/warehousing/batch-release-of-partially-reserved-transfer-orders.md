...
description: W tym artykule opisano sposób konfigurowania i stosowania zwalniania wsadowego częściowo zarezerwowanych zamówień przeniesienia z urządzenia przenośnego.
author: perlynne
ms.date: 05/26/2017
ms.topic: article
ms.prod: ''

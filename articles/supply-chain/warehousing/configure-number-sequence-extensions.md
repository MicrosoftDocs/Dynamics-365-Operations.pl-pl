...
description: W tym artykule opisano funkcje, które umożliwiają obsługę rozszerzeń sekwencji identyfikatorów dla numerów identyfikacyjnych, identyfikatorów etykiet grupy czynności, identyfikatorów kontenerów i identyfikatorów list przewozowych.
author: Mirzaab
ms.date: 06/10/2020
ms.topic: article
ms.prod: ''

...
Od wersji 10.0.25 Supply Chain Management version ta funkcja jest domyślnie włączona. Od wersji 10.0.29 Supply Chain Management version ta funkcja jest wymagana. W związku z tym jest domyślnie włączona i nie można jej ponownie wyłączyć. Jeśli używasz wersji starszej niż 10.0.29, administratorzy mogą włączyć lub wyłączyć tę funkcję, wyszukując funkcję *Przetwarzanie zdarzeń aplikacji magazynowej* w obszarze roboczym [Zarządzanie funkcjami](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md).

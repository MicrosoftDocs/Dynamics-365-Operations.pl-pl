...
ms.locfileid: "859766"
---
# <a name="warehouse-mobile-device-display-settings"></a>Ustawienia wyświetlania urządzeń przenośnych używanych w magazynie

[!include [banner](../includes/banner.md)]

> [!NOTE]
> Ta funkcja jest przestarzała. Aby uzyskać więcej informacji, zobacz [Usunięte i przestarzałe funkcje](../../dev-itpro/migration-upgrade/deprecated-features.md#warehouse-mobile-devices-portal).

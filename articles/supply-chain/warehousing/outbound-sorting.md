...
### <a name="set-up-a-wave-template"></a><span data-ttu-id="c2f3a-123">Konfigurowanie szablonu grupy czynności</span><span class="sxs-lookup"><span data-stu-id="c2f3a-123">Set up a wave template</span></span>
...
1. <span data-ttu-id="c2f3a-139">Na skróconej karcie **Użytkownicy** wybierz opcję **Nowy**, aby utworzyć konto urządzenia przenośnego, i określ dla niego następujące wartości:</span><span class="sxs-lookup"><span data-stu-id="c2f3a-139">On the **Users** FastTab, select **New** to create a mobile device account, and set the following values for it:</span></span>
    ...
    - <span data-ttu-id="c2f3a-140">**Identyfikator użytkownika:** wprowadź unikatowy identyfikator.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-140">**User ID:** Enter a unique ID.</span></span>
...
### <a name="set-up-warehouse-management-parameters"></a><span data-ttu-id="c2f3a-157">Konfigurowanie parametrów zarządzania magazynem</span><span class="sxs-lookup"><span data-stu-id="c2f3a-157">Set up Warehouse management parameters</span></span>
...
### <a name="set-up-a-location"></a><span data-ttu-id="c2f3a-173">Ustaw lokalizację</span><span class="sxs-lookup"><span data-stu-id="c2f3a-173">Set up a location</span></span>
...
1. <span data-ttu-id="c2f3a-192">Na skróconej karcie **Ogólne** ustaw następujące wartości:</span><span class="sxs-lookup"><span data-stu-id="c2f3a-192">On the **General** FastTab, set the following values:</span></span>
...
1. <span data-ttu-id="c2f3a-202">W edytorze zapytań na karcie **Sortowanie** dodaj wiersz o następujących wartościach:</span><span class="sxs-lookup"><span data-stu-id="c2f3a-202">In the query editor, on the **Sorting** tab, add a line that has the following values:</span></span>
    ...
    - <span data-ttu-id="c2f3a-209">**Kierunek wyszukiwania:** *Rosnąco*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-209">**Search direction:** *Ascending*</span></span>
...
1. <span data-ttu-id="c2f3a-226">Na skróconej karcie **Omówienie** ustaw następujące wartości:</span><span class="sxs-lookup"><span data-stu-id="c2f3a-226">On the **Overview** FastTab, set the following values:</span></span>
    ...
    - <span data-ttu-id="c2f3a-227">**Magazyn:** *62*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-227">**Warehouse:** *62*</span></span>
...
<span data-ttu-id="c2f3a-245">Umożliwia skonfigurowanie klasy pracy, która będzie używana razem z sortowaniem.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-245">Set up a work class that will be used together with sorting.</span></span>
...
1. <span data-ttu-id="c2f3a-262">Na skróconej karcie **Ogólne** ustaw następujące wartości:</span><span class="sxs-lookup"><span data-stu-id="c2f3a-262">On the **General** FastTab, set the following values:</span></span>
...
1. <span data-ttu-id="c2f3a-279">Na skróconej karcie **Klasy pracy** wybierz opcję **Nowy**, a następnie określ następujące wartości:</span><span class="sxs-lookup"><span data-stu-id="c2f3a-279">On the **Work classes** FastTab, select **New**, and then set the following values:</span></span>
    ...
    - <span data-ttu-id="c2f3a-280">I **dentyfikator klasy pracy:** *SORTOWANIE*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-280">**Work class ID:** *SORT*</span></span>
...
#### <a name="set-up-a-single-sku-directive"></a><span data-ttu-id="c2f3a-296">Konfigurowanie pojedyńczej dyrektywy SKU</span><span class="sxs-lookup"><span data-stu-id="c2f3a-296">Set up a single-SKU directive</span></span>
...
1. <span data-ttu-id="c2f3a-315">Na skróconej karcie **Akcje dyrektywy lokalizacji** wybierz opcję **Nowy**, a następnie określ następujące wartości w nowym wierszu:</span><span class="sxs-lookup"><span data-stu-id="c2f3a-315">On the **Location Directive Actions** FastTab, select **New**, and then set the following values on the new line.</span></span> <span data-ttu-id="c2f3a-316">Zaakceptuj wartość domyślną dla wszystkich pozostałych pól.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-316">Accept the default values for all the other fields.</span></span>
    ...
    - <span data-ttu-id="c2f3a-317">**Sekwencja:** *1*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-317">**Sequence:** *1*</span></span>
...
1. <span data-ttu-id="c2f3a-336">Wybierz opcję **Zapisz**, aby pasek narzędzi na skróconej karcie **Wiersze** stał się dostępny.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-336">Select **Save** to make the toolbar on the **Lines** FastTab available.</span></span>
...
1. <span data-ttu-id="c2f3a-353">Wybierz kolejno opcje **Zarządzanie magazynem \> Ustawienia \> Praca \> Szablony pracy**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-353">Go to **Warehouse management \> Setup \> Work \> Work templates**.</span></span>
...
### <a name="create-sales-orders-and-picking-work"></a><span data-ttu-id="c2f3a-371">Tworzenie zlecenia pracy i pobierania zamówienia sprzedaży</span><span class="sxs-lookup"><span data-stu-id="c2f3a-371">Create sales orders and picking work</span></span>
...
1. <span data-ttu-id="c2f3a-407">Na skróconej karcie **Szczegółów wiersza** na karcie **Dostawa** należy określić wartość w polu **Metoda dostawy** na *Flowe-STD*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-407">On the **Line details** FastTab, on the **Delivery** tab, set the **Mode of delivery** field to *Flowe-STD*.</span></span>
...
#### <a name="get-the-work-ids-from-the-work-details"></a><span data-ttu-id="c2f3a-423">Pobierz identyfikatory pracy z szczegółów pracy</span><span class="sxs-lookup"><span data-stu-id="c2f3a-423">Get the work IDs from the work details</span></span>
...
1. <span data-ttu-id="c2f3a-440">Umożliwia przejrzenie informacji na stronie **Zamówienia sprzedaży - Odłożenie**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-440">Review the information on the **Sales orders - Put** page.</span></span> <span data-ttu-id="c2f3a-441">Pole **Loc** powinno wskazywać, że pobrane towary przechodzą na lokalizację *Pakunek*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-441">The **Loc** field should indicate that the picked items are going to the *Pack* location.</span></span>
...
1. <span data-ttu-id="c2f3a-460">Umożliwia przejrzenie informacji na stronie **Zamówienia sprzedaży - Odłożenie**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-460">Review the information on the **Sales orders - Put** page.</span></span> <span data-ttu-id="c2f3a-461">Pole **Loc** powinno wskazywać, że pobrane towary przechodzą na lokalizację *Pakunek*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-461">The **Loc** field should indicate that the picked items are going to the *Pack* location.</span></span>
1. <span data-ttu-id="c2f3a-462">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-462">Select **OK**.</span></span>

    <span data-ttu-id="c2f3a-463">Na stronie **Skanuj identyfikator pracy / identyfikator numeru identyfikacyjnego** jest wyświetlany komunikat „praca wykonana”.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-463">On the **Scan a work ID / license plate ID** page, you receive a "Work Completed" message.</span></span> <span data-ttu-id="c2f3a-464">Ten komunikat wskazuje, że wykonano identyfikator pracy z wiersza 2 zamówienia sprzedaży 2.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-464">This message indicates that the work ID from line 2 of sales order 2 has been completed.</span></span>

### <a name="pack-sales-orders-into-containers"></a><span data-ttu-id="c2f3a-465">Pakowanie zamówień sprzedaży do kontenerów</span><span class="sxs-lookup"><span data-stu-id="c2f3a-465">Pack sales orders into containers</span></span>

#### <a name="pack-sales-order-1-into-containers"></a><span data-ttu-id="c2f3a-466">Pakowanie zamówienia 1 sprzedaży do kontenerów</span><span class="sxs-lookup"><span data-stu-id="c2f3a-466">Pack sales order 1 into containers</span></span>

1. <span data-ttu-id="c2f3a-467">Przejdź do **Zarządzanie magazynem \> Pakowanie i konteneryzacja \> Pakunek**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-467">Go to **Warehouse management \> Packing and containerization \> Pack**.</span></span>

    <span data-ttu-id="c2f3a-468">Wyświetli się okno dialogowe **Wybierz stację pakowania**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-468">The **Select packing station** dialog box appears.</span></span> <span data-ttu-id="c2f3a-469">Domyślnie pole **Pracownik** powinno mieć ustawioną nazwę pracownika skonfigurowanego wcześniej.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-469">By default, the **Worker** field should be set to the name of the worker that you set up earlier.</span></span>

1. <span data-ttu-id="c2f3a-470">Poniższe wartości umożliwiają wyświetlanie i pracę z wysyłkami i kontenerami planowanymi w określonej lokalizacji pakowania:</span><span class="sxs-lookup"><span data-stu-id="c2f3a-470">Set the following values to view and work on shipments and containers that are planned at the specific packing location:</span></span>

    - <span data-ttu-id="c2f3a-471">**Oddział:** *6*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-471">**Site:** *6*</span></span>
    - <span data-ttu-id="c2f3a-472">**Magazyn:** *62*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-472">**Warehouse:** *62*</span></span>
    - <span data-ttu-id="c2f3a-473">**Lokalizacja:** *Pakiet*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-473">**Location:** *Pack*</span></span>
    - <span data-ttu-id="c2f3a-474">**Identyfikator profilu pakowania:** *Sortowanie*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-474">**Packing profile ID:** *Sort*</span></span>

1. <span data-ttu-id="c2f3a-475">Kliknij przycisk **OK**, aby zamknąć okno dialogowe.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-475">Select **OK** to close the dialog box.</span></span>
1. <span data-ttu-id="c2f3a-476">Na stronie **Pakiet**, w polu **Numer identyfikacyjny lub wysyłka**, wprowadź docelowy numer identyfikacyjny dla zamówienia sprzedaży 1.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-476">On the **Pack** page, in the **License plate or shipment** field, enter the target LP for sales order 1.</span></span> <span data-ttu-id="c2f3a-477">Następnie należy wybrać **Kartę** lub klawisz **Enter** na klawiaturze w celu wychodzenia z pola.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-477">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="c2f3a-478">W okienku akcji wybierz opcję **Nowy kontener**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-478">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="c2f3a-479">Zaakceptuj wszystkie ustawienia domyślne i kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-479">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="c2f3a-480">Zanotuj identyfikator kontenera.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-480">Make a note of the container ID.</span></span>
1. <span data-ttu-id="c2f3a-481">Na skróconej karcie **Pakowanie przedmiotów** ustaw następujące wartości:</span><span class="sxs-lookup"><span data-stu-id="c2f3a-481">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="c2f3a-482">**Ilość:** *1*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-482">**Quantity:** *1*</span></span>
    - <span data-ttu-id="c2f3a-483">**Identyfikator:** pozycja *A0001*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-483">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="c2f3a-484">W okienku akcji wybierz opcję **Zamknij kontener**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-484">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="c2f3a-485">W oknie dialogowym **Zamknij kontener** wybierz opcję **Pobierz wagę z systemu**, aby zaktualizować pole **Waga brutto**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-485">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="c2f3a-486">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-486">Select **OK**.</span></span> <span data-ttu-id="c2f3a-487">Kontener zostanie przeniesiony do lokalizacji *SORTOWANIA* i będzie gotowy do sortowania.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-487">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="c2f3a-488">Utwórz drugi kontener, aby dodać drugi towar z numeru identyfikacyjnego dla zamówienia sprzedaży 1 do nowego kontenera.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-488">Create a second container to add the second item from the LP for sales order 1 to a new container.</span></span>
1. <span data-ttu-id="c2f3a-489">W okienku akcji wybierz opcję **Nowy kontener**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-489">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="c2f3a-490">Zaakceptuj wszystkie ustawienia domyślne i kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-490">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="c2f3a-491">Zanotuj identyfikator kontenera.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-491">Make a note of the container ID.</span></span>
1. <span data-ttu-id="c2f3a-492">Na skróconej karcie **Pakowanie przedmiotów** ustaw następujące wartości:</span><span class="sxs-lookup"><span data-stu-id="c2f3a-492">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="c2f3a-493">**Ilość:** *1*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-493">**Quantity:** *1*</span></span>
    - <span data-ttu-id="c2f3a-494">**Identyfikator:** pozycja *A0001*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-494">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="c2f3a-495">W okienku akcji wybierz opcję **Zamknij kontener**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-495">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="c2f3a-496">W oknie dialogowym **Zamknij kontener** wybierz opcję **Pobierz wagę z systemu**, aby zaktualizować pole **Waga brutto**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-496">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="c2f3a-497">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-497">Select **OK**.</span></span> <span data-ttu-id="c2f3a-498">Kontener zostanie przeniesiony do lokalizacji *SORTOWANIA* i będzie gotowy do sortowania.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-498">The container is moved to the *SORT* location and is ready for sorting.</span></span>

#### <a name="pack-sales-order-2-into-containers"></a><span data-ttu-id="c2f3a-499">Pakowanie zamówienia 2 sprzedaży do kontenerów</span><span class="sxs-lookup"><span data-stu-id="c2f3a-499">Pack sales order 2 into containers</span></span>

1. <span data-ttu-id="c2f3a-500">Na stronie **Pakiet**, w polu **Numer identyfikacyjny lub wysyłka**, wprowadź docelowy numer identyfikacyjny dla wiersza 1 zamówienia sprzedaży 2.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-500">On the **Pack** page, in the **License plate or shipment** field, enter the target LP for line 1 of sales order 2.</span></span> <span data-ttu-id="c2f3a-501">Następnie należy wybrać **Kartę** lub klawisz **Enter** na klawiaturze w celu wychodzenia z pola.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-501">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="c2f3a-502">W okienku akcji wybierz opcję **Nowy kontener**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-502">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="c2f3a-503">Zaakceptuj wszystkie ustawienia domyślne i kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-503">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="c2f3a-504">Zanotuj identyfikator kontenera.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-504">Make a note of the container ID.</span></span>
1. <span data-ttu-id="c2f3a-505">Na skróconej karcie **Pakowanie przedmiotów** ustaw następujące wartości:</span><span class="sxs-lookup"><span data-stu-id="c2f3a-505">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="c2f3a-506">**Ilość:** *1*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-506">**Quantity:** *1*</span></span>
    - <span data-ttu-id="c2f3a-507">**Identyfikator:** pozycja *A0001*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-507">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="c2f3a-508">W okienku akcji wybierz opcję **Zamknij kontener**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-508">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="c2f3a-509">W oknie dialogowym **Zamknij kontener** wybierz opcję **Pobierz wagę z systemu**, aby zaktualizować pole **Waga brutto**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-509">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="c2f3a-510">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-510">Select **OK**.</span></span> <span data-ttu-id="c2f3a-511">Kontener zostanie przeniesiony do lokalizacji *SORTOWANIA* i będzie gotowy do sortowania.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-511">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="c2f3a-512">Wpolu **Numer identyfikacyjny lub wysyłka**, wprowadź docelowy numer identyfikacyjny dla wiersza 2 zamówienia sprzedaży 2.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-512">In the **License plate or shipment** field, enter the target LP for line 2 of the sales order 2.</span></span> <span data-ttu-id="c2f3a-513">Następnie należy wybrać **Kartę** lub klawisz **Enter** na klawiaturze w celu wychodzenia z pola.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-513">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="c2f3a-514">W okienku akcji wybierz opcję **Nowy kontener**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-514">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="c2f3a-515">Zaakceptuj wszystkie ustawienia domyślne i kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-515">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="c2f3a-516">Zanotuj identyfikator kontenera.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-516">Make a note of the container ID.</span></span>
1. <span data-ttu-id="c2f3a-517">Na skróconej karcie **Pakowanie przedmiotów** ustaw następujące wartości:</span><span class="sxs-lookup"><span data-stu-id="c2f3a-517">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="c2f3a-518">**Ilość:** *1*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-518">**Quantity:** *1*</span></span>
    - <span data-ttu-id="c2f3a-519">**Pole identyfikatora:** pozycja *A0002*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-519">**Identifier field:** Item *A0002*</span></span>

1. <span data-ttu-id="c2f3a-520">W okienku akcji wybierz opcję **Zamknij kontener**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-520">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="c2f3a-521">W oknie dialogowym **Zamknij kontener** wybierz opcję **Pobierz wagę z systemu**, aby zaktualizować pole **Waga brutto**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-521">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="c2f3a-522">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-522">Select **OK**.</span></span> <span data-ttu-id="c2f3a-523">Kontener zostanie przeniesiony do lokalizacji *SORTOWANIA* i będzie gotowy do sortowania.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-523">The container is moved to the *SORT* location and is ready for sorting.</span></span>

<span data-ttu-id="c2f3a-524">Aby wyświetlić szczegóły kontenera, należy przejść do **Zarządzanie magazynem \> Pakowanie i konteneryzacja \> Kontenery** oraz wyszukać identyfikatory kontenerów, które zostały utworzone podczas pakowania.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-524">To view the container details, go to **Warehouse management \> Packing and containerization \> Containers**, and search for the container IDs that were created during packing.</span></span>

### <a name="sort-the-containers"></a><span data-ttu-id="c2f3a-525">Sortowanie kontenerów</span><span class="sxs-lookup"><span data-stu-id="c2f3a-525">Sort the containers</span></span>

> [!IMPORTANT]
> <span data-ttu-id="c2f3a-526">Po dostępie do elementu menu **Kompilacja palety** w aplikacji mobilnej do sortowania wychodzącego wyświetlany jest przycisk z etykietą **Pełna**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-526">When you access the **Pallet build** menu item on the mobile app to do outbound sorting, you will see a button that is labeled **Full**.</span></span> <span data-ttu-id="c2f3a-527">*Nie używaj przycisku **Pełne** do sortowania lub zamykania stanowiska.*</span><span class="sxs-lookup"><span data-stu-id="c2f3a-527">*Don't use the **Full** button to sort or close the position.*</span></span>
>
> <span data-ttu-id="c2f3a-528">Przycisk **Pełny** jest domyślnie dostępny i nie można go wyłączyć ani usunąć ze strony.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-528">The **Full** button is provided by default and can't be disabled or removed from the page.</span></span> <span data-ttu-id="c2f3a-529">Nie jest używany dla funkcji *Sortowanie towarów wychodzących*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-529">It isn't used for the *Outbound sorting* feature.</span></span>

#### <a name="sort-the-first-container"></a><span data-ttu-id="c2f3a-530">Sortuj pierwszy kontener</span><span class="sxs-lookup"><span data-stu-id="c2f3a-530">Sort the first container</span></span>

1. <span data-ttu-id="c2f3a-531">Na urządzeniu przenośnym zaloguj się do magazynu *62*, używając identyfikatora użytkownika utworzonego dla tego scenariusza (lub identyfikatora użytkownika dla istniejącego użytkownika danych demonstracyjnych).</span><span class="sxs-lookup"><span data-stu-id="c2f3a-531">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="c2f3a-532">W menu głównym wybierz opcję **Wychodzące**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-532">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="c2f3a-533">W menu **Wychodzące** wybierz opcję **Kompilacja palety**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-533">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="c2f3a-534">W polu **LP/Con** wprowadź pierwszy identyfikator kontenera skojarzony z zamówieniem sprzedaży 1.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-534">In the **LP/Con** field, enter the first container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="c2f3a-535">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-535">Select **OK**.</span></span>
1. <span data-ttu-id="c2f3a-536">Ponieważ nie istnieją obecnie pozycje sortowania, należy je określić.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-536">Because no sort positions currently exist, you must specify one.</span></span> <span data-ttu-id="c2f3a-537">W polu **Identyfikator stanowiska sortowania** wprowadź *SP01*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-537">In the **Sort position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="c2f3a-538">Ponieważ żaden numer identyfikacyjny nie jest aktualnie skojarzony z pozycją sortowania *SP01*, należy określić jeden z nich.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-538">Because no LP is currently associated with sort position *SP01*, you must specify one.</span></span> <span data-ttu-id="c2f3a-539">W polu **Numer identyfikacyjny** wprowadź *PLP01*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-539">In the **LP** field, enter *PLP01*.</span></span>
1. <span data-ttu-id="c2f3a-540">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-540">Select **OK**.</span></span>
1. <span data-ttu-id="c2f3a-541">Ponieważ sprawdzanie poprawności pozycji sortowania jest włączone, należy ponownie wprowadzić identyfikator pozycji sortowania.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-541">Because sort position validation is turned on, you must enter the sort position ID again.</span></span> <span data-ttu-id="c2f3a-542">W polu **Identyfikator stanowiska sortowania** wprowadź *SP01*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-542">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="c2f3a-543">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-543">Select **OK**.</span></span>

    <span data-ttu-id="c2f3a-544">Zostanie wyświetlony komunikat „Praca zakończona”.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-544">You receive a "Work completed" message.</span></span>

> [!TIP]
> <span data-ttu-id="c2f3a-545">Aby wyświetlić pozycję sortowania i numer identyfikacyjny w tym celu należy przejść do pola pakowanie w **Zarządzanie magazynem \> Pakowanie i konteneryzacja \> Przypisania stanowisk sortowania towarów wychodzących**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-545">To view the sort position and the LP in it, go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
>
> <span data-ttu-id="c2f3a-546">Na stronie **Przypisania stanowisk sortowania towarów wychodzących** wyświetlane są wszystkie stanowiska, które są obecnie aktywne.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-546">The **Outbound sorting position assignments** page shows all the sort positions that are currently active.</span></span> <span data-ttu-id="c2f3a-547">W polu **Transakcja na stanowisku sortowania** wyświetlany jest numer numer identyfikacyjny skojarzony z poszczególnymi pozycjami sortowania oraz kontenery znajdujące się na położeniu sortowania.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-547">The **Sort position transactions** field shows the LP that is associated with each sort position, and the containers that are in the sort position.</span></span> <span data-ttu-id="c2f3a-548">Zauważ, że jedna pozycja sortowania już istnieje, a skrócona karta **Kryteria stanowiska sortowania** przedstawia kryterium **Wysyłka - usługa przewoźnika - powietrze**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-548">Notice that one sort position currently exists, and that the **Sort position criteria** FastTab shows a criterion of **Shipment – Carrier service - Air**.</span></span>

#### <a name="sort-the-remaining-containers"></a><span data-ttu-id="c2f3a-549">Posortuj pozostałe pojemniki</span><span class="sxs-lookup"><span data-stu-id="c2f3a-549">Sort the remaining containers</span></span>

1. <span data-ttu-id="c2f3a-550">Na urządzeniu przenośnym zaloguj się do magazynu *62*, używając identyfikatora użytkownika utworzonego dla tego scenariusza (lub identyfikatora użytkownika dla istniejącego użytkownika danych demonstracyjnych).</span><span class="sxs-lookup"><span data-stu-id="c2f3a-550">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="c2f3a-551">W menu głównym wybierz opcję **Wychodzące**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-551">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="c2f3a-552">W menu **Wychodzące** wybierz opcję **Kompilacja palety**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-552">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="c2f3a-553">W polu **LP/Con** wprowadź drugi identyfikator kontenera skojarzony z zamówieniem sprzedaży 1.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-553">In the **LP/Con** field, enter the second container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="c2f3a-554">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-554">Select **OK**.</span></span> <span data-ttu-id="c2f3a-555">Ponieważ szablon sortowania jest skonfigurowany do automatycznego sortowania, a pozycja sortowania, która ma kryteria dopasowywania, już istnieje, jest automatycznie kierowana do właściwej pozycji sortowania.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-555">Because the sorting template is set up to sort automatically, and a sort position that has matching criteria already exists, you're automatically directed to the correct sort position.</span></span>
1. <span data-ttu-id="c2f3a-556">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-556">Select **OK**.</span></span>
1. <span data-ttu-id="c2f3a-557">Potwierdź identyfikator stanowiska sortowania, aby wskazać, że ilość zapasów znajduje się w odpowiednim miejscu.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-557">Confirm the sort position ID to indicate that the inventory is in the correct place.</span></span> <span data-ttu-id="c2f3a-558">W polu **Identyfikator stanowiska sortowania** wprowadź *SP01*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-558">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="c2f3a-559">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-559">Select **OK**.</span></span>

    <span data-ttu-id="c2f3a-560">Praca została zakończona dla drugiego kontenera z zamówienia sprzedaży 1.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-560">Work is completed on the second container from sales order 1.</span></span> <span data-ttu-id="c2f3a-561">Teraz zostaną posortowane pozostałe kontenery z zamówienia sprzedaży 2.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-561">You will now sort the remaining containers from sales order 2.</span></span>

1. <span data-ttu-id="c2f3a-562">W polu **LP/Con** wprowadź identyfikator kontenera z zamówienia sprzedaży 2, który zawiera pozycję *A0001*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-562">In the **LP/Con** field, enter the container ID of the container from sales order 2 that holds item *A0001*.</span></span> <span data-ttu-id="c2f3a-563">Ponieważ usługa przewoźnika jest inna, system wyświetli monit o wprowadzenie nowej pozycji sortowania i przypisanie do tego stanowiska obiektu numer identyfikacyjny.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-563">Because the carrier service differs, you're prompted to enter a new sort position and assign an LP to that position.</span></span> <span data-ttu-id="c2f3a-564">Należy skorzystać z pozycji sortowania *SP02* i numer identyfikacyjny *PLP02*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-564">Use sort position *SP02* and LP *PLP02*.</span></span>
1. <span data-ttu-id="c2f3a-565">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-565">Select **OK**.</span></span>
1. <span data-ttu-id="c2f3a-566">Potwierdź pozycję sortowania, wprowadzając *SP02* w polu **Identyfikator pozycji sortowania**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-566">Confirm the sort position by entering *SP02* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="c2f3a-567">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-567">Select **OK**.</span></span>

    <span data-ttu-id="c2f3a-568">Praca w kontenerze została zakończona.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-568">Work is completed on the container.</span></span>

1. <span data-ttu-id="c2f3a-569">W polu **LP/Con** wprowadź identyfikator ostatniego kontenera z zamówienia sprzedaży 2, który zawiera pozycję *A0002*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-569">In the **LP/Con** field, enter the container ID for the remaining container from sales order 2 that holds item *A0002*.</span></span> <span data-ttu-id="c2f3a-570">Ponieważ usługa przewoźnika jest taka sama jak usługa przewoźnika dla zamówienia sprzedaży 1, system pokazuje istniejącą pozycję sortowania, która ma kryteria dopasowywania.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-570">Because the carrier service is the same as the carrier service for sales order 1, the system shows the existing sort position that has matching criteria.</span></span>
1. <span data-ttu-id="c2f3a-571">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-571">Select **OK**.</span></span>
1. <span data-ttu-id="c2f3a-572">Potwierdź pozycję sortowania, wprowadzając *SP01* w polu **Identyfikator pozycji sortowania**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-572">Confirm the sort position by entering *SP01* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="c2f3a-573">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-573">Select **OK**.</span></span>

    <span data-ttu-id="c2f3a-574">Praca w kontenerze została zakończona.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-574">Work is completed on the container.</span></span>

### <a name="close-the-outbound-sorting-positions"></a><span data-ttu-id="c2f3a-575">Zamknij wychodzące pozycje sortowania</span><span class="sxs-lookup"><span data-stu-id="c2f3a-575">Close the outbound sorting positions</span></span>

<span data-ttu-id="c2f3a-576">Po posortowaniu wszystkich zapasów należy zamknąć to stanowisko, aby można było utworzyć pracę.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-576">When all inventory has been sorted, the position must be closed before work can be created.</span></span> <span data-ttu-id="c2f3a-577">Zostaną utworzone posortowane prace związane z pobieraniem zapasów, aby przenieść je do bramy dokowej.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-577">Sorted inventory picking work will be created to take the inventory to the bay door.</span></span>

#### <a name="close-a-position-from-the-mobile-device"></a><span data-ttu-id="c2f3a-578">Zamykanie stanowiska z urządzenia przenośnego</span><span class="sxs-lookup"><span data-stu-id="c2f3a-578">Close a position from the mobile device</span></span>

1. <span data-ttu-id="c2f3a-579">Na urządzeniu przenośnym zaloguj się do magazynu *62*, używając identyfikatora użytkownika utworzonego dla tego scenariusza (lub identyfikatora użytkownika dla istniejącego użytkownika danych demonstracyjnych).</span><span class="sxs-lookup"><span data-stu-id="c2f3a-579">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="c2f3a-580">W menu głównym wybierz opcję **Wychodzące**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-580">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="c2f3a-581">W menu **Wychodzące** wybierz opcję **Kompilacja palety**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-581">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="c2f3a-582">W polu **LP/Con** wprowadź identyfikator kontenera, który został posortowany w celu posortowania pozycji *SP01*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-582">In the **LP/Con** field, enter a container ID that was sorted to sort position *SP01*.</span></span>
1. <span data-ttu-id="c2f3a-583">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-583">Select **OK**.</span></span>
1. <span data-ttu-id="c2f3a-584">Pojawi się następujący komunikat: „Kontener jest już posortowany do stanowiska SP01.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-584">You receive the following message: "The container is already sorted to position SP01.</span></span> <span data-ttu-id="c2f3a-585">Zamknąć to stanowisko?”</span><span class="sxs-lookup"><span data-stu-id="c2f3a-585">Close the position?"</span></span> <span data-ttu-id="c2f3a-586">Kliknij przycisk **Zamknij**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-586">Select **Close**.</span></span>

    <span data-ttu-id="c2f3a-587">Praca została zakończona.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-587">Work is completed.</span></span>

#### <a name="close-a-position-from-outbound-sorting-position-assignments"></a><span data-ttu-id="c2f3a-588">Zamykanie stanowiska z przypisań pozycji sortowania wychodzącego</span><span class="sxs-lookup"><span data-stu-id="c2f3a-588">Close a position from outbound sorting position assignments</span></span>

1. <span data-ttu-id="c2f3a-589">Należy przejść do **Zarządzanie magazynem \> Pakowanie i konteneryzacja \> Przypisania stanowisk sortowania towarów wychodzących**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-589">Go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
1. <span data-ttu-id="c2f3a-590">W lewej kolumnie wybierz **SP02**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-590">In the left column, select **SP02**.</span></span> <span data-ttu-id="c2f3a-591">Ten wiersz określający pozycję sortowania dla zapasów wychodzących jest tym, który zostanie zamknięty.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-591">This outbound sorting position row is the one that you will close.</span></span>
1. <span data-ttu-id="c2f3a-592">W okienku akcji wybierz opcję **Zamknij stanowisko**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-592">On the Action Pane, select **Close position**.</span></span> <span data-ttu-id="c2f3a-593">Rekord stanowiska sortowania jest zamknięty i nie jest już wyświetlany.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-593">The sorting position record is closed and is no longer shown.</span></span>

    > [!TIP]
    > <span data-ttu-id="c2f3a-594">Aby wyświetlić wszystkie rekordy zamkniętych stanowisk, zaznacz pole wyboru **Wyświetl zamknięte**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-594">To show all closed position records, select the **Show closed** check box.</span></span>

### <a name="sorted-inventory-picking"></a><span data-ttu-id="c2f3a-595">Pobranie z posortowanych zapasów</span><span class="sxs-lookup"><span data-stu-id="c2f3a-595">Sorted inventory picking</span></span>

<span data-ttu-id="c2f3a-596">Należy wykonać posortowaną pracę pobrania z magazynu.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-596">You must complete the sorted inventory picking work.</span></span> <span data-ttu-id="c2f3a-597">Po zakończeniu Inwentaryzacja zostanie pobrana do zamówienia sprzedaży.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-597">When it's completed, the inventory will be picked to the sales order.</span></span> <span data-ttu-id="c2f3a-598">W tym momencie obowiązują wszystkie inne procesy magazynowe.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-598">At that point, all other warehouse processes apply.</span></span>

1. <span data-ttu-id="c2f3a-599">Na urządzeniu przenośnym zaloguj się do magazynu *62*, używając identyfikatora użytkownika utworzonego dla tego scenariusza (lub identyfikatora użytkownika dla istniejącego użytkownika danych demonstracyjnych).</span><span class="sxs-lookup"><span data-stu-id="c2f3a-599">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="c2f3a-600">W menu głównym wybierz opcję **Wychodzące**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-600">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="c2f3a-601">W menu **Wychodzące** wybierz opcję **Ładowanie z sortowania**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-601">On the **Outbound** menu, select **Load from Sorting**.</span></span>
1. <span data-ttu-id="c2f3a-602">Wprowadź identyfikator docelowego z pierwszej pozycji sortowania, *SP01*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-602">Enter the target LP ID from the first sort position, *SP01*.</span></span> <span data-ttu-id="c2f3a-603">Ustaw wartość w polu **Identyfikator** na *PLP01*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-603">Set the **ID** field to *PLP01*.</span></span>
1. <span data-ttu-id="c2f3a-604">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-604">Select **OK**.</span></span>
1. <span data-ttu-id="c2f3a-605">Strona **Odbieranie sortowanych zapasów: Odbiór** zawiera listę prac pobrań, które muszą zostać wykonane.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-605">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="c2f3a-606">Pobranie z lokalizacji *SORTOWANIE* i docelowego numeru identyfikacyjnego *PLP01*, który ma wiele towarów i ilość *3*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-606">Pick from the *SORT* location and target LP *PLP01*, which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="c2f3a-607">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-607">Select **OK**.</span></span>
1. <span data-ttu-id="c2f3a-608">Strona **Odbieranie sortowanych zapasów: Odłożenie** zawiera listę prac odkładania, które muszą zostać wykonane.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-608">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="c2f3a-609">Odkładanie z lokalizacji *Baydoor* i docelowego numeru identyfikacyjnego *PLP01*, który ma wiele towarów i ilość *3*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-609">Put to the *Baydoor* location and target LP *PLP01*, which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="c2f3a-610">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-610">Select **OK**.</span></span>

    <span data-ttu-id="c2f3a-611">Praca została zakończona.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-611">Work is completed.</span></span>

1. <span data-ttu-id="c2f3a-612">Wprowadź docelowy numer identyfikacyjny z drugie pozycji sortowania, *SP02*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-612">Enter the target license plate ID from the second sort position, *SP02*.</span></span> <span data-ttu-id="c2f3a-613">Ustaw wartość w polu **Identyfikator** na *PLP02*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-613">Set the **ID** field to *PLP02*.</span></span>
1. <span data-ttu-id="c2f3a-614">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-614">Select **OK**.</span></span>
1. <span data-ttu-id="c2f3a-615">Strona **Odbieranie sortowanych zapasów: Odbiór** zawiera listę prac pobrań, które muszą zostać wykonane.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-615">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="c2f3a-616">Pobranie z lokalizacji *SORTOWANIE* i docelowego numeru identyfikacyjnego *PLP02*, który ma wiele towarów i ilość *1*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-616">Pick from the *SORT* location and target LP *PLP02*, which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="c2f3a-617">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-617">Select **OK**.</span></span>
1. <span data-ttu-id="c2f3a-618">Strona **Odbieranie sortowanych zapasów: Odłożenie** zawiera listę prac odkładania, które muszą zostać wykonane.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-618">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="c2f3a-619">Odkładanie z lokalizacji *Baydoor* i docelowego numeru identyfikacyjnego *PLP02*, który ma wiele towarów i ilość *1*.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-619">Put to the *Baydoor* location and target LP *PLP02*, which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="c2f3a-620">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-620">Select **OK**.</span></span>

    <span data-ttu-id="c2f3a-621">Praca została zakończona.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-621">Work is completed.</span></span>

<span data-ttu-id="c2f3a-622">Od tego momentu obowiązują wszystkie inne procesy magazynowe.</span><span class="sxs-lookup"><span data-stu-id="c2f3a-622">From this point forward, all other warehouse processes apply.</span></span>

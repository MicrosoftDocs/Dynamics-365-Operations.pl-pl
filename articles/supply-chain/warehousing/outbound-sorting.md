...
description: Ten artykuł zawiera informacje o wychodzącym sortowaniu. Ta funkcjonalność ułatwia obsługę małych pojemników i pomaga pracownikom magazynu lepiej planować i organizować pojemność palet w ciężarówce.
author: Mirzaab
ms.date: 07/15/2020
ms.topic: article
ms.prod: ''

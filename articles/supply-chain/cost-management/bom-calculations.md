...
description: Obliczenia łącznego kosztu i ceny sprzedaży są nazywane obliczeniami listy składowej BOM i inicjuje się je ze strony Obliczenia. Ten artykuł zawiera informacje dotyczące obliczeń BOM.
author: JennySong-SH
ms.date: 05/01/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8902810"
---
# <a name="bom-calculations"></a>Obliczenia BOM

[!include [banner](../includes/banner.md)]

Obliczenia łącznego kosztu i ceny sprzedaży są nazywane obliczeniami listy składowej BOM i inicjuje się je ze strony Obliczenia. Ten artykuł zawiera informacje dotyczące obliczeń BOM.

...
- **Międzyfirmowe planowanie główne** — międzyfirmowy plan główny oblicza zapotrzebowania netto w różnych podmiotach prawnych. Łączy on popyt i dostawy między firmami nie tylko w perspektywie krótkoterminowego, ustalonego popytu i dostaw, ale także w perspektywie długoterminowej, zaplanowanej (jeszcze bez ustaleń). Aby uzyskać więcej informacji, zobacz [Planowanie międzyfirmowe](planning-optimization/Intercompany-planning.md).

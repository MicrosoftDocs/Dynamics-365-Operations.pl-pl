...
description: W tym artykule opisano, jak skonfigurować informacje o wysyłce dla modułu Koszt z wyładunkiem.
author: Weijiesa
ms.date: 12/04/2020
ms.topic: article
ms.prod: ''
...
W tym artykule opisano, jak skonfigurować informacje o wysyłce dla modułu **Koszt z wyładunkiem**.

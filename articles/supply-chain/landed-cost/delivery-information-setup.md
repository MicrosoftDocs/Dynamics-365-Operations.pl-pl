...
description: W tym artykule opisano, jak skonfigurować informacje o dostawie dla modułu Koszt dostawy.
author: Weijiesa
ms.date: 12/09/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8895620"
---
# <a name="delivery-information-setup"></a>Konfiguracja informacji o dostawie

[!include [banner](../../includes/banner.md)]

W tym artykule opisano, jak skonfigurować informacje o dostawie dla modułu **Koszt dostawy**.

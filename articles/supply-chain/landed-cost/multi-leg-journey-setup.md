...
description: W tym artykule opisano, jak skonfigurować podróże wieloetapowe dla modułu kosztów z wyładunkiem.
author: Weijiesa
ms.date: 12/04/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8905842"
---
# <a name="multi-leg-journey-setup"></a>Ustawienia podróży wieloetapowej

[!include [banner](../../includes/banner.md)]

W tym artykule opisano, jak skonfigurować podróże wieloetapowe dla modułu **kosztów z wyładunkiem**.

...
Aby wyszukać i edytować rzeczywistą wartość substancji aktywnej dla partii:
1. Wybierz kolejno opcje **Zarządzanie zapasami \> Zapytania i raporty \> Wymiary śledzenia \> Partie**.
1. Wybierz numer partii z siatki.
1. W okienku akcji otwórz kartę **Widok** i wybierz opcję **Atrybuty partii zapasów**.
...
| Typ substancji | Numer towaru | Ilość w wierszu formuły | Jednostka |
|---|---|---|---|
| None | A | 20 | litr |
| Aktywni | mld | 30 | litr |
| Kompensacja | C | 10 | litr |
| Wystawca | D | 40 | litr |

W poniższej tabeli przedstawiono wyniki poszczególnych przykładów.

| Numer towaru | Typ substancji | Ilość szacowana | Zbilansowana ilość | Aktywna ilość | Jednostka | Wartość podstawowa |
|---|---|---|---|---|---|---|
| A | None | 20 | 20 | | litr | |
| W | Aktywne | 30 | 25.71 | 9.00 | litr | 30.00 |
| C | Kompensacja | 10 | 14.72 | | litr | |
| D | Wystawca | 40 | 39.57 | | litr | |

### <a name="active-ingredients"></a>Substancje aktywne
...
#### <a name="active-ingredient-example"></a>Przykład substancji aktywnej
...
### <a name="none-ingredients"></a>Brak substancji

Jeśli zastosujesz proces równoważenia partii, gdy **typem substancji** jest *Brak*, szacowana ilość jest taka sama, jak zbilansowana ilość w wierszu formuły w zamówieniu partii.

#### <a name="none-ingredient-example"></a>Przykład braku substancji
...
### <a name="compensating-ingredients"></a>Substancje kompensujące
...
1. Wybierz opcję **Zarządzanie informacjami o produkcji \> Listy składowe i formuły \> Formuły**.
1. Otwórz wiersz formuły, a następnie wybierz pozycję **Składniki**, aby otworzyć stronę **Reguła kompensacji**.
1. Zaznacz wiersz reprezentujący regułę kompensacji, a następnie zaznacz substancję aktywną, która ma być kompensowana.
...
#### <a name="compensating-ingredient-example"></a>Przykład substancji kompensującej
...
1. Wynik jest mnożony przez współczynnik kompensujący:  
    4,29 × 1,10 = –4,72

1. Szacowana ilość kompensująca jest zmniejszana o –4,72 w celu wyznaczenia zbilansowanej ilości kompensującej:  
    10 – (–4,72) = 14,72
...
### <a name="filler-ingredients"></a>Substancje wypełniające
...
#### <a name="filler-ingredient-example"></a>Przykład substancji wypełniającej
...
1. Potwierdzenie i zwolnienie formuły

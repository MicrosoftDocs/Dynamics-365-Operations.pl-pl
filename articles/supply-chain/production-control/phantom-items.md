...
Na ilustracji poniżej (a) to BOM produktu H oraz części F i G, a (b) to arkusz marszruty dla produktu H i części F.

![Przykład struktury BOM na dwóch poziomach.](media/product-H-part-F.png)
...
![BOM inżynieryjnych dla produktu H.](media/product-H-part-B.png)
...
![Typ wiersza fantomu używany w wielopoziomowych strukturach BOM.](media/product-G-route-sheet-G.png)
...
![Przykład sieci marszruty używanej w wielopoziomowym BOM.](media/product-G-part-F.png)

Na ilustracji poniżej (a) to BOM produktu G i części F, a (b) to arkusz marszruty dla produktu G i części F.

![BOM dla produktu G i części F, a także arkusz marszruty dla produktu G i części F.](media/product-G-part-F-with-route-sheet.png)

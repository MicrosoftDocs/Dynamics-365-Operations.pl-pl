...
W module Zarządzanie składnikami majątku należy skonfigurować ogólne parametry odnoszące się do składników majątku, zleceń pracy i planowania zlecenia pracy. W tym artykule wyjaśniono sposób ich konfigurowania. Wybierz **Zarządzanie składnikami majątku** > **Ustawienia** > **Parametry zarządzania składnikami majątku**, aby otworzyć stronę.

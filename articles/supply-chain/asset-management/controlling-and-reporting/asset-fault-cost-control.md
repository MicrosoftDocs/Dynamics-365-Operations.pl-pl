...
description: W tym artykule wyjaśniono kontrolę kosztów usterek składników majątku w module Zarządzanie składnikami majątku.
...
Informacje na temat konfigurowania usterek można znaleźć w artykule [Zarządzanie usterkami](../setup-for-work-orders/fault-management.md).

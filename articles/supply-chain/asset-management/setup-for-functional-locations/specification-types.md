...
description: W tym artykule wyjaśniono, jak tworzyć typy atrybutów w Zarządzaniu składnikami majątku.
...
W tym artykule wyjaśniono, jak tworzyć typy atrybutów w Zarządzaniu składnikami majątku. Atrybuty są używane do opisywania właściwości różnych elementów. Można konfigurować atrybuty następujących elementów:

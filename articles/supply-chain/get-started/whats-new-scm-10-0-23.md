...
W tym temacie wymieniono nowe oraz zmienione funkcje dostępne w programie Microsoft Dynamics 365 Supply Chain Management w wersji zapoznawczej 10.0.23. Ta wersja ma numer kompilacji 10.0.1037 i jest dostępna w następujący sposób:
...
| Sprzedaż i marketing | Wyczyść historię aktualizacji zamówień sprzedaży | Funkcja ta pozwala na wyczyszczenie tymczasowych zapisów historycznych związanych z aktualizacjami zamówień sprzedaży. Dodaje nowy przycisk o nazwie **Wyczyść historię aktualizacji sprzedaży** do panelu akcji na stronach szczegółów i listy zamówień sprzedaży. |

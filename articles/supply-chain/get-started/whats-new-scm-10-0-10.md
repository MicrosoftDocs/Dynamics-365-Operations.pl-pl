...
description: W tym artykule opisano nowe oraz zmienione funkcje dostępne w Dynamics 365 Supply Chain Management 10.0.10.
author: kamaybac
ms.date: 04/08/2020
ms.topic: article
ms.prod: ''
...
W tym artykule opisano nowe i zmienione funkcje dostępne w rozwiązaniu Microsoft Dynamics 365 Supply Chain Management 10.0.10. Ta wersja ma numer kompilacji 10.0.420 i jest dostępna w następujący sposób:

- **Wersja podglądu:** marzec 2020
- **Dostępność ogólna (Samoaktualizacja):** kwiecień 2020
- **Automatyczna aktualizacja:** maj 2020
...
- [Ulepszenia drukowania etykiet dla zarządzania magazynem](/dynamics365-release-plan/2020wave1/dynamics365-supply-chain-management/label-printing-enhancements-warehouse-management)<br> - Aby uzyskać więcej informacji, zobacz temat [Układy etykiet rozsyłania dokumentów](../warehousing/document-routing-layout-for-license-plates.md).
...
Dynamics 365 Supply Chain Management 10.0.10 zawiera aktualizację platformy. Aby dowiedzieć się więcej, zobacz [aktualizacje platformy dla wersji 10.0.10 aplikacji finansowych i operacyjnych](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-34.md).

### <a name="bug-fixes"></a>Poprawki błędów

Aby uzyskać informacje dotyczące poprawek usterek zawartych w tej aktualizacji, należy zalogować się do Lifecycle Services (LCS) i wyświetlić [artykuł z bazy wiedzy](https://fix.lcs.dynamics.com/Issue/Details?bugId=424137&dbType=3&qc=bf63d49dcc96e51eb42ac1dd66c6c5e5d7548f1e176f729e324ea3353b9860cb).

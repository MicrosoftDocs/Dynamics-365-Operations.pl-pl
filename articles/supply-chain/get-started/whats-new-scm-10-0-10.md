...
W tym temacie opisano nowe i zmienione funkcje dostępne w rozwiązaniu Microsoft Dynamics 365 Supply Chain Management 10.0.10. Ta wersja ma numer kompilacji 10.0.420 i jest dostępna w następujący sposób:
...
Dynamics 365 Supply Chain Management 10.0.10 zawiera aktualizację platformy. Aby dowiedzieć się więcej, zobacz [aktualizację platformy dla wersji 10.0.10 aplikacji Finance and Operations](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-34.md).

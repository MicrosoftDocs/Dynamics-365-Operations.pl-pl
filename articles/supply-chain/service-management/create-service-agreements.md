...
description: W tym artykule opisano sposób korzystania z funkcji w modułach Zarządzanie serwisem oraz Zarządzanie projektami i ich księgowanie do tworzenia umów serwisowych.
author: sorenva
ms.date: 02/19/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8901771"
---
# <a name="create-service-agreements"></a>Tworzenie umów o świadczenie usług

[!include [banner](../includes/banner.md)]

W tym artykule opisano sposób korzystania z funkcji w modułach Zarządzanie serwisem oraz Zarządzanie projektami i ich księgowanie do tworzenia umów serwisowych.
...
5. Wykonaj kroki opisane w sekcji zatytułowanej **Tworzenie umowy serwisowej** wcześniej w tym artykule, aby wprowadzić odwołanie do projektu.

...
description: W tym temacie opisano sposób konfigurowania interwałów serwisowych. Interwał serwisu określa częstotliwość, z jaką są tworzone wiersze umowy serwisowej podczas tworzenia zleceń serwisowych.
author: sorenva
ms.date: 02/20/2018
ms.topic: article
ms.prod: ''

...
Poniższy diagram ilustruje ogólne procesy biznesowe w module **Zarządzanie serwisem** oraz pokazuje, gdzie procesy serwisowe integrują się z innymi modułami.
...
|Ważne zadania           | Strony podstawowe                         |Popularne raporty              |
|--------------------------|---------------------------------------|-----------------------------|
|Realizacja umowy serwisowej|Umowy serwisowe                     |Marża zlecenia serwisowego         |
|Obsługa zapytań odbiorców |Zlecenia serwisowe                         |Opis pracy             |
|                          |Pulpit wysyłki                         |Transakcja — subskrypcja   |
|                          |                                       |Transakcje opłat subskrypcji|


## <a name="integration-of-service-management"></a>Integracja zarządzania usługami

Zarządzanie usługami można zintegrować z następującymi modułami:

  - [Sprzedaż i marketing — omówienie](../sales-marketing/overview-sales-marketing.md)
  - [Zasoby ludzkie](https://docs.microsoft.com/dynamics365/unified-operations/talent/index)

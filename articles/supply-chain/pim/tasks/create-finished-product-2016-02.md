...
---
# <a name="create-a-finished-product-february-2016"></a>Tworzenie wyrobu gotowego (luty 2016)
...
11. W polu Domyślny typ zamówienia wybierz opcję „Produkcja”.
    * Ponieważ jest to wyrób gotowy, który zostanie wytworzony, wybierz opcję Produkcja.  
12. W polu Oddział zakupu wprowadź lub wybierz wartość.
    * Dla demonstracji zaznacz wartość Oddział 1.  

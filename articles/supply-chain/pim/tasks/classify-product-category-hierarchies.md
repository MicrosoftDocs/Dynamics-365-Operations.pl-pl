...
1. W okienku akcji wybierz pozycję **Produkt**.
1. Wybierz **Kategorie produktów**.
1. Wybierz pozycję **Nowy**.
1. W polu **Hierarchia kategorii** wprowadź lub wybierz wartość.
1. W polu **Kategoria** wprowadź lub wybierz wartość.
1. Wybierz pozycję **Nowy**.
1. W polu **Hierarchia kategorii** wprowadź lub wybierz wartość.
1. W polu **Kategoria** wprowadź lub wybierz wartość.
1. Zamknij stronę.

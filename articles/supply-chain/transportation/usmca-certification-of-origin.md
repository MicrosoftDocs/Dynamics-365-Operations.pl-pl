...
## <a name="turn-the-usmca-feature-on-or-off"></a>Włączanie lub wyłączanie funkcji USMCA

Aby używać tej funkcji, należy ją włączyć dla systemu. Od wersji 10.0.29 Supply Chain Management funkcja jest domyślnie włączona. Administratorzy mogą włączyć lub wyłączyć tę funkcję, wyszukując funkcję *Dokument certyfikatu pochodzenia USMCA* w obszarze roboczym [Zarządzanie funkcjami](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md).
...
Aby uzyskać więcej informacji na temat każdego z tych elementów i sposobu znalezienia ich wartości, zapoznaj się z pozostałymi sekcjami w tym artykule.
...
1. Wykonaj jedną z następujących czynności:
    - Przejdź do modułu **Zarządzanie transportem wysyłek \> Planowanie \> Wysyłki \> Wszystkie wysyłki** i wybierz wysyłkę, dla której ma zostać wydrukowany dokument.

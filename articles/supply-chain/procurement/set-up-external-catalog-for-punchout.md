...
description: W tym artykule opisano używanie zewnętrznego katalogu (dynamicznie dostępnego katalogu dostawcy, PunchOut) w celu zbierania informacji ofertowych od dostawcy i dodawania ich do zapotrzebowania.

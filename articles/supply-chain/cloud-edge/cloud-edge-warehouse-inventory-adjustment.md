...
description: Ten artykuł zawiera informacje dotyczące arkusza korekt zapasów magazynowych i przetwarzania w przypadku używania jednostek skalowania.
author: perlynne
ms.date: 04/22/2021
ms.topic: article
ms.prod: ''

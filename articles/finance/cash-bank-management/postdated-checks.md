...
description: Ten artykuł zawiera informacje o obsłudze czeków postdatowanych. Czeki postdatowane są wystawiane do celów wykonywania i odbierania płatności w przyszłości.
author: angelad116
ms.date: 01/12/2018
ms.topic: article
ms.prod: ''

...
- Umożliwia zapisywanie konkretnego stanu środków pieniężnych lub prognoz tego stanu, edytowanie tych wartości, a następnie łatwe porównywanie prognozy z rzeczywistymi finansami i mierzenie jej skuteczności.
...
- Umożliwia wyświetlanie prognozy przepływów pieniężnych w wielu walutach między osobami prawnymi oraz filtrowanie i wyświetlanie przepływów pieniężnych związanych z kontem bankowym. 

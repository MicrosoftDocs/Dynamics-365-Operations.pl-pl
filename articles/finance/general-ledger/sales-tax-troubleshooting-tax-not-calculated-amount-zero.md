...
description: Ten artykuł zawiera informacje na temat rozwiązywania problemów, które mogą pomóc w sytuacji, gdy kwota podatku wynosi 0 (zero) lub podatek nie został obliczony.
author: shtao
ms.date: 04/01/2021
ms.topic: article
ms.prod: ''

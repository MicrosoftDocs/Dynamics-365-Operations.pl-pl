...
Funkcjonalność wprowadzona w wersji 10.0.5 Dynamics 365 Finance (październik 2019) umożliwia korzystanie z funkcji zarządzania funkcjami w celu zapewnienia lepszej elastyczności konsolidacji i podwójnej waluty. Aby włączyć tę funkcję, przejdź do obszaru roboczego **Zarządzanie funkcjami** i wybierz **Włącz funkcję podwójnej waluty w obszarze konsolidacja księgi głównej**.

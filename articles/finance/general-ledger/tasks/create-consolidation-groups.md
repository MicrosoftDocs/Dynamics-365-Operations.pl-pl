...
3. W polu Grupa kont konsolidacji wprowadź unikatowy identyfikator grupy kont konsolidacji.
4. W polu Nazwa wpisz wartość.

## <a name="add-accounts-to-consolidation-account-group"></a>Dodawanie kont do grupy kont konsolidacji
1. Zamknij stronę.
2. Wybierz kolejno opcje Księga główna > Plan kont > Konta > Dodatkowe konta konsolidacji.
3. Kliknij przycisk Nowy.
4. W polu Konto główne kliknij przycisk rozwijany, aby otworzyć wyszukiwanie.
5. Na liście kliknij konto główne, które chcesz zmapować.
6. W polu Grupa kont konsolidacji kliknij przycisk rozwijany, aby otworzyć wyszukiwanie.
7. Na liście kliknij grupę kont konsolidacji.

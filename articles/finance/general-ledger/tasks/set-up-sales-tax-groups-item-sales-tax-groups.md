...
1. Otwórz **Okienko nawigacji > Podatek > Podatki pośrednie > Podatek > Grupy podatków**.
2. Kliknij przycisk **Nowy**.
3. W polu **Grupa podatków** wpisz wartość.
4. W polu **Opis** wpisz wartość.
5. Przełącz rozwinięcie sekcji **Ustawienia**.
6. Kliknij przycisk **Dodaj**.
7. Na liście oznacz wybrany wiersz.
8. W polu **Kod podatku** kliknij przycisk rozwijany, aby otworzyć wyszukiwanie.
9. Na liście kliknij łącze w wybranym wierszu.
10. Kliknij przycisk **Zapisz**.
11. Zamknij stronę.
12. Wybierz kolejno opcje **Podatek > Podatki pośrednie > Podatek > Grupy podatków dla towaru**.
13. Kliknij przycisk **Nowy**.
14. W polu **Grupa podatków dla towaru** wpisz wartość.

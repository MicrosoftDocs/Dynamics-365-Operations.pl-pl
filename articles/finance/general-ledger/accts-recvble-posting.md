---
title: Księgowanie należności
description: Ten temat wyjaśnia, w jaki sposób konfiguruje się księgowania na kontach należności i podaje przykłady konfiguracji księgowań.

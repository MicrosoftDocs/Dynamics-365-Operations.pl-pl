...
> [!NOTE]
> Ta funkcja zostanie wycofana we wrześniu 2022 roku, nowi użytkownicy powinni korzystać z raportów elektronicznych. Aby uzyskać więcej informacji, zobacz [Tworzenie plików płatności dodatnich przy użyciu raportów elektronicznych](set-up-positive-pay-er.md).

...
Jeśli w zamówieniu sprzedaży 000036 zostanie wybrana opcja **Załącznik**, w arkuszu faktur będzie wyświetlany oryginalny wpis księgowania. Aby wyświetlić wpis wycofania oraz nowy wpis księgowania z zamówienia sprzedaży, wybierz opcję **Korekty przychodu** w okienku zadań, a następnie wybierz opcję **Załącznik**.

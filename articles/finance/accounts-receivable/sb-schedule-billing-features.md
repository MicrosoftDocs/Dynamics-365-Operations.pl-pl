...
description: W tym temacie omówiono funkcje harmonogramów rozliczeń, takie jak metody ustalania cen, eskalacje i rabaty, daty wyrównania, proraty, rozliczenia odwrotne oraz grupy elementów dzielonych.
...
ms.locfileid: "8700727"
---
# <a name="billing-schedule-features"></a>Funkcje harmonogramu rozliczania

[!include [banner](../includes/banner.md)]

W tym temacie omówiono funkcje harmonogramów billingowych i linii harmonogramów billingowych. Opisano w nim różne metody stosowane do ustalania cen, sposoby korzystania z podwyżek i rabatów oraz sposoby odwracania okresu rozliczeniowego. Zawiera również przykłady obliczeń prorogacji i dzielenia grup pozycji.

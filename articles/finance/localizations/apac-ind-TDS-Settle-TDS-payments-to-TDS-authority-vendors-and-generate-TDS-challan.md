...
description: W tym artykule opisano sposób rozliczania płatności podatków potrącanych w źródle (TDS) na rzecz dostawców urzędów skarbowych.
author: kailiang
ms.date: 03/12/2021
ms.topic: article
ms.prod: ''
...
W tym artykule opisano sposób rozliczania płatności podatków potrącanych w źródle (TDS) na rzecz dostawców urzędów skarbowych.

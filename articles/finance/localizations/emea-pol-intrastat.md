...
16. Naciśnij przycisk **OK** i przejrzyj wygenerowany raport w formacie XML. W poniższej tabeli przedstawiono wartości w przykładowym raporcie.
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Informacje o dokumencie</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Informacje o firmie</strong></p>
    </td>
    </tr>
    <tr>
    <td width="191">
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Informacje o towarze</strong></p>
    </td>
    </tr>
    <tr>
    <td>
    ...
    <tr>
    <td colspan="3">
    <p align=center><strong>Informacje o kontakcie</strong></p>
    </td>
    </tr>
    <tr>
    <td>

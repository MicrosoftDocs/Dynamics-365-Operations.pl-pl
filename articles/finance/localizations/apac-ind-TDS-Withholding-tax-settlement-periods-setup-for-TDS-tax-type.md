...
description: W tym artykule wyjaśniono, jak skonfigurować okresy rozliczeniowe dla okresów rozliczenia podatku odliczonego u źródła (TDS).
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
W tym artykule wyjaśniono, jak skonfigurować okresy rozliczeniowe dla okresów rozliczenia podatku odliczonego u źródła (TDS).

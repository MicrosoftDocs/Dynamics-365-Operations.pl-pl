...
description: Ten artykuł zawiera listę tematów pomocy oraz innych zasobów dostępnych dla modułu Rachunek kosztów.
author: aprilolson
ms.date: 04/25/2018
ms.topic: article
ms.prod: ''
...
| &nbsp; | &nbsp;  |
|------|---|
|  [Rozpoczęcie korzystania z modułu Rachunek kosztów (Nauka)](/training/modules/get-started-cost-accounting-dyn365-finance/)  |[Wymiary składników kosztów](cost-elements.md)  |

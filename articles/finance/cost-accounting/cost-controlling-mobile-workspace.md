...
description: Ten artykuł zawiera informacje dotyczące mobilnego obszaru roboczego Kontrola kosztów. Ten obszar roboczy umożliwia menedżerom centrów kosztów podgląd na działanie tych centrów zawsze i wszędzie.
author: AndersGirke
ms.date: 05/24/2022
ms.topic: article
ms.prod: ''
...
Ten artykuł zawiera informacje dotyczące mobilnego obszaru roboczego **Kontrola kosztów**. Ten obszar roboczy umożliwia menedżerom centrów kosztów podgląd na działanie tych centrów zawsze i wszędzie.

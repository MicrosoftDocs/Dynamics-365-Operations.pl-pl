...
Gdy znasz pojęcia i terminologię używaną w usłudze Microsoft Dynamics 365 Finance, implementacja planowania budżetu w organizacji jest łatwiejsza.
...
Przepływ pracy Budżetowanie dla planowania budżetu tworzy się na stronie **Przepływy pracy Budżetowanie**. Ten proces przypomina proce tworzenia innych przepływów pracy. Na poniższe ilustracji pokazano przykład przepływu pracy Centrala. 
...
> [!NOTE] 
> Domyślnie będzie ograniczona do 36 kolumn, chyba że rozszerzysz planowanie budżetu o kroki w [rozszerzanie układu planowania budżetu](./extending-budget-planning-layout.md).

...
description: Ten artykuł przedstawia omówienie metody amortyzacji 200 procent — amortyzacja degresywna.
author: moaamer
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8870170"
---
# <a name="200-percent-reducing-balance-depreciation"></a>200% amortyzacja degresywna

[!include [banner](../includes/banner.md)]

Ten artykuł przedstawia omówienie metody amortyzacji 200 procent — amortyzacja degresywna.
...
|--------|-----------------------------------------------|------------------------|---------------------------------------|
| Rok 1 | (11000 – 1000) × 40% = 4000                | 11000 – 4000 = 7000 | 11000 – 1000 – 4000 = 6000        |

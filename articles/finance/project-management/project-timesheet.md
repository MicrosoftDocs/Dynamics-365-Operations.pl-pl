...
W Finance aplikacja mobilna Project Timesheet musi być włączona. Aby włączyć tę funkcję, przejdź do menu **Parametry modułu Zarządzanie projektami i ich księgowanie \> Karta czasu pracy** i wybierz parametr **Włącz Microsoft Dynamics 365 Project Timesheet**.

## <a name="sign-in-to-the-app"></a>Zaloguj się do aplikacji

1.  Uruchom aplikację na urządzeniu komórkowym.

2.  Wprowadź swój adres URL Finance.

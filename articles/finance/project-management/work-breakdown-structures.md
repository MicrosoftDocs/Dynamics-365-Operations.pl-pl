...
Tworzenie SPP to intensywny proces, który zazwyczaj trwa długo i wymaga współpracy oraz przekazywania informacji między dużą grupą osób. W tym temacie opisujemy, jak można wykorzystać udoskonalenia wprowadzone do funkcji SPP, aby ułatwić sobie szacowanie i monitorowanie w projekcie.
...
**Naprawianie wszystkich błędów planowania** jeśli chcesz, żeby rozwiązanie Finance naprawiło wszystkie błędy w SPP, w okienku akcji kliknij **Korygowanie wszystkich rozbieżności planowania**. 
...
Finance używa reguły zarabiania 0:100 podczas planowania zarobionej wartości. Zgodnie z tą regułą wartość zadania jest księgowana w zadaniu w dniu zakończenia zadania. Wartości nie są księgowane przed całkowitym zakończeniem zadania. 

...
description: W tym artykule wyjaśniono, jak konfigurować typy wydatków w module Wynajem składnika majątku.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8908046"
---
# <a name="set-up-expense-types"></a>Konfigurowanie typów wydatków

[!include [banner](../includes/banner.md)]

W tym artykule wyjaśniono, jak konfigurować typy wydatków w module Wynajem składnika majątku. Koszty, które nie są reprezentowane w harmonogramie płatności, są nazywane *kosztami wydatków*. Przykładami tych kosztów są podatki od nieruchomości, wspólne koszty utrzymania obszaru oraz koszty ubezpieczenia.

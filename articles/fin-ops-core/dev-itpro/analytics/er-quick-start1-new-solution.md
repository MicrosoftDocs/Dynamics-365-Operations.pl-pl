...
- [<span data-ttu-id="29ea1-106">Konfigurowanie struktury ER</span><span class="sxs-lookup"><span data-stu-id="29ea1-106">Configure the ER framework</span></span>](#ConfigureFramework)
...
- [<span data-ttu-id="29ea1-118">Umożliwia zaprojektowanie mapowania modelu dla skonfigurowanego modelu danych</span><span class="sxs-lookup"><span data-stu-id="29ea1-118">Design a model mapping for the configured data model</span></span>](#DesignMapping)
    ...
    - [<span data-ttu-id="29ea1-120">Stwórz nowy model konfiguracji mapowania</span><span class="sxs-lookup"><span data-stu-id="29ea1-120">Create a new model mapping configuration</span></span>](#CreateModelMapping)
        ...
        - [<span data-ttu-id="29ea1-127">Umożliwia zakończenie projektu mapowania modelu</span><span class="sxs-lookup"><span data-stu-id="29ea1-127">Complete the design of the model mapping</span></span>](#CompleteModelMapping)
...
- [<span data-ttu-id="29ea1-143">Opracowywanie Artefacts aplikacji w celu wywołania zaprojektowanego raportu</span><span class="sxs-lookup"><span data-stu-id="29ea1-143">Develop application artefacts to call the designed report</span></span>](#DevelopCustomCode)
    ...
    - [<span data-ttu-id="29ea1-144">Zmień kod źródłowy</span><span class="sxs-lookup"><span data-stu-id="29ea1-144">Modify source code</span></span>](#ModifySourceCode)
        ...
        - [<span data-ttu-id="29ea1-145">Dodawanie klasy kontraktu danych</span><span class="sxs-lookup"><span data-stu-id="29ea1-145">Add a data contract class</span></span>](#DataContractClass)
...
- [<span data-ttu-id="29ea1-155">Dostrajanie zaprojektowanego rozwiązania ER</span><span class="sxs-lookup"><span data-stu-id="29ea1-155">Tune a designed ER solution</span></span>](#TuneSolution)
    ...
    - [<span data-ttu-id="29ea1-166">Umożliwia uruchomienie formatu z aplikacji</span><span class="sxs-lookup"><span data-stu-id="29ea1-166">Run a format from the application</span></span>](#RunFormatFromApp2)
...
#### <a name="activate-an-er-configuration-provider"></a><a name="ActivateAddedProvider"></a><span data-ttu-id="29ea1-209">Aktywowanie dostawcy konfiguracji ER</span><span class="sxs-lookup"><span data-stu-id="29ea1-209">Activate an ER configuration provider</span></span>
...
1. <span data-ttu-id="29ea1-234">Na stronie **Konfiguracje** w drzewie konfiguracje wybierz **Model kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-234">On the **Configurations** page, in the configuration tree, select **Questionnaire model**.</span></span>
...
4. <span data-ttu-id="29ea1-400">Dodaj nowe źródło danych, które będzie używane w celu uzyskania dostępu do tabeli KMQuestion, gdzie każdy rekord reprezentuje jedno pytanie w kwestionariuszu:</span><span class="sxs-lookup"><span data-stu-id="29ea1-400">Add a new data source that will be used to access the KMQuestion table, where every record represents a single question in a questionnaire:</span></span>
    ...
    1. <span data-ttu-id="29ea1-401">W okienku **Źródła danych** wybierz **Dodaj źródło**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-401">In the **Data sources** pane, select **Add root**.</span></span>
...
9. <span data-ttu-id="29ea1-420">W okienku **Typy źródła danych** wybierz **Funkcje\\Pole obliczeniowe**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-420">In the **Data source types** pane, select **Functions\\Calculated field**.</span></span>
...
13. <span data-ttu-id="29ea1-438">W okienku **Typy źródła danych** wybierz opcję **Dynamics 365 for Operations\\Tabele**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-438">In the **Data source types** pane, select **Dynamics 365 for Operations\\Table**.</span></span>
...
3. <span data-ttu-id="29ea1-454">W okienku **Typy źródła danych** wybierz opcję **Dynamics 365 for Operations\\Wyliczenie**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-454">In the **Data source types** pane, select **Dynamics 365 for Operations\\Enumeration**.</span></span>
...
5. <span data-ttu-id="29ea1-472">Zamknij okno dialogowe **Tłumaczenie tekstu**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-472">Close the **Text translation** dialog box.</span></span>
...
<span data-ttu-id="29ea1-475">Wprowadziłeś etykiety ER tylko dla języka domyślnego.</span><span class="sxs-lookup"><span data-stu-id="29ea1-475">You've entered ER labels only for the default language.</span></span> <span data-ttu-id="29ea1-476">Aby uzyskać informacje o tym, jak można tłumaczyć etykiety ER na inne języki, zobacz [Projektowanie raportów wielojęzycznych](er-design-multilingual-reports.md).</span><span class="sxs-lookup"><span data-stu-id="29ea1-476">For information about how ER labels can be translated into other languages, see [Design multilingual reports](er-design-multilingual-reports.md).</span></span>

#### <a name="add-a-data-source-to-transform-the-results-of-comparing-enumeration-values-to-a-text-value"></a><a name="AddMmDataSource3"></a><span data-ttu-id="29ea1-477">Dodaj źródło danych w celu przekształcenia wyników porównywania wartości wyliczenia z wartością tekstową</span><span class="sxs-lookup"><span data-stu-id="29ea1-477">Add a data source to transform the results of comparing enumeration values to a text value</span></span>

<span data-ttu-id="29ea1-478">Ponieważ należy kilkakrotnie przekształcić wyniki porównania między wartościami wyliczenia i wartościami tekstowymi w przypadku źródeł różnic, warto skonfigurować tę logikę jako pojedyncze źródło danych.</span><span class="sxs-lookup"><span data-stu-id="29ea1-478">Because you must transform the results of the comparison between enumeration values and text values several times for difference sources, it's a good idea to configure this logic as a single data source.</span></span> <span data-ttu-id="29ea1-479">Jednak aby to źródło danych było wielokrotnego użytku, należy skonfigurować je jako parametry źródła danych.</span><span class="sxs-lookup"><span data-stu-id="29ea1-479">However, to make this data source reusable, you must then configure it as the parametrized data source.</span></span> <span data-ttu-id="29ea1-480">Aby uzyskać więcej informacji, zobacz [Obsługa sparametryzowanych wywołań źródeł danych narzędzia Raportowanie elektroniczne typu pola obliczeniowego](er-calculated-field-type.md).</span><span class="sxs-lookup"><span data-stu-id="29ea1-480">For more information, see [Support parameterized calls of ER data sources of the Calculated field type](er-calculated-field-type.md).</span></span>

1. <span data-ttu-id="29ea1-481">Na stronie **Projektant mapowania modelu** w okienku **Typy źródła danych** wybierz **Ogólne\\Pusty kontener**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-481">On the **Model mapping designer** page, in the **Data source types** pane, select **General\\Empty container**.</span></span>
2. <span data-ttu-id="29ea1-482">Dodaj nowe źródło danych kontenera:</span><span class="sxs-lookup"><span data-stu-id="29ea1-482">Add a new container data source:</span></span>

    1. <span data-ttu-id="29ea1-483">W okienku **Źródła danych** wybierz **Dodaj źródło**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-483">In the **Data sources** pane, select **Add root**.</span></span>
    2. <span data-ttu-id="29ea1-484">W oknie dialogowym rozwijanym w polu **Nazwa** wprowadź **Pomocnik**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-484">In the dialog box, in the **Name** field, enter **Helper**.</span></span>
    3. <span data-ttu-id="29ea1-485">Wybierz przycisk **OK**, aby dodać nowe źródło danych kontenera.</span><span class="sxs-lookup"><span data-stu-id="29ea1-485">Select **OK** to add the new container data source.</span></span>

3. <span data-ttu-id="29ea1-486">W okienku **Typy źródła danych** wybierz **Funkcje\\Pole obliczeniowe**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-486">In the **Data source types** pane, select **Functions\\Calculated field**.</span></span>
4. <span data-ttu-id="29ea1-487">Dodaj nowe źródło danych:</span><span class="sxs-lookup"><span data-stu-id="29ea1-487">Add a new data source:</span></span>

    1. <span data-ttu-id="29ea1-488">W okienku **Źródła danych** wybierz **Pomocnik**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-488">In the **Data sources** pane, select **Helper**.</span></span>
    2. <span data-ttu-id="29ea1-489">Wybierz opcję **Dodaj**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-489">Select **Add**.</span></span>
    3. <span data-ttu-id="29ea1-490">W oknie dialogowym rozwijanym w polu **nazwa** wprowadź **NoYesEnumToString**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-490">In the dialog box, in the **Name** field, enter **NoYesEnumToString**.</span></span>
    4. <span data-ttu-id="29ea1-491">Wybierz opcję **Edytuj formułę**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-491">Select **Edit formula**.</span></span>
    5. <span data-ttu-id="29ea1-492">W edytorze formuł wybierz opcję **Parametry**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-492">In the formula editor, select **Parameters**.</span></span>
    6. <span data-ttu-id="29ea1-493">Wykonaj następujące kroki, aby określić parametry dla skonfigurowanego wyrażenia:</span><span class="sxs-lookup"><span data-stu-id="29ea1-493">Follow these steps to specify parameters for the configured expression:</span></span>

        1. <span data-ttu-id="29ea1-494">Wybierz pozycję **Nowy**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-494">Select **New**.</span></span>
        2. <span data-ttu-id="29ea1-495">W oknie dialogowym rozwijanym w polu **Nazwa** wprowadź **Argument**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-495">In the dialog box, in the **Name** field, enter **Argument**.</span></span>
        3. <span data-ttu-id="29ea1-496">W polu **Typ** wybierz typ danych **Wartość logiczna**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-496">In the **Type** field, select the **Boolean** data type.</span></span>
        4. <span data-ttu-id="29ea1-497">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-497">Select **OK**.</span></span>

    7. <span data-ttu-id="29ea1-498">W polu **Formuła** wprowadź **IF (Argument = true, \@"GER\_LABEL:PositiveAnswer", \@"GER\_LABEL:NegativeAnswer")**, aby zwrócić tekst odpowiedniej etykiety ER, w zależności od języka kontekstu wykonywania i wartości określonego parametru.</span><span class="sxs-lookup"><span data-stu-id="29ea1-498">In the **Formula** field, enter **IF (Argument = true, \@"GER\_LABEL:PositiveAnswer", \@"GER\_LABEL:NegativeAnswer")** to return the text of the appropriate ER label, depending on the language of the execution context and value of the specified parameter.</span></span>
    8. <span data-ttu-id="29ea1-499">Wybierz przycisk **Zapisz** i zamknij edytor formuł.</span><span class="sxs-lookup"><span data-stu-id="29ea1-499">Select **Save**, and close the formula editor.</span></span>
    9. <span data-ttu-id="29ea1-500">Wybierz przycisk **OK**, aby dodać nowe źródło danych.</span><span class="sxs-lookup"><span data-stu-id="29ea1-500">Select **OK** to add the new data source.</span></span>

![Skonfigurowany model mapowania w projektancie modeli mapowania ER](./media/er-quick-start1-added-data-sources.png)

#### <a name="bind-data-sources-to-data-model-fields"></a><a name="AddMmBindings1"></a><span data-ttu-id="29ea1-502">Powiąż źródła danych z polami modelu danych</span><span class="sxs-lookup"><span data-stu-id="29ea1-502">Bind data sources to data model fields</span></span>

<span data-ttu-id="29ea1-503">Aby określić sposób, w jaki model danych będzie wypełniał dane aplikacji w czasie wykonywania, należy powiązać skonfigurowane źródła danych z polami modelu danych.</span><span class="sxs-lookup"><span data-stu-id="29ea1-503">You must bind the configured data sources to the fields of the data model to specify how the data model will by filled in with application data at runtime.</span></span>

1. <span data-ttu-id="29ea1-504">Na stronie **Projektant mapowania modelu** w okienku **Model danych** wybierz **CompanyName**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-504">On the **Model mapping designer** page, in the **Data model** pane, select **CompanyName**.</span></span>
2. <span data-ttu-id="29ea1-505">W okienku **Źródła danych** rozwiń węzeł **CompanyInfo**, a następnie wykonaj następujące kroki:</span><span class="sxs-lookup"><span data-stu-id="29ea1-505">In the **Data sources** pane, expand **CompanyInfo**, and then follow these steps:</span></span>

    1. <span data-ttu-id="29ea1-506">Rozwiń węzeł **CompanyInfo.find()**, który reprezentuje metodę **find()** tabeli CompanyInfo.</span><span class="sxs-lookup"><span data-stu-id="29ea1-506">Expand the **CompanyInfo.find()** node that represents the **find()** method of the CompanyInfo table.</span></span>
    2. <span data-ttu-id="29ea1-507">Wybierz **CompanyInfo.find().Name**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-507">Select **CompanyInfo.find().Name**.</span></span>
    3. <span data-ttu-id="29ea1-508">Wybierz opcję **Powiąż**, aby wpisać nazwę firmy, z której wywoływane jest skonfigurowane mapowanie modelu w kontekście at runtime.</span><span class="sxs-lookup"><span data-stu-id="29ea1-508">Select **Bind** to fill in the name of the company that the configured model mapping is called in the context of at runtime.</span></span>

3. <span data-ttu-id="29ea1-509">W okienku **Model danych** wybierz **Kwestionariusz**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-509">In the **Data model** pane, select **Questionnaire**.</span></span>
4. <span data-ttu-id="29ea1-510">W okienku **Źródła danych** wybierz opcję **Kwestionariusz**, a następnie wybierz **Powiąż**, aby wypełnić rekordy kwestionariusza.</span><span class="sxs-lookup"><span data-stu-id="29ea1-510">In the **Data sources** pane, select **Questionnaire**, and then select **Bind** to fill in questionnaire records.</span></span>
5. <span data-ttu-id="29ea1-511">W okienku **Model danych** rozwiń węzeł **Kwestionariusz**, a następnie wykonaj następujące kroki:</span><span class="sxs-lookup"><span data-stu-id="29ea1-511">In the **Data model** pane, expand **Questionnaire**, and then follow these steps:</span></span>

    1. <span data-ttu-id="29ea1-512">W okienku **Model danych** wybierz **Aktywne**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-512">In the **Data model** pane, select **Active**.</span></span>
    2. <span data-ttu-id="29ea1-513">W okienku **Model danych** wybierz **Edytuj**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-513">In the **Data model** pane, select **Edit**.</span></span>
    3. <span data-ttu-id="29ea1-514">W polu **Formuła** wprowadź wartość **Helper.NoYesEnumToString (\@.Active = EnumAppNoYes.Yes)**, aby wypełnić wynik porównania między wartościami wyliczenia zależne od tekstu i języka.</span><span class="sxs-lookup"><span data-stu-id="29ea1-514">In the **Formula** field, enter **Helper.NoYesEnumToString (\@.Active = EnumAppNoYes.Yes)** to fill the text-dependent and language-dependent result of the comparison between enumeration values.</span></span>

6. <span data-ttu-id="29ea1-515">Kontynuuj wiązanie źródeł danych z polami modelu danych w ten sam sposób, aż uzyskasz następujący wynik.</span><span class="sxs-lookup"><span data-stu-id="29ea1-515">Continue to bind data sources to data model fields in the same manner until you achieve the following result.</span></span>

    | <span data-ttu-id="29ea1-516">Ścieżka pola</span><span class="sxs-lookup"><span data-stu-id="29ea1-516">Field path</span></span>                                              | <span data-ttu-id="29ea1-517">Typ danych</span><span class="sxs-lookup"><span data-stu-id="29ea1-517">Data type</span></span>   | <span data-ttu-id="29ea1-518">Akcja</span><span class="sxs-lookup"><span data-stu-id="29ea1-518">Action</span></span> | <span data-ttu-id="29ea1-519">Wyrażenie wiązania</span><span class="sxs-lookup"><span data-stu-id="29ea1-519">Binding expression</span></span> |
    |---------------------------------------------------------|-------------|--------|--------------------|
    | <span data-ttu-id="29ea1-520">CompanyName</span><span class="sxs-lookup"><span data-stu-id="29ea1-520">CompanyName</span></span>                                             | <span data-ttu-id="29ea1-521">Ciąg</span><span class="sxs-lookup"><span data-stu-id="29ea1-521">String</span></span>      | <span data-ttu-id="29ea1-522">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-522">Bind</span></span>   | <span data-ttu-id="29ea1-523">CompanyInfo.'find()'.Name</span><span class="sxs-lookup"><span data-stu-id="29ea1-523">CompanyInfo.'find()'.Name</span></span> |
    | <span data-ttu-id="29ea1-524">Kwestionariusz</span><span class="sxs-lookup"><span data-stu-id="29ea1-524">Questionnaire</span></span>                                           | <span data-ttu-id="29ea1-525">Lista rekordów</span><span class="sxs-lookup"><span data-stu-id="29ea1-525">Record list</span></span> | <span data-ttu-id="29ea1-526">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-526">Bind</span></span>   | <span data-ttu-id="29ea1-527">Kwestionariusz</span><span class="sxs-lookup"><span data-stu-id="29ea1-527">Questionnaire</span></span> |
    | <span data-ttu-id="29ea1-528">Kwestionariusz\\Aktywny</span><span class="sxs-lookup"><span data-stu-id="29ea1-528">Questionnaire\\Active</span></span>                                   | <span data-ttu-id="29ea1-529">Ciąg</span><span class="sxs-lookup"><span data-stu-id="29ea1-529">String</span></span>      | <span data-ttu-id="29ea1-530">Edycja</span><span class="sxs-lookup"><span data-stu-id="29ea1-530">Edit</span></span>   | <span data-ttu-id="29ea1-531">Helper.NoYesEnumToString(\@.active = EnumAppNoYes.Yes)</span><span class="sxs-lookup"><span data-stu-id="29ea1-531">Helper.NoYesEnumToString(\@.active = EnumAppNoYes.Yes)</span></span> |
    | <span data-ttu-id="29ea1-532">Kwestionariusz\\Kod</span><span class="sxs-lookup"><span data-stu-id="29ea1-532">Questionnaire\\Code</span></span>                                     | <span data-ttu-id="29ea1-533">Ciąg</span><span class="sxs-lookup"><span data-stu-id="29ea1-533">String</span></span>      | <span data-ttu-id="29ea1-534">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-534">Bind</span></span>   | <span data-ttu-id="29ea1-535">\@.kmCollectionId</span><span class="sxs-lookup"><span data-stu-id="29ea1-535">\@.kmCollectionId</span></span> |
    | <span data-ttu-id="29ea1-536">Kwestionariusz\\Opis</span><span class="sxs-lookup"><span data-stu-id="29ea1-536">Questionnaire\\Description</span></span>                              | <span data-ttu-id="29ea1-537">Ciąg</span><span class="sxs-lookup"><span data-stu-id="29ea1-537">String</span></span>      | <span data-ttu-id="29ea1-538">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-538">Bind</span></span>   | <span data-ttu-id="29ea1-539">\@.Opis</span><span class="sxs-lookup"><span data-stu-id="29ea1-539">\@.Description</span></span> |
    | <span data-ttu-id="29ea1-540">Kwestionariusz\\TypKwestionariusza</span><span class="sxs-lookup"><span data-stu-id="29ea1-540">Questionnaire\\QuestionnaireType</span></span>                        | <span data-ttu-id="29ea1-541">Ciąg</span><span class="sxs-lookup"><span data-stu-id="29ea1-541">String</span></span>      | <span data-ttu-id="29ea1-542">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-542">Bind</span></span>   | <span data-ttu-id="29ea1-543">\@.'&gt;Relations'.kmCollectionTypeId.Description</span><span class="sxs-lookup"><span data-stu-id="29ea1-543">\@.'&gt;Relations'.kmCollectionTypeId.Description</span></span> |
    | <span data-ttu-id="29ea1-544">Kwestionariusz\\QuestionOrder</span><span class="sxs-lookup"><span data-stu-id="29ea1-544">Questionnaire\\QuestionOrder</span></span>                            | <span data-ttu-id="29ea1-545">Ciąg</span><span class="sxs-lookup"><span data-stu-id="29ea1-545">String</span></span>      | <span data-ttu-id="29ea1-546">Edycja</span><span class="sxs-lookup"><span data-stu-id="29ea1-546">Edit</span></span>   | <span data-ttu-id="29ea1-547">CASE (\@.questionMode,</span><span class="sxs-lookup"><span data-stu-id="29ea1-547">CASE (\@.questionMode,</span></span><br><span data-ttu-id="29ea1-548">EnumAppQuestionOrder.Conditional, "Conditional",</span><span class="sxs-lookup"><span data-stu-id="29ea1-548">EnumAppQuestionOrder.Conditional, "Conditional",</span></span><br><span data-ttu-id="29ea1-549">EnumAppQuestionOrder.Random, „Losowo (procent w kwestionariuszu)”,</span><span class="sxs-lookup"><span data-stu-id="29ea1-549">EnumAppQuestionOrder.Random, "Random (percentage in questionnaire)",</span></span><br><span data-ttu-id="29ea1-550">EnumAppQuestionOrder.RandomGroup, „Losowo (procent w grupach wyników)”,</span><span class="sxs-lookup"><span data-stu-id="29ea1-550">EnumAppQuestionOrder.RandomGroup, "Random (percentage in result groups)",</span></span><br><span data-ttu-id="29ea1-551">EnumAppQuestionOrder.Sequence, „Sekwencyjne”,</span><span class="sxs-lookup"><span data-stu-id="29ea1-551">EnumAppQuestionOrder.Sequence, "Sequential",</span></span><br><span data-ttu-id="29ea1-552">"")</span><span class="sxs-lookup"><span data-stu-id="29ea1-552">"")</span></span> |
    | <span data-ttu-id="29ea1-553">Kwestionariusz\\ResultsGroup</span><span class="sxs-lookup"><span data-stu-id="29ea1-553">Questionnaire\\ResultsGroup</span></span>                             | <span data-ttu-id="29ea1-554">Zarejestruj</span><span class="sxs-lookup"><span data-stu-id="29ea1-554">Record</span></span>      |        | |
    | <span data-ttu-id="29ea1-555">Kwestionariusz\\ResultsGroup\\Kod</span><span class="sxs-lookup"><span data-stu-id="29ea1-555">Questionnaire\\ResultsGroup\\Code</span></span>                       | <span data-ttu-id="29ea1-556">Ciąg</span><span class="sxs-lookup"><span data-stu-id="29ea1-556">String</span></span>      | <span data-ttu-id="29ea1-557">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-557">Bind</span></span>   | <span data-ttu-id="29ea1-558">\@.'\$ResultGroup'.kmQuestionResultGroupId</span><span class="sxs-lookup"><span data-stu-id="29ea1-558">\@.'\$ResultGroup'.kmQuestionResultGroupId</span></span> |
    | <span data-ttu-id="29ea1-559">Kwestionariusz\\ResultsGroup\\Opis</span><span class="sxs-lookup"><span data-stu-id="29ea1-559">Questionnaire\\ResultsGroup\\Description</span></span>                | <span data-ttu-id="29ea1-560">Ciąg</span><span class="sxs-lookup"><span data-stu-id="29ea1-560">String</span></span>      | <span data-ttu-id="29ea1-561">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-561">Bind</span></span>   | <span data-ttu-id="29ea1-562">\@.'\$ResultGroup'.description</span><span class="sxs-lookup"><span data-stu-id="29ea1-562">\@.'\$ResultGroup'.description</span></span> |
    | <span data-ttu-id="29ea1-563">Kwestionariusz\\ResultsGroup\\MaxNumberOfPoints</span><span class="sxs-lookup"><span data-stu-id="29ea1-563">Questionnaire\\ResultsGroup\\MaxNumberOfPoints</span></span>          | <span data-ttu-id="29ea1-564">Rzeczywisty</span><span class="sxs-lookup"><span data-stu-id="29ea1-564">Real</span></span>        | <span data-ttu-id="29ea1-565">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-565">Bind</span></span>   | <span data-ttu-id="29ea1-566">\@.'\$ResultGroup'.maxPoint</span><span class="sxs-lookup"><span data-stu-id="29ea1-566">\@.'\$ResultGroup'.maxPoint</span></span> |
    | <span data-ttu-id="29ea1-567">Kwestionariusz\\Pytanie</span><span class="sxs-lookup"><span data-stu-id="29ea1-567">Questionnaire\\Question</span></span>                                 | <span data-ttu-id="29ea1-568">Lista rekordów</span><span class="sxs-lookup"><span data-stu-id="29ea1-568">Record list</span></span> | <span data-ttu-id="29ea1-569">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-569">Bind</span></span>   | <span data-ttu-id="29ea1-570">\@.'&lt;Relations'.KMCollectionQuestion</span><span class="sxs-lookup"><span data-stu-id="29ea1-570">\@.'&lt;Relations'.KMCollectionQuestion</span></span> |
    | <span data-ttu-id="29ea1-571">Kwestionariusz\\Pytanie\\CollectionSequenceNumber</span><span class="sxs-lookup"><span data-stu-id="29ea1-571">Questionnaire\\Question\\CollectionSequenceNumber</span></span>       | <span data-ttu-id="29ea1-572">Wartość całkowita</span><span class="sxs-lookup"><span data-stu-id="29ea1-572">Integer</span></span>     | <span data-ttu-id="29ea1-573">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-573">Bind</span></span>   | <span data-ttu-id="29ea1-574">\@.answerCollectionSequenceNumber</span><span class="sxs-lookup"><span data-stu-id="29ea1-574">\@.answerCollectionSequenceNumber</span></span> |
    | <span data-ttu-id="29ea1-575">Kwestionariusz\\Pytanie\\Identyfikator</span><span class="sxs-lookup"><span data-stu-id="29ea1-575">Questionnaire\\Question\\Id</span></span>                             | <span data-ttu-id="29ea1-576">Ciąg</span><span class="sxs-lookup"><span data-stu-id="29ea1-576">String</span></span>      | <span data-ttu-id="29ea1-577">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-577">Bind</span></span>   | <span data-ttu-id="29ea1-578">\@.kmQuestionId</span><span class="sxs-lookup"><span data-stu-id="29ea1-578">\@.kmQuestionId</span></span> |
    | <span data-ttu-id="29ea1-579">Kwestionariusz\\Pytanie\\MustBeCompleted</span><span class="sxs-lookup"><span data-stu-id="29ea1-579">Questionnaire\\Question\\MustBeCompleted</span></span>                | <span data-ttu-id="29ea1-580">Ciąg</span><span class="sxs-lookup"><span data-stu-id="29ea1-580">String</span></span>      | <span data-ttu-id="29ea1-581">Edycja</span><span class="sxs-lookup"><span data-stu-id="29ea1-581">Edit</span></span>   | <span data-ttu-id="29ea1-582">Helper.NoYesEnumToString(\@.mandatory = EnumAppNoYes.Yes)</span><span class="sxs-lookup"><span data-stu-id="29ea1-582">Helper.NoYesEnumToString(\@.mandatory = EnumAppNoYes.Yes)</span></span> |
    | <span data-ttu-id="29ea1-583">Kwestionariusz\\Pytanie\\PrimaryQuestion</span><span class="sxs-lookup"><span data-stu-id="29ea1-583">Questionnaire\\Question\\PrimaryQuestion</span></span>                | <span data-ttu-id="29ea1-584">Ciąg</span><span class="sxs-lookup"><span data-stu-id="29ea1-584">String</span></span>      | <span data-ttu-id="29ea1-585">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-585">Bind</span></span>   | <span data-ttu-id="29ea1-586">\@.parentQuestionId</span><span class="sxs-lookup"><span data-stu-id="29ea1-586">\@.parentQuestionId</span></span> |
    | <span data-ttu-id="29ea1-587">Kwestionariusz\\Pytanie\\SequenceNumber</span><span class="sxs-lookup"><span data-stu-id="29ea1-587">Questionnaire\\Question\\SequenceNumber</span></span>                 | <span data-ttu-id="29ea1-588">Wartość całkowita</span><span class="sxs-lookup"><span data-stu-id="29ea1-588">Integer</span></span>     | <span data-ttu-id="29ea1-589">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-589">Bind</span></span>   | <span data-ttu-id="29ea1-590">\@.SequenceNumber</span><span class="sxs-lookup"><span data-stu-id="29ea1-590">\@.SequenceNumber</span></span> |
    | <span data-ttu-id="29ea1-591">Kwestionariusz\\Pytanie\\Tekst</span><span class="sxs-lookup"><span data-stu-id="29ea1-591">Questionnaire\\Question\\Text</span></span>                           | <span data-ttu-id="29ea1-592">Ciąg</span><span class="sxs-lookup"><span data-stu-id="29ea1-592">String</span></span>      | <span data-ttu-id="29ea1-593">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-593">Bind</span></span>   | <span data-ttu-id="29ea1-594">\@.'\$Question'.text</span><span class="sxs-lookup"><span data-stu-id="29ea1-594">\@.'\$Question'.text</span></span> |
    | <span data-ttu-id="29ea1-595">Kwestionariusz\\Pytanie\\Odpowiedź</span><span class="sxs-lookup"><span data-stu-id="29ea1-595">Questionnaire\\Question\\Answer</span></span>                         | <span data-ttu-id="29ea1-596">Lista rekordów</span><span class="sxs-lookup"><span data-stu-id="29ea1-596">Record list</span></span> | <span data-ttu-id="29ea1-597">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-597">Bind</span></span>   | <span data-ttu-id="29ea1-598">\@.'\$Question'.'\$Answer'</span><span class="sxs-lookup"><span data-stu-id="29ea1-598">\@.'\$Question'.'\$Answer'</span></span> |
    | <span data-ttu-id="29ea1-599">Kwestionariusz\\Pytanie\\Odpowiedź\\CorrectAnswer</span><span class="sxs-lookup"><span data-stu-id="29ea1-599">Questionnaire\\Question\\Answer\\CorrectAnswer</span></span>          | <span data-ttu-id="29ea1-600">Ciąg</span><span class="sxs-lookup"><span data-stu-id="29ea1-600">String</span></span>      | <span data-ttu-id="29ea1-601">Edycja</span><span class="sxs-lookup"><span data-stu-id="29ea1-601">Edit</span></span>   | <span data-ttu-id="29ea1-602">Helper.NoYesEnumToString(\@.correctAnswer = EnumAppNoYes.Yes)</span><span class="sxs-lookup"><span data-stu-id="29ea1-602">Helper.NoYesEnumToString(\@.correctAnswer = EnumAppNoYes.Yes)</span></span> |
    | <span data-ttu-id="29ea1-603">Kwestionariusz\\Pytanie\\Odpowiedź\\Punkty</span><span class="sxs-lookup"><span data-stu-id="29ea1-603">Questionnaire\\Question\\Answer\\Points</span></span>                 | <span data-ttu-id="29ea1-604">Rzeczywisty</span><span class="sxs-lookup"><span data-stu-id="29ea1-604">Real</span></span>        | <span data-ttu-id="29ea1-605">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-605">Bind</span></span>   | <span data-ttu-id="29ea1-606">\@.point</span><span class="sxs-lookup"><span data-stu-id="29ea1-606">\@.point</span></span> |
    | <span data-ttu-id="29ea1-607">Kwestionariusz\\Pytanie\\Odpowiedź\\SequenceNumber</span><span class="sxs-lookup"><span data-stu-id="29ea1-607">Questionnaire\\Question\\Answer\\SequenceNumber</span></span>         | <span data-ttu-id="29ea1-608">Wartość całkowita</span><span class="sxs-lookup"><span data-stu-id="29ea1-608">Integer</span></span>     | <span data-ttu-id="29ea1-609">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-609">Bind</span></span>   | <span data-ttu-id="29ea1-610">\@.sequenceNumber</span><span class="sxs-lookup"><span data-stu-id="29ea1-610">\@.sequenceNumber</span></span> |
    | <span data-ttu-id="29ea1-611">Kwestionariusz\\Pytanie\\Odpowiedź\\Tekst</span><span class="sxs-lookup"><span data-stu-id="29ea1-611">Questionnaire\\Question\\Answer\\Text</span></span>                   | <span data-ttu-id="29ea1-612">Ciąg</span><span class="sxs-lookup"><span data-stu-id="29ea1-612">String</span></span>      | <span data-ttu-id="29ea1-613">Powiąż</span><span class="sxs-lookup"><span data-stu-id="29ea1-613">Bind</span></span>   | <span data-ttu-id="29ea1-614">\@.text</span><span class="sxs-lookup"><span data-stu-id="29ea1-614">\@.text</span></span> |

    <span data-ttu-id="29ea1-615">Na poniższej ilustracji przedstawiono ostatni stan skonfigurowanego mapowania modelu na stronie **Projektanta mapowania modeli**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-615">The following illustration shows the final state of the configured model mapping on the **Model mapping designer** page.</span></span>

    ![W pełni skonfigurowany model mapowania w projektancie modeli mapowania ER](./media/er-quick-start1-mapping2.png)

7. <span data-ttu-id="29ea1-617">Zapisz zmiany.</span><span class="sxs-lookup"><span data-stu-id="29ea1-617">Save your changes.</span></span>
8. <span data-ttu-id="29ea1-618">Zamknij stronę **Projektant mapowania modelu**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-618">Close the **Model mapping designer** page.</span></span>

#### <a name="complete-the-design-of-the-model-mapping"></a><a name="CompleteModelMapping"></a><span data-ttu-id="29ea1-619">Umożliwia zakończenie projektu mapowania modelu</span><span class="sxs-lookup"><span data-stu-id="29ea1-619">Complete the design of the model mapping</span></span>

1. <span data-ttu-id="29ea1-620">Otwórz **Administracja organizacji** \> **Elektroniczne raportowanie** \> **Konfiguracje**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-620">Go to **Organization administration** \> **Electronic reporting** \> **Configurations**.</span></span>
2. <span data-ttu-id="29ea1-621">Na stronie **Konfiguracje** w drzewie konfiguracje wybierz **Mapowanie kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-621">On the **Configurations** page, in the configuration tree, select **Questionnaire mapping**.</span></span>
3. <span data-ttu-id="29ea1-622">Na skróconej karcie **wersje** szybkie wybierz wersję konfiguracji o stanie **Wersja robocza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-622">On the **Versions** FastTab, select the configuration version that has a status of **Draft**.</span></span>
4. <span data-ttu-id="29ea1-623">Wybierz **Zmień status** \> **Zakończone**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-623">Select **Change status** \> **Complete**.</span></span>

<span data-ttu-id="29ea1-624">Stan wersja 1.1 tej konfiguracji zostanie zmieniony z wersji **Roboczej** na **Ukończoną**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-624">The status of version 1.1 of this configuration is changed from **Draft** to **Completed**.</span></span> <span data-ttu-id="29ea1-625">Wersja 1.1 nie może być już zmieniana.</span><span class="sxs-lookup"><span data-stu-id="29ea1-625">Version 1.1 can no longer be changed.</span></span> <span data-ttu-id="29ea1-626">Ta wersja zawiera skonfigurowany model mapowania i może być używana jako podstawa dla innych konfiguracji ER.</span><span class="sxs-lookup"><span data-stu-id="29ea1-626">This version contains the configured model mapping and can be used as the basis for other ER configurations.</span></span> <span data-ttu-id="29ea1-627">Wersja 1.2 tej konfiguracji jest utworzona i ma stan **Wersja robocza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-627">Version 1.2 of this configuration is created and has a status of **Draft**.</span></span> <span data-ttu-id="29ea1-628">Tę wersję można edytować, aby skorygować konfigurację **Mapowanie kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-628">You can edit this version to adjust the **Questionnaire mapping** configuration.</span></span>

![Wersje edytowalnej konfiguracji ER na stronie konfiguracje](./media/er-quick-start1-mapping-configuration.png)

> [!NOTE]
> <span data-ttu-id="29ea1-630">Skonfigurowane mapowanie modelu to specyficzna dla finansów implementacja abstrakcyjnego modelu danych, który reprezentuje domenę biznesową **Kwestionariusz**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-630">The configured model mapping is your Finance-specific implementation of the abstract data model that represents the **Questionnaire** business domain.</span></span>

## <a name="design-a-template-for-a-custom-report"></a><a name="DesignReportTemplate"></a><span data-ttu-id="29ea1-631">Projektowanie szablonu raportu niestandardowego</span><span class="sxs-lookup"><span data-stu-id="29ea1-631">Design a template for a custom report</span></span>

<span data-ttu-id="29ea1-632">Struktura ER wykorzystuje predefiniowane szablony do generowania raportów w formatach Microsoft Office (skoroszyty programu Excel lub dokumenty Word).</span><span class="sxs-lookup"><span data-stu-id="29ea1-632">The ER framework uses predefined templates to generate reports in Microsoft Office formats (Excel workbooks or Word documents).</span></span> <span data-ttu-id="29ea1-633">Podczas generowania wymaganego raportu szablon jest wypełniany wymaganymi danymi zgodnie ze skonfigurowanym przepływem danych.</span><span class="sxs-lookup"><span data-stu-id="29ea1-633">While the required report is being generated, a template is filled in with required data according to the configured dataflow.</span></span> <span data-ttu-id="29ea1-634">Dlatego należy najpierw zaprojektować szablon raportu niestandardowego.</span><span class="sxs-lookup"><span data-stu-id="29ea1-634">Therefore, you must first design a template for your custom report.</span></span> <span data-ttu-id="29ea1-635">Ten szablon musi być zaprojektowany jako skoroszyt programu Excel, którego struktura reprezentuje układ raportu niestandardowego.</span><span class="sxs-lookup"><span data-stu-id="29ea1-635">This template must be designed as an Excel workbook, the structure of which represents the layout of a custom report.</span></span> <span data-ttu-id="29ea1-636">Należy nazwać każdy element programu Excel, który ma być wypełniony wymaganymi danymi.</span><span class="sxs-lookup"><span data-stu-id="29ea1-636">You must name every Excel item that you plan to fill in with required data.</span></span>

1. <span data-ttu-id="29ea1-637">Pobierz [Szablon raportu kwestionariusza.xslx](https://go.microsoft.com/fwlink/?linkid=851448) i zapisz go na komputerze lokalnym.</span><span class="sxs-lookup"><span data-stu-id="29ea1-637">Download the [Questionnaires report template.xslx](https://go.microsoft.com/fwlink/?linkid=851448) file, and save it to your local computer.</span></span>
2. <span data-ttu-id="29ea1-638">Otwórz plik w programie Excel i przejrzyj strukturę skoroszytu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-638">Open the file in Excel, and review the structure of the workbook.</span></span>

<span data-ttu-id="29ea1-639">Jak pokazuje poniższa ilustracja, pobrany szablon został zaprojektowany w celu wydrukowania określonych kwestionariuszy, które zawierają pytania zawarte w kwestionariuszu wraz z odpowiednimi odpowiedziami.</span><span class="sxs-lookup"><span data-stu-id="29ea1-639">As the following illustration shows, the downloaded template has been designed to print specified questionnaires that present a questionnaire's questions together with appropriate answers.</span></span>

![Szablon programu Excel do drukowania określonych kwestionariuszy](./media/er-quick-start1-template-layout.png)

<span data-ttu-id="29ea1-641">Do tego szablonu zostały dodane nazwy programu Excel, aby wypełnić szczegóły kwestionariusza.</span><span class="sxs-lookup"><span data-stu-id="29ea1-641">Excel names have been added to this template to fill in the questionnaire details.</span></span> <span data-ttu-id="29ea1-642">Do przeglądania nazw Excel można użyć Menedżera nazw.</span><span class="sxs-lookup"><span data-stu-id="29ea1-642">You can use Name Manager to review the Excel names.</span></span>
...
<span data-ttu-id="29ea1-644">Etykiety raportów zostały dodane jako stały tekst w języku angielskim.</span><span class="sxs-lookup"><span data-stu-id="29ea1-644">Report labels have been added as fixed text in the English language.</span></span> <span data-ttu-id="29ea1-645">Etykiety raportów można zastąpić nowymi nazwami programu Excel, które wypełniają etykiety tekstem zależnym od języka, używając [etykiet](#AddMmLabels) formatu ER, tak jak w przypadku wyrażeń zależnych od języka w skonfigurowanym mapowaniu modelu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-645">You can replace the report labels with new Excel names that fill in the labels with language-dependent text by using the ER format [labels](#AddMmLabels), as you did for language-dependent expressions in the configured model mapping.</span></span> <span data-ttu-id="29ea1-646">W takim przypadku do edytowalnego formatu ER trzeba dodać etykiety ER.</span><span class="sxs-lookup"><span data-stu-id="29ea1-646">In this case, ER labels must be added in the editable ER format.</span></span>

<span data-ttu-id="29ea1-647">Na poniższej ilustracji przedstawiono nagłówek raportu niestandardowego, który umożliwia stronicowanie w Excel.</span><span class="sxs-lookup"><span data-stu-id="29ea1-647">As the following illustration shows, the custom report header has been specified to enable Excel to do paging.</span></span>

![Niestandardowy nagłówek raportu w podanym szablonie programu Excel](./media/er-quick-start1-template-header.png)

## <a name="design-a-format"></a><a name="DesignFormat"></a><span data-ttu-id="29ea1-649">Projektowanie formatu</span><span class="sxs-lookup"><span data-stu-id="29ea1-649">Design a format</span></span>

<span data-ttu-id="29ea1-650">Jako użytkownik pełniący rolę konsultanta funkcjonalnego raportowania elektronicznego należy utworzyć nową konfigurację ER zawierającą komponent [formatu](general-electronic-reporting.md#FormatComponentOutbound).</span><span class="sxs-lookup"><span data-stu-id="29ea1-650">As a user in the Electronic Reporting Functional Consultant role, you must create a new ER configuration that contains a [format](general-electronic-reporting.md#FormatComponentOutbound) component.</span></span> <span data-ttu-id="29ea1-651">Należy skonfigurować składnik formatu w celu określenia sposobu, w jaki szablon raportu będzie wypełniał wymagane dane w czasie wykonywania.</span><span class="sxs-lookup"><span data-stu-id="29ea1-651">You must configure the format component to specify how a report template will be filled in with required data at runtime.</span></span>

<span data-ttu-id="29ea1-652">Wykonując kroki opisane w sekcji [Import zaprojektowanej konfiguracji formatu](#FormatImport), można zaimportować wymagany format z podanego pliku XML.</span><span class="sxs-lookup"><span data-stu-id="29ea1-652">By completing the steps in the [Import a designed format configuration](#FormatImport) section, you can import the required format from the provided XML file.</span></span> <span data-ttu-id="29ea1-653">Można również wykonać kroki opisane w sekcji [Utwórz nową konfigurację formatu](#FormatCreate), aby zaprojektować ten format od podstaw.</span><span class="sxs-lookup"><span data-stu-id="29ea1-653">Alternatively, you can complete the steps in the [Create a new format configuration](#FormatCreate) section to design this format from scratch.</span></span>

### <a name="import-a-designed-format-configuration"></a><a name="FormatImport"></a><span data-ttu-id="29ea1-654">Import zaprojektowanej konfiguracji formatu</span><span class="sxs-lookup"><span data-stu-id="29ea1-654">Import a designed format configuration</span></span>

1. <span data-ttu-id="29ea1-655">Pobierz [Kwestionariusze formatu.wersja.1.1.xml](https://go.microsoft.com/fwlink/?linkid=851448) i zapisz go na komputerze lokalnym.</span><span class="sxs-lookup"><span data-stu-id="29ea1-655">Download the [Questionnaires format.version.1.1.xml](https://go.microsoft.com/fwlink/?linkid=851448) file, and save it to your local computer.</span></span>
2. <span data-ttu-id="29ea1-656">Wybierz kolejno opcje **Administrowanie organizacją** \> **Obszary robocze** \> **Raportowanie elektroniczne**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-656">Go to **Organization administration** \> **Workspaces** \> **Electronic reporting**.</span></span>
3. <span data-ttu-id="29ea1-657">W obszarze roboczym **raportowanie elektroniczne** wybierz **konfiguracje raportowania**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-657">In the **Electronic reporting** workspace, select **Reporting configurations**.</span></span>
4. <span data-ttu-id="29ea1-658">W okienku akcji wybierz opcję **Wymiana** \> **Załaduj z pliku XML**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-658">On the Action pane, Select **Exchange** \> **Load from XML file**.</span></span>
5. <span data-ttu-id="29ea1-659">Wybierz opcję **Przeglądaj**, a następnie znajdź i wybierz **Format kwestionariuszy.wersja.1.1.xml**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-659">Select **Browse**, and then find and select the **Questionnaires format.version.1.1.xml** file.</span></span>
6. <span data-ttu-id="29ea1-660">Wybierz przycisk **OK**, aby importować konfigurację.</span><span class="sxs-lookup"><span data-stu-id="29ea1-660">Select **OK** to import the configuration.</span></span>

<span data-ttu-id="29ea1-661">Aby kontynuować, pomiń następną procedurę, [Utwórz nową konfigurację formatu](#FormatCreate).</span><span class="sxs-lookup"><span data-stu-id="29ea1-661">To continue, skip the next procedure, [Create a new format configuration](#FormatCreate).</span></span>

### <a name="create-a-new-format-configuration"></a><a name="FormatCreate"></a><span data-ttu-id="29ea1-662">Utwórz nową konfigurację formatu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-662">Create a new format configuration</span></span>
 
1. <span data-ttu-id="29ea1-663">Otwórz **Administracja organizacji** \> **Elektroniczne raportowanie** \> **Konfiguracje**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-663">Go to **Organization administration** \> **Electronic reporting** \> **Configurations**.</span></span>
2. <span data-ttu-id="29ea1-664">Na stronie **Konfiguracje** w drzewie konfiguracje wybierz **Model kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-664">On the **Configurations** page, in the configuration tree, select **Questionnaire model**.</span></span>
3. <span data-ttu-id="29ea1-665">Wybierz **Utwórz konfigurację**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-665">Select **Create configuration**.</span></span>
4. <span data-ttu-id="29ea1-666">W oknie dialogowym rozwijanym wykonaj następujące kroki:</span><span class="sxs-lookup"><span data-stu-id="29ea1-666">In the drop-down dialog box, follow these steps:</span></span>

    1. <span data-ttu-id="29ea1-667">W polu **Nowy** wybierz **Format oparty na modelu danych Kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-667">In the **New** field, select **Format based on data model Questionnaires**.</span></span>
    2. <span data-ttu-id="29ea1-668">W polu **Nazwa** wpisz **Raport kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-668">In the **Name** field, enter **Questionnaire report**.</span></span>
    3. <span data-ttu-id="29ea1-669">W polu **Wersja modelu danych** wybierz **1**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-669">In the **Data model version** field, select **1**.</span></span>

        > [!NOTE]
        > - <span data-ttu-id="29ea1-670">W przypadku wybrania określonej wersji podstawowego modelu danych, struktura odpowiedniej wersji modelu danych zostanie przedstawiona jako struktura **Modelu** źródła danych w utworzonym formacie.</span><span class="sxs-lookup"><span data-stu-id="29ea1-670">If you select a specific version of the base data model, the structure of the corresponding version of the data model will be presented to you as the structure of the **Model** data source in the format that is created.</span></span>
        > - <span data-ttu-id="29ea1-671">Można pozostawić to pole puste.</span><span class="sxs-lookup"><span data-stu-id="29ea1-671">You can leave this field blank.</span></span> <span data-ttu-id="29ea1-672">W takim przypadku struktura **Wersji roboczej** modelu danych zostanie przedstawiona jako struktura źródła danych **Modelu** w utworzonym formacie.</span><span class="sxs-lookup"><span data-stu-id="29ea1-672">In that case, the structure of the **Draft** version of the data model will be presented to you as the structure of the **Model** data source in the format that is created.</span></span> <span data-ttu-id="29ea1-673">Następnie można dostosować model i natychmiast zobaczyć te zmiany w formacie.</span><span class="sxs-lookup"><span data-stu-id="29ea1-673">You can then adjust your model and immediately see those adjustments in your format.</span></span> <span data-ttu-id="29ea1-674">Takie podejście może poprawić wydajność projektu rozwiązania ER podczas konfigurowania modelu danych, mapowania modelu i formatowania jednocześnie.</span><span class="sxs-lookup"><span data-stu-id="29ea1-674">This approach might improve the efficiency of ER solution design when you configure your data model, model mapping, and format simultaneously.</span></span>
        > - <span data-ttu-id="29ea1-675">W przypadku wybrania konkretnej wersji podstawowego modelu danych można użyć **Wersji roboczej** w późniejszym czasie, gdy zaczniesz edytować format.</span><span class="sxs-lookup"><span data-stu-id="29ea1-675">If you select a specific version of the base data model, you can switch to using the **Draft** version later, when you start to edit a format.</span></span>

    4. <span data-ttu-id="29ea1-676">W polu **Definicja modelu danych** wybierz definicję **Główną**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-676">In the **Data model definition** field, select the **Root** definition.</span></span>

5. <span data-ttu-id="29ea1-677">Wybierz **Stwórz konfiguracj**, aby stworzyć konfigurację.</span><span class="sxs-lookup"><span data-stu-id="29ea1-677">Select **Create configuration** to create the configuration.</span></span>

#### <a name="import-a-report-template"></a><a name="ImportReportTemplate"></a><span data-ttu-id="29ea1-678">Zaimportuj szablon raportu</span><span class="sxs-lookup"><span data-stu-id="29ea1-678">Import a report template</span></span>

1. <span data-ttu-id="29ea1-679">Na stronie **Konfiguracje** w drzewie konfiguracje wybierz **Raport kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-679">On the **Configurations** page, in the configuration tree, select **Questionnaire report**.</span></span>
2. <span data-ttu-id="29ea1-680">Wybierz opcję **Projektant**, aby rozpocząć konfigurowanie formatu niestandardowego.</span><span class="sxs-lookup"><span data-stu-id="29ea1-680">Select **Designer** to start to configure a custom format.</span></span>
3. <span data-ttu-id="29ea1-681">Na stronie **Projektant formatu** w okienku akcji wybierz **Importuj** \> **Importuj z programu Excel**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-681">On the **Format designer** page, on the Action Pane, select **Import** \> **Import from Excel**.</span></span>
4. <span data-ttu-id="29ea1-682">W oknie dialogowym wykonaj następujące kroki:</span><span class="sxs-lookup"><span data-stu-id="29ea1-682">In the dialog box, follow these steps:</span></span>

    1. <span data-ttu-id="29ea1-683">Wybierz **Dodaj szablon**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-683">Select **Add template**.</span></span>
    2. <span data-ttu-id="29ea1-684">Znajdź i wybierz lokalnie zapisany plik **Szablon raportu kwestionariusza.xslx**, a następnie wybierz opcję **Otwórz**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-684">Find and select the locally saved **Questionnaires report template.xslx** file, and then select **Open**.</span></span>
    3. <span data-ttu-id="29ea1-685">Wybierz przycisk **OK**, aby importować szablon.</span><span class="sxs-lookup"><span data-stu-id="29ea1-685">Select **OK** to import the template.</span></span>

    ![Importowanie szablonu raportu](./media/er-quick-start1-template-import.png)

<span data-ttu-id="29ea1-687">Element formatu **Excel\\Plik** jest automatycznie dodawany do formatu edytowalnego jako element główny.</span><span class="sxs-lookup"><span data-stu-id="29ea1-687">The **Excel\\File** format element is automatically added to the editable format as a root element.</span></span> <span data-ttu-id="29ea1-688">Dodatkowo, element formatu **Excel\\Zakres** lub element formatu **Excel\\Komórka** jest automatycznie dodawany do każdej rozpoznanej nazwy Excela importowanego szablonu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-688">Additionally, either the **Excel\\Range** format element or the **Excel\\Cell** format element is automatically added for every recognized Excel name of the imported template.</span></span> <span data-ttu-id="29ea1-689">Format **Excel\\Nagłówek** z zagnieżdżonym elementem **Ciąg** jest dodawany automatycznie w celu odzwierciedlenia ustawień nagłówka zaimportowanego szablonu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-689">The **Excel\\Header** format that has the nested **String** element is automatically added to reflect the header settings of the imported template.</span></span>
...
#### <a name="configure-a-format"></a><a name="ConfigureFormat"></a><span data-ttu-id="29ea1-691">Konfigurowanie formatu</span><span class="sxs-lookup"><span data-stu-id="29ea1-691">Configure a format</span></span>

1. <span data-ttu-id="29ea1-692">Na stronie **Projektant formatów** w drzewie formatu wybierz element główny programu **Excel**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-692">On the **Format designer** page, in the format tree, select the **Excel** root element.</span></span>
2. <span data-ttu-id="29ea1-693">Na karcie **Format** po prawej stronie strony, w polu **Nazwa** wprowadź <a name="AddFormatRootElement"></a>**Raport**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-693">On the **Format** tab on the right side of the page, in the **Name** field, enter <a name="AddFormatRootElement"></a>**Report**.</span></span>
3. <span data-ttu-id="29ea1-694">W polu **Preferencje języka** wybierz opcję **Preferencje użytkownika**, aby uruchomić raport w preferowanym języku użytkownika.</span><span class="sxs-lookup"><span data-stu-id="29ea1-694">In the **Language preference** field, select **User preference** to run the report in the user's preferred language.</span></span>
4. <span data-ttu-id="29ea1-695">W polu **Preferencje dotyczące kultury** wybierz opcję **Preferencje użytkownika**, aby uruchomić raport dostosowany do preferencji kulturowych użytkownika.</span><span class="sxs-lookup"><span data-stu-id="29ea1-695">In the **Culture preference** field, select **User preference** to run the report in the user's preferred culture.</span></span>

    <span data-ttu-id="29ea1-696">Aby uzyskać informacje dotyczące sposobu określania kontekstu języka i kultury dla procesu ER, zapoznaj się z tematem [Projektowanie raportów wielojęzycznych](er-design-multilingual-reports.md).</span><span class="sxs-lookup"><span data-stu-id="29ea1-696">For information about how to specify the language and culture contexts for an ER process, see [Design multilingual reports](er-design-multilingual-reports.md).</span></span>
...
5. <span data-ttu-id="29ea1-698">W drzewie formatu rozwiń węzeł główny, a następnie wybierz pozycję **ResultsGroup**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-698">In the format tree, expand the root node, and then select **ResultsGroup**.</span></span>
6. <span data-ttu-id="29ea1-699">Na karcie **Format** w polu **Kierunek replikacji** wybierz opcję **Brak replikacji**, ponieważ nie ma oczekiwanego wielu grup wyników dla jednego kwestionariusza.</span><span class="sxs-lookup"><span data-stu-id="29ea1-699">On the **Format** tab, in the **Replication direction** field, select **No replication**, because you don't expect to have multiple result groups for a single questionnaire.</span></span>
...
7. <span data-ttu-id="29ea1-701">Wybierz opcję **Zapisz**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-701">Select **Save**.</span></span>

#### <a name="define-the-data-binding-for-a-report-title"></a><a name="DefineFormatBindings"></a><span data-ttu-id="29ea1-702">Definiowanie powiązania danych dla tytułu raportu</span><span class="sxs-lookup"><span data-stu-id="29ea1-702">Define the data binding for a report title</span></span>

<span data-ttu-id="29ea1-703">Należy określić powiązanie danych dla elementu formatu używanego do wypełniania tytułu wygenerowanego raportu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-703">You must specify a data binding for a format element that is used to fill in the title of a generated report.</span></span>

1. <span data-ttu-id="29ea1-704">Na stronie **Projektant formatów** na karcie **Mapowanie** po prawej stronie wybierz element pliku **Raport\\ReportTitle** w drzewie formatu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-704">On the **Format designer** page, on the **Mapping** tab on the right, select the **Report\\ReportTitle** element.</span></span>
2. <span data-ttu-id="29ea1-705">Wybierz opcję **Edytuj formułę**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-705">Select **Edit formula**.</span></span>
3. <span data-ttu-id="29ea1-706">W edytorze formuł wybierz opcję **Przetłumacz**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-706">In the formula editor, select **Translate**.</span></span>
4. <span data-ttu-id="29ea1-707">W oknie dialogowym **Tłumaczenie tekstu** wykonaj następujące kroki:</span><span class="sxs-lookup"><span data-stu-id="29ea1-707">In the **Text translation** dialog box, follow these steps:</span></span>

    1. <span data-ttu-id="29ea1-708">W polu **Identyfikator etykiety** wejdź do **ReportTitle**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-708">In the **Label ID** field, enter **ReportTitle**.</span></span>
    2. <span data-ttu-id="29ea1-709">W polu **Tekst w języku domyślnym** wprowadź wartość **Raport kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-709">In the **Text in default language** field, enter **Questionnaires report**.</span></span>
    3. <span data-ttu-id="29ea1-710">Zaznacz element **Przetłumacz** i kliknij przycisk **Zapisz**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-710">Select **Translate**, and then select **Save**.</span></span>
    4. <span data-ttu-id="29ea1-711">Wybierz opcję **Przetłumacz**, aby zamknąć okno dialogowe **Tłumaczenie tekstu**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-711">Select **Translate** to close the **Text translation** dialog box.</span></span>

5. <span data-ttu-id="29ea1-712">Zamknij edytor formuł.</span><span class="sxs-lookup"><span data-stu-id="29ea1-712">Close the formula editor.</span></span>
...
<span data-ttu-id="29ea1-714">Tę technikę można stosować do tworzenia wszystkich etykiet zależnych od języka bieżącego szablonu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-714">You can use this technique to make all other labels of the current template language-dependent.</span></span> <span data-ttu-id="29ea1-715">Aby uzyskać informacje dotyczące sposobu tłumaczenia dodanych etykiet jednej konfiguracji ER na wszystkie obsługiwane języki, zapoznaj się z tematami [Projektowanie raportów wielojęzycznych](er-design-multilingual-reports.md).</span><span class="sxs-lookup"><span data-stu-id="29ea1-715">For information about how the added labels of a single ER configuration can be translated into all supported languages, see [Design multilingual reports](er-design-multilingual-reports.md).</span></span>

#### <a name="review-model-data-source"></a><a name="ReviewModelDataSource"></a><span data-ttu-id="29ea1-716">Przejrzyj źródło danych modelu</span><span class="sxs-lookup"><span data-stu-id="29ea1-716">Review model data source</span></span>

1. <span data-ttu-id="29ea1-717">Na stronie **Projektant formatów** na karcie **Mapowanie** wybierz <a name="ModelDSName"></a>**model** źródła danych, który reprezentuje podstawowy model danych tego formatu ER.</span><span class="sxs-lookup"><span data-stu-id="29ea1-717">On the **Format designer** page, on the **Mapping** tab, select the <a name="ModelDSName"></a>**model** data source that represents the base data model of this ER format.</span></span>
2. <span data-ttu-id="29ea1-718">Wybierz opcję **Edycja**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-718">Select **Edit**.</span></span>
3. <span data-ttu-id="29ea1-719">Przejrzyj informacje w oknie dialogowym **Właściwości źródła danych**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-719">Review the information in the **Data source properties** dialog box.</span></span> <span data-ttu-id="29ea1-720">To źródło danych reprezentuje wersję 1 składnika modelu danych **Kwestionariuszy**, który znajduje się w konfiguracji ER dla **Modelu kwestionariuszy**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-720">This data source represents version 1 of the **Questionnaires** data model component that resides in the **Questionnaires model** ER configuration.</span></span>

![Właściwości źródła danych modelu w projektancie operacji ER](./media/er-quick-start1-model-data-source.png)

#### <a name="bind-format-elements-to-data-source-fields"></a><a name="BindFormatElements"></a><span data-ttu-id="29ea1-722">Powiązanie elementów formatu na pola źródła danych</span><span class="sxs-lookup"><span data-stu-id="29ea1-722">Bind format elements to data source fields</span></span>

<span data-ttu-id="29ea1-723">Aby określić sposób wypełniania szablonu w czasie wykonywania, należy powiązać każdy element formatu powiązany z odpowiednią nazwą programu Excel z pojedynczym polem źródła danych tego formatu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-723">To specify how a template is filled in at runtime, you must bind every format element that is associated with an appropriate Excel name to a single field of this format's data source.</span></span>

1. <span data-ttu-id="29ea1-724">Na stronie **Projektant formatów** w drzewie formatu wybierz element formatu **Raport\\CompanyName**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-724">On the **Format designer** page, in the format tree, select the **Report\\CompanyName** format element.</span></span>
2. <span data-ttu-id="29ea1-725">Na karcie **Mapowanie** wybierz pole źródła danych **model.CompanyName** typu **Ciąg**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-725">On the **Mapping** tab, select the **model.CompanyName** data source field of the **String** type.</span></span>
3. <span data-ttu-id="29ea1-726">Wybierz opcję **Powiąż**, aby wprowadzić nazwę firmy w szablonie.</span><span class="sxs-lookup"><span data-stu-id="29ea1-726">Select **Bind** to enter a company name in a template.</span></span>
4. <span data-ttu-id="29ea1-727">W drzewie formatu zaznacz element **Report\\Kwestionariusz**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-727">In the format tree, select the **Report\\Questionnaire** element.</span></span>
5. <span data-ttu-id="29ea1-728">Na karcie **Mapowanie** wybierz pole źródła danych **model.Questionnaire** typu **Lista rekordów**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-728">On the **Mapping** tab, select the **model.Questionnaire** data source field of the **Record list** type.</span></span>
6. <span data-ttu-id="29ea1-729">Wybierz **Powiąż**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-729">Select **Bind**.</span></span>
7. <span data-ttu-id="29ea1-730">Wybierz opcję **Pokaż szczegóły**, aby wyświetlić więcej szczegółów dotyczących elementów formatu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-730">Select **Show details** to see more details for format elements.</span></span>

    <span data-ttu-id="29ea1-731">Element formatu zakresu **Kwestionariusza** jest skonfigurowany jako replikowany pionowo.</span><span class="sxs-lookup"><span data-stu-id="29ea1-731">The **Questionnaire** range format element is configured as vertically replicated.</span></span> <span data-ttu-id="29ea1-732">Jeśli jest powiązany ze źródłem danych typu **Lista rekordów**, odpowiedni zakres **Kwestionariusza** w szablonie programu Excel jest powtarzany dla każdego rekordu powiązanego źródła danych.</span><span class="sxs-lookup"><span data-stu-id="29ea1-732">When it's bound to a data source of the **Record list** type, the appropriate **Questionnaire** range of the Excel template is repeated for every record of the bound data source.</span></span>
...
8. <span data-ttu-id="29ea1-736">Skonfiguruj podobne powiązania dla pozostałych elementów formatu, tak jak to opisano w poniższej tabeli.</span><span class="sxs-lookup"><span data-stu-id="29ea1-736">Configure similar bindings for the remaining format elements, as described in the following table.</span></span>

    > [!NOTE]
    > <span data-ttu-id="29ea1-737">W tej tabeli informacje w kolumnie „ścieżka źródła danych” zakładają, że funkcja ER [ścieżka względna](relative-path-data-bindings-er-models-format.md) jest włączona.</span><span class="sxs-lookup"><span data-stu-id="29ea1-737">In this table, the information in the "Data source path" column assumes that the [relative path](relative-path-data-bindings-er-models-format.md) ER feature is turned on.</span></span>

    | <span data-ttu-id="29ea1-738">Ścieżka elementu formatu</span><span class="sxs-lookup"><span data-stu-id="29ea1-738">Format element path</span></span>                                      | <span data-ttu-id="29ea1-739">Ścieżka źródła danych</span><span class="sxs-lookup"><span data-stu-id="29ea1-739">Data source path</span></span> |
    |----------------------------------------------------------|------------------|
    | <span data-ttu-id="29ea1-740">Excel\\ReportTitle</span><span class="sxs-lookup"><span data-stu-id="29ea1-740">Excel\\ReportTitle</span></span>                                       | <span data-ttu-id="29ea1-741">**\@"GER\_LABEL:ReportTitle"**</span><span class="sxs-lookup"><span data-stu-id="29ea1-741">**\@"GER\_LABEL:ReportTitle"**</span></span> |
    | <span data-ttu-id="29ea1-742">Excel\\CompanyName</span><span class="sxs-lookup"><span data-stu-id="29ea1-742">Excel\\CompanyName</span></span>                                       | <span data-ttu-id="29ea1-743">**model.CompanyName**</span><span class="sxs-lookup"><span data-stu-id="29ea1-743">**model.CompanyName**</span></span> |
    | <span data-ttu-id="29ea1-744">Excel\\Kwestionariusz</span><span class="sxs-lookup"><span data-stu-id="29ea1-744">Excel\\Questionnaire</span></span>                                     | <span data-ttu-id="29ea1-745">**model.Questionnaire**</span><span class="sxs-lookup"><span data-stu-id="29ea1-745">**model.Questionnaire**</span></span> |
    | <span data-ttu-id="29ea1-746">Excel\\Kwestionariusz\\Aktywny</span><span class="sxs-lookup"><span data-stu-id="29ea1-746">Excel\\Questionnaire\\Active</span></span>                             | <span data-ttu-id="29ea1-747">**\@.Active**, gdzie **\@** to **model.Questionnaire**</span><span class="sxs-lookup"><span data-stu-id="29ea1-747">**\@.Active**, where **\@** is **model.Questionnaire**</span></span> |
    | <span data-ttu-id="29ea1-748">Excel\\Kwestionariusz\\Kod</span><span class="sxs-lookup"><span data-stu-id="29ea1-748">Excel\\Questionnaire\\Code</span></span>                               | <span data-ttu-id="29ea1-749">**\@.Code**</span><span class="sxs-lookup"><span data-stu-id="29ea1-749">**\@.Code**</span></span> |
    | <span data-ttu-id="29ea1-750">Excel\\Kwestionariusz\\Opis</span><span class="sxs-lookup"><span data-stu-id="29ea1-750">Excel\\Questionnaire\\Description</span></span>                        | <span data-ttu-id="29ea1-751">**\@.Opis**</span><span class="sxs-lookup"><span data-stu-id="29ea1-751">**\@.Description**</span></span> |
    | <span data-ttu-id="29ea1-752">Excel\\Kwestionariusz\\TypKwestionariusza</span><span class="sxs-lookup"><span data-stu-id="29ea1-752">Excel\\Questionnaire\\QuestionnaireType</span></span>                  | <span data-ttu-id="29ea1-753">**\@.QuestionnaireType**</span><span class="sxs-lookup"><span data-stu-id="29ea1-753">**\@.QuestionnaireType**</span></span> |
    | <span data-ttu-id="29ea1-754">Excel\\Kwestionariusz\\QuestionOrder</span><span class="sxs-lookup"><span data-stu-id="29ea1-754">Excel\\Questionnaire\\QuestionOrder</span></span>                      | <span data-ttu-id="29ea1-755">**\@.QuestionOrder**</span><span class="sxs-lookup"><span data-stu-id="29ea1-755">**\@.QuestionOrder**</span></span> |
    | <span data-ttu-id="29ea1-756">Excel\\Kwestionariusz\\ResultsGroup\\Kod\_</span><span class="sxs-lookup"><span data-stu-id="29ea1-756">Excel\\Questionnaire\\ResultsGroup\\Code\_</span></span>               | <span data-ttu-id="29ea1-757">**\@.ResultsGroup.Code**</span><span class="sxs-lookup"><span data-stu-id="29ea1-757">**\@.ResultsGroup.Code**</span></span> |
    | <span data-ttu-id="29ea1-758">Excel\\Kwestionariusz\\ResultsGroup\\Opis\_</span><span class="sxs-lookup"><span data-stu-id="29ea1-758">Excel\\Questionnaire\\ResultsGroup\\Description\_</span></span>        | <span data-ttu-id="29ea1-759">**\@.ResultsGroup.Description**</span><span class="sxs-lookup"><span data-stu-id="29ea1-759">**\@.ResultsGroup.Description**</span></span> |
    | <span data-ttu-id="29ea1-760">Excel\\Kwestionariusz\\ResultsGroup\\MaxNumberOfPoints</span><span class="sxs-lookup"><span data-stu-id="29ea1-760">Excel\\Questionnaire\\ResultsGroup\\MaxNumberOfPoints</span></span>    | <span data-ttu-id="29ea1-761">**\@.ResultsGroup.MaxNumberOfPoint**</span><span class="sxs-lookup"><span data-stu-id="29ea1-761">**\@.ResultsGroup.MaxNumberOfPoint**</span></span> |
    | <span data-ttu-id="29ea1-762">Excel\\Kwestionariusz\\Pytanie</span><span class="sxs-lookup"><span data-stu-id="29ea1-762">Excel\\Questionnaire\\Question</span></span>                           | <span data-ttu-id="29ea1-763">**\@.Pytanie**</span><span class="sxs-lookup"><span data-stu-id="29ea1-763">**\@.Question**</span></span> |
    | <span data-ttu-id="29ea1-764">Excel\\Kwestionariusz\\Pytanie\\CollectionSequenceNumber</span><span class="sxs-lookup"><span data-stu-id="29ea1-764">Excel\\Questionnaire\\Question\\CollectionSequenceNumber</span></span> | <span data-ttu-id="29ea1-765">**\@.CollectionSequenceNumber**, gdzie **\@** to **model.Questionnaire.Question**</span><span class="sxs-lookup"><span data-stu-id="29ea1-765">**\@.CollectionSequenceNumber**, where **\@** is **model.Questionnaire.Question**</span></span> |
    | <span data-ttu-id="29ea1-766">Excel\\Kwestionariusz\\Pytanie\\Identyfikator</span><span class="sxs-lookup"><span data-stu-id="29ea1-766">Excel\\Questionnaire\\Question\\Id</span></span>                       | <span data-ttu-id="29ea1-767">**\@.Id**</span><span class="sxs-lookup"><span data-stu-id="29ea1-767">**\@.Id**</span></span> |
    | <span data-ttu-id="29ea1-768">Excel\\Kwestionariusz\\Pytanie\\MustBeCompleted</span><span class="sxs-lookup"><span data-stu-id="29ea1-768">Excel\\Questionnaire\\Question\\MustBeCompleted</span></span>          | <span data-ttu-id="29ea1-769">**\@.MustBeCompleted**</span><span class="sxs-lookup"><span data-stu-id="29ea1-769">**\@.MustBeCompleted**</span></span> |
    | <span data-ttu-id="29ea1-770">Excel\\Kwestionariusz\\Pytanie\\PrimaryQuestion</span><span class="sxs-lookup"><span data-stu-id="29ea1-770">Excel\\Questionnaire\\Question\\PrimaryQuestion</span></span>          | <span data-ttu-id="29ea1-771">**\@.PrimaryQuestion**</span><span class="sxs-lookup"><span data-stu-id="29ea1-771">**\@.PrimaryQuestion**</span></span> |
    | <span data-ttu-id="29ea1-772">Excel\\Kwestionariusz\\Pytanie\\SequenceNumber</span><span class="sxs-lookup"><span data-stu-id="29ea1-772">Excel\\Questionnaire\\Question\\SequenceNumber</span></span>           | <span data-ttu-id="29ea1-773">**\@.SequenceNumber**</span><span class="sxs-lookup"><span data-stu-id="29ea1-773">**\@.SequenceNumber**</span></span> |
    | <span data-ttu-id="29ea1-774">Excel\\Kwestionariusz\\Pytanie\\Tekst</span><span class="sxs-lookup"><span data-stu-id="29ea1-774">Excel\\Questionnaire\\Question\\Text</span></span>                     | <span data-ttu-id="29ea1-775">**\@.Text**</span><span class="sxs-lookup"><span data-stu-id="29ea1-775">**\@.Text**</span></span> |
    | <span data-ttu-id="29ea1-776">Excel\\Kwestionariusz\\Pytanie\\Odpowiedź</span><span class="sxs-lookup"><span data-stu-id="29ea1-776">Excel\\Questionnaire\\Question\\Answer</span></span>                   | <span data-ttu-id="29ea1-777">**\@.Answer**</span><span class="sxs-lookup"><span data-stu-id="29ea1-777">**\@.Answer**</span></span> |
    | <span data-ttu-id="29ea1-778">Excel\\Kwestionariusz\\Pytanie\\Odpowiedź\\CorrectAnswer</span><span class="sxs-lookup"><span data-stu-id="29ea1-778">Excel\\Questionnaire\\Question\\Answer\\CorrectAnswer</span></span>    | <span data-ttu-id="29ea1-779">**\@.CorrectAnswer**, gdzie **\@** to **model.Questionnaire.Answer**</span><span class="sxs-lookup"><span data-stu-id="29ea1-779">**\@.CorrectAnswer**, where **\@** is **model.Questionnaire.Answer**</span></span> |
    | <span data-ttu-id="29ea1-780">Excel\\Kwestionariusz\\Pytanie\\Odpowiedź\\Punkty</span><span class="sxs-lookup"><span data-stu-id="29ea1-780">Excel\\Questionnaire\\Question\\Answer\\Points</span></span>           | <span data-ttu-id="29ea1-781">**\@.Points**</span><span class="sxs-lookup"><span data-stu-id="29ea1-781">**\@.Points**</span></span> |
    | <span data-ttu-id="29ea1-782">Excel\\Kwestionariusz\\Pytanie\\Odpowiedź\\Tekst</span><span class="sxs-lookup"><span data-stu-id="29ea1-782">Excel\\Questionnaire\\Question\\Answer\\Text</span></span>             | <span data-ttu-id="29ea1-783">**\@.Text**</span><span class="sxs-lookup"><span data-stu-id="29ea1-783">**\@.Text**</span></span> |

9. <span data-ttu-id="29ea1-784">Po zakończeniu wybierz przycisk **Zapisz**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-784">When you've finished, select **Save**.</span></span>

<span data-ttu-id="29ea1-785">Na poniższej ilustracji przedstawiono ostatni stan skonfigurowanych powiązaniań danych na stronie **Projektanta formatów**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-785">The following illustration shows the final state of the configured data bindings on the **Format designer** page.</span></span>

![Skonfigurowane powiązania danych w projektancie operacji ER](./media/er-quick-start1-bindings2.png)

> [!IMPORTANT]
> <span data-ttu-id="29ea1-787">Cała kolekcja określonych źródeł danych i powiązań reprezentuje składnik odwzorowania formatu skonfigurowanego formatu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-787">The whole collection of specified data sources and bindings represents a format mapping component of the configured format.</span></span> <span data-ttu-id="29ea1-788">To mapowanie formatu jest wywoływane w przypadku uruchomienia skonfigurowanego formatu generowania raportu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-788">This format mapping is called when you run the configured format for report generation.</span></span>

### <a name="run-a-designed-format-from-er"></a><a name="RunFormatFromER"></a><span data-ttu-id="29ea1-789">Uruchamianie zaprojektowanego formatu od ER</span><span class="sxs-lookup"><span data-stu-id="29ea1-789">Run a designed format from ER</span></span>

<span data-ttu-id="29ea1-790">Możesz teraz uruchomić zaprojektowany format do celów testowych ze strony **Konfiguracje**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-790">You can now run a designed format for testing purposes from the **Configurations** page.</span></span>

1. <span data-ttu-id="29ea1-791">Otwórz **Administracja organizacji** \> **Elektroniczne raportowanie** \> **Konfiguracje**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-791">Go to **Organization administration** \> **Electronic reporting** \> **Configurations**.</span></span>
2. <span data-ttu-id="29ea1-792">Na stronie **Konfiguracje** w drzewie konfiguracji w panelu po lewej wybierz pozycję **Model kwestionariusza**, a potem wybierz **Raport kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-792">On the **Configuration** page, in the configuration tree, expand **Questionnaire model**, and then select **Questionnaire report**.</span></span>
3. <span data-ttu-id="29ea1-793">Wybierz opcję **Projektant** dla wersji formatu, która ma stan **Wersja robocza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-793">Select **Designer** for the format version that has a status of **Draft**.</span></span>
4. <span data-ttu-id="29ea1-794">Na stronie **Projektant formatów** wybierz opcję **Uruchom**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-794">On the **Format designer** page, select **Run**.</span></span>
5. <span data-ttu-id="29ea1-795">W oknie dialogowym **Parametry ER**, na skróconej karcie **Rekordy do uwzględnienia**, skonfiguruj opcję filtrowania tak, aby uwzględniony był tylko kwestionariusz **SBCCrsExam**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-795">In the **ER parameters** dialog box, on the **Records to include** FastTab, configure the filtering option so that only the **SBCCrsExam** questionnaire is included.</span></span>
6. <span data-ttu-id="29ea1-796">Wybierz przycisk **OK**, aby filtrować opcje.</span><span class="sxs-lookup"><span data-stu-id="29ea1-796">Select **OK** to confirm the filtering option.</span></span>
7. <span data-ttu-id="29ea1-797">Wybierz przycisk **OK**, aby uruchomić raport.</span><span class="sxs-lookup"><span data-stu-id="29ea1-797">Select **OK** to run the report.</span></span>
8. <span data-ttu-id="29ea1-798">Przejrzyj wygenerowany raport.</span><span class="sxs-lookup"><span data-stu-id="29ea1-798">Review the generated report.</span></span>

<span data-ttu-id="29ea1-799">[Domyślnie](electronic-reporting-destinations.md#default-behavior) wygenerowany raport jest dostarczany jako plik programu Excel, który można pobrać.</span><span class="sxs-lookup"><span data-stu-id="29ea1-799">By [default](electronic-reporting-destinations.md#default-behavior), a generated report is delivered as an Excel file that you can download.</span></span> <span data-ttu-id="29ea1-800">Na poniższych ilustracjach przedstawiono dwie strony wygenerowanego raportu w formacie programu Excel.</span><span class="sxs-lookup"><span data-stu-id="29ea1-800">The following illustrations show two pages of the generated report in Excel format.</span></span>
...
## <a name="tune-a-designed-format"></a><a name="TuneFormat"></a><span data-ttu-id="29ea1-803">Dostrajanie zaprojektowanego formatu</span><span class="sxs-lookup"><span data-stu-id="29ea1-803">Tune a designed format</span></span>

### <a name="modify-a-format-to-change-the-name-of-a-generated-document"></a><a name="ModifyToChangeName"></a><span data-ttu-id="29ea1-804">Modyfikowanie formatu w celu zmiany nazwy wygenerowanego dokumentu</span><span class="sxs-lookup"><span data-stu-id="29ea1-804">Modify a format to change the name of a generated document</span></span>

<span data-ttu-id="29ea1-805">Domyślnie wygenerowany dokument ma nazwę, używając aliasu bieżącego użytkownika.</span><span class="sxs-lookup"><span data-stu-id="29ea1-805">By default, a generated document is named by using the alias of the current user.</span></span> <span data-ttu-id="29ea1-806">Modyfikując format, można zmienić to zachowanie, tak aby wygenerowany dokument mógł zostać nazwany na podstawie logiki niestandardowej użytkownika.</span><span class="sxs-lookup"><span data-stu-id="29ea1-806">By modifying the format, you can change this behavior so that a generated document is named based on your custom logic.</span></span> <span data-ttu-id="29ea1-807">Na przykład nazwa wygenerowanego dokumentu może być oparta na dacie i godzinie bieżącej sesji oraz na tytule raportu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-807">For example, the name of a generated document can be based on the current session date and time, and on the report's title.</span></span>

1. <span data-ttu-id="29ea1-808">Na stronie **Projektant formatów** wybierz element główny **Raport**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-808">On the **Format designer** page, select the **Report** root item.</span></span>
2. <span data-ttu-id="29ea1-809">Na karcie **Mapowanie** wybierz opcję **Edytuj nazwę pliku**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-809">On the **Mapping** tab, select **Edit file name**.</span></span>
3. <span data-ttu-id="29ea1-810">W polu **Formuła** wprowadź **CONCATENATE (\@"GER\_LABEL:ReportTitle", " - ", DATETIMEFORMAT(SESSIONNOW(), "yyyy-MM-dd hh-mm-ss"))**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-810">In the **Formula** field, enter **CONCATENATE (\@"GER\_LABEL:ReportTitle", " - ", DATETIMEFORMAT(SESSIONNOW(), "yyyy-MM-dd hh-mm-ss"))**.</span></span>
4. <span data-ttu-id="29ea1-811">Wybierz przycisk **Zapisz** i zamknij edytor formuł.</span><span class="sxs-lookup"><span data-stu-id="29ea1-811">Select **Save**, and close the formula editor.</span></span>
5. <span data-ttu-id="29ea1-812">Wybierz opcję **Zapisz**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-812">Select **Save**.</span></span>

### <a name="modify-a-format-to-change-the-order-of-questions"></a><a name="ModifyToOrder"></a><span data-ttu-id="29ea1-813">Umożliwia zmodyfikowanie formatu w celu zmiany kolejności pytań</span><span class="sxs-lookup"><span data-stu-id="29ea1-813">Modify a format to change the order of questions</span></span>

<span data-ttu-id="29ea1-814">Pytania nie są poprawnie uporządkowane w wygenerowanym raporcie.</span><span class="sxs-lookup"><span data-stu-id="29ea1-814">The questions aren't correctly ordered in a generated report.</span></span> <span data-ttu-id="29ea1-815">Kolejność można zmienić, modyfikując format.</span><span class="sxs-lookup"><span data-stu-id="29ea1-815">You can change the order by modifying the format.</span></span>

1. <span data-ttu-id="29ea1-816">Na stronie **Projektant formatów** wybierz element główny **Raport**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-816">On the **Format designer** page, select the **Report** root item.</span></span>
2. <span data-ttu-id="29ea1-817">Na karcie **Mapowanie** w drzewie formatu rozwiń **Raport\\Kwestionariusz\\Pytanie**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-817">On the **Mapping** tab, in the format tree, expand **Report\\Questionnaire\\Question**.</span></span>

    ![Element formatu pytań dla zakresu typu Projektant operacji ER](./media/er-quick-start1-bindings3.png)

3. <span data-ttu-id="29ea1-819">Na karcie **Mapowanie** wybierz opcję **model.Questionnaire**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-819">On the **Mapping** tab, select **model.Questionnaire**.</span></span>
4. <span data-ttu-id="29ea1-820">Wybierz opcję **Dodaj** \> **Funkcje\\Pole obliczeniowe**, a następnie w polu **Nazwa** wprowadź **OrderedQuestions**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-820">Select **Add** \> **Functions\\Calculated field**, and then, in the **Name** field, enter **OrderedQuestions**.</span></span>
5. <span data-ttu-id="29ea1-821">Wybierz opcję **Edytuj formułę**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-821">Select **Edit formula**.</span></span>
6. <span data-ttu-id="29ea1-822">W edytorze formuł w polu **Formuła** wprowadź **ORDERBY (model.Questionnaire.Question, model.Questionnaire.Question.SequenceNumber)** w celu uporządkowania listy pytań bieżącego kwestionariusza według numeru porządkowego.</span><span class="sxs-lookup"><span data-stu-id="29ea1-822">In the formula editor, in the **Formula** field, enter **ORDERBY (model.Questionnaire.Question, model.Questionnaire.Question.SequenceNumber)** to order the list of questions of the current questionnaire by the sequence order number.</span></span>
7. <span data-ttu-id="29ea1-823">Wybierz przycisk **Zapisz** i zamknij edytor formuł.</span><span class="sxs-lookup"><span data-stu-id="29ea1-823">Select **Save**, and close the formula editor.</span></span>
8. <span data-ttu-id="29ea1-824">Wybierz przycisk **OK**, aby ukończyć wprowadzanie nowego pola obliczeniowego.</span><span class="sxs-lookup"><span data-stu-id="29ea1-824">Select **OK** to complete the entry of a new calculated field.</span></span>
9. <span data-ttu-id="29ea1-825">Na karcie **Mapowanie** wybierz opcję **model.Questionnaire.OrderedQuestions**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-825">On the **Mapping** tab, select **model.Questionnaire.OrderedQuestions**.</span></span>
10. <span data-ttu-id="29ea1-826">W drzewie formatu wybierz **Excel\\Kwestionariusz\\Pytanie**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-826">In the format tree, select **Excel\\Questionnaire\\Question**.</span></span>
11. <span data-ttu-id="29ea1-827">Wybierz opcję **Powiąż**, a następnie potwierdź, że bieżąca ścieżka **model.Questionnaire.Questions** jest zastępowana nową ścieżką **model.Questionnaire.OrderedQuestions** we wszystkich powiązaniach elementów zagnieżdżonych.</span><span class="sxs-lookup"><span data-stu-id="29ea1-827">Select **Bind**, and then confirm that the current **model.Questionnaire.Questions** path is replaced by the new **model.Questionnaire.OrderedQuestions** path in all bindings of nested elements.</span></span>
12. <span data-ttu-id="29ea1-828">Wybierz opcję **Zapisz**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-828">Select **Save**.</span></span>
...
### <a name="run-a-modified-format-from-er"></a><a name="RunFormatFromER2"></a><span data-ttu-id="29ea1-830">Uruchamianie zmodyfikowanego formatu od ER</span><span class="sxs-lookup"><span data-stu-id="29ea1-830">Run a modified format from ER</span></span>

<span data-ttu-id="29ea1-831">Możesz teraz uruchomić zmodyfikowany format do celów testowych ze środowiska ER.</span><span class="sxs-lookup"><span data-stu-id="29ea1-831">You can now run a modified format for testing purposes from the ER framework.</span></span>

1. <span data-ttu-id="29ea1-832">Na stronie **Projektant formatów** wybierz opcję **Uruchom**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-832">On the **Format designer** page, select **Run**.</span></span>
2. <span data-ttu-id="29ea1-833">W oknie dialogowym **Parametry ER**, na skróconej karcie **Rekordy do uwzględnienia**, skonfiguruj opcję filtrowania tak, aby uwzględniony był tylko kwestionariusz **SBCCrsExam**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-833">In the **ER parameters** dialog box, on the **Records to include** FastTab, configure the filtering option so that only the **SBCCrsExam** questionnaire is included.</span></span>
3. <span data-ttu-id="29ea1-834">Wybierz przycisk **OK**, aby filtrować opcje.</span><span class="sxs-lookup"><span data-stu-id="29ea1-834">Select **OK** to confirm the filtering option.</span></span>
4. <span data-ttu-id="29ea1-835">Wybierz przycisk **OK**, aby uruchomić raport.</span><span class="sxs-lookup"><span data-stu-id="29ea1-835">Select **OK** to run the report.</span></span>
5. <span data-ttu-id="29ea1-836">Przejrzyj wygenerowany raport.</span><span class="sxs-lookup"><span data-stu-id="29ea1-836">Review the generated report.</span></span>

<span data-ttu-id="29ea1-837">Poniższa ilustracja przedstawia wygenerowany raport w formacie Excel, w którym pytania są poprawnie uporządkowane.</span><span class="sxs-lookup"><span data-stu-id="29ea1-837">The following illustration shows a generated report in Excel format where the questions are correctly ordered.</span></span>

![Wygenerowany raport w formacie Excel z poprawnie uporządkowanymi pytaniami](./media/er-quick-start1-report2.png)

### <a name="complete-the-format-design"></a><a name="CompleteFormat"></a><span data-ttu-id="29ea1-839">Zakończ projektowanie formatu</span><span class="sxs-lookup"><span data-stu-id="29ea1-839">Complete the format design</span></span>

1. <span data-ttu-id="29ea1-840">Otwórz **Administracja organizacji** \> **Elektroniczne raportowanie** \> **Konfiguracje**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-840">Go to **Organization administration** \> **Electronic reporting** \> **Configurations**.</span></span>
2. <span data-ttu-id="29ea1-841">Na stronie **Konfiguracje** w drzewie konfiguracji w panelu po lewej wybierz pozycję **Model kwestionariusza**, a potem wybierz **Raport kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-841">On the **Configurations** page, in the configuration tree, expand **Questionnaire model**, and then select **Questionnaire report**.</span></span>
3. <span data-ttu-id="29ea1-842">Na skróconej karcie **wersje** szybkie wybierz wersję konfiguracji o stanie **Wersja robocza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-842">On the **Versions** FastTab, select the configuration version that has a status of **Draft**.</span></span>
4. <span data-ttu-id="29ea1-843">Wybierz **Zmień status** \> **Zakończone**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-843">Select **Change status** \> **Complete**.</span></span>

<span data-ttu-id="29ea1-844">Stan wersja 1.1 tej konfiguracji zostanie zmieniony z wersji **Roboczej** na **Ukończoną**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-844">The status of version 1.1 of this configuration is changed from **Draft** to **Completed**.</span></span> <span data-ttu-id="29ea1-845">Wersja 1.1 nie może być już zmieniana.</span><span class="sxs-lookup"><span data-stu-id="29ea1-845">Version 1.1 can no longer be changed.</span></span> <span data-ttu-id="29ea1-846">Ta wersja zawiera skonfigurowany format i może być używana do drukowania raportu niestandardowego.</span><span class="sxs-lookup"><span data-stu-id="29ea1-846">This version contains the configured format and can be used to print your custom report.</span></span> <span data-ttu-id="29ea1-847">Wersja 1.2 tej konfiguracji jest utworzona i ma stan **Wersja robocza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-847">Version 1.2 of this configuration is created and has a status of **Draft**.</span></span> <span data-ttu-id="29ea1-848">Tę wersję można edytować, aby skorygować format raportu **Kwestionariusz**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-848">You can edit this version to adjust the format of your **Questionnaire** report.</span></span>

![Wersje edytowalnej konfiguracji ER na stronie konfiguracje](./media/er-quick-start1-format-configuration.png)

> [!NOTE]
> <span data-ttu-id="29ea1-850">Skonfigurowany format to projekt raportu **Kwestionariusz** i nie zawiera żadnych relacji z artefaktami specyficznymi dla Finance.</span><span class="sxs-lookup"><span data-stu-id="29ea1-850">The configured format is your design of the **Questionnaire** report and contains no relations to the Finance-specific artefacts.</span></span>

## <a name="develop-application-artefacts-to-call-the-designed-report"></a><a name="DevelopCustomCode"></a><span data-ttu-id="29ea1-851">Opracowywanie Artefacts aplikacji w celu wywołania zaprojektowanego raportu</span><span class="sxs-lookup"><span data-stu-id="29ea1-851">Develop application artefacts to call the designed report</span></span>

<span data-ttu-id="29ea1-852">Jako użytkownik w roli administratora systemu musisz opracować nową logikę, tak aby skonfigurowany format ER mógł być wywoływany z interfejsu użytkownika aplikacji (UI) w celu wygenerowania raportu niestandardowego.</span><span class="sxs-lookup"><span data-stu-id="29ea1-852">As a user in the System Administrator role, you must develop new logic so that the configured ER format can be called from the application user interface (UI) to generate your custom report.</span></span> <span data-ttu-id="29ea1-853">Obecnie moduł ER nie oferuje żadnych możliwości konfigurowania tego typu logiki.</span><span class="sxs-lookup"><span data-stu-id="29ea1-853">Currently, ER doesn't offer any capability for configuring this type of logic.</span></span> <span data-ttu-id="29ea1-854">W związku z tym wymagane są pewne prace technologiczne.</span><span class="sxs-lookup"><span data-stu-id="29ea1-854">Therefore, some engineering work is required.</span></span> 

<span data-ttu-id="29ea1-855">Aby opracować nową logikę, należy wdrożyć topologię obsługującą ciągłe budowanie.</span><span class="sxs-lookup"><span data-stu-id="29ea1-855">To develop the new logic, you must deploy a topology that supports continuous build.</span></span> <span data-ttu-id="29ea1-856">Więcej informacji znajdziesz w [Wdrażanie topologii obsługujących ciągłą budowę i automatyzację testów](../perf-test/continuous-build-test-automation.md).</span><span class="sxs-lookup"><span data-stu-id="29ea1-856">For more information, see [Deploy topologies that support continuous build and test automation](../perf-test/continuous-build-test-automation.md).</span></span> <span data-ttu-id="29ea1-857">Ponadto musisz także mieć dostęp do środowiska programowania dla tej topologii.</span><span class="sxs-lookup"><span data-stu-id="29ea1-857">You must also have access to the development environment for this topology.</span></span> <span data-ttu-id="29ea1-858">Aby uzyskać więcej informacji na temat dostępnego interfejsu API ER, zapoznaj się z tematem [Interfejs API struktury modułu Raportowanie elektroniczne](er-apis-app73.md).</span><span class="sxs-lookup"><span data-stu-id="29ea1-858">For more information about the available ER API, see [ER framework API](er-apis-app73.md).</span></span>

### <a name="modify-source-code"></a><a name="ModifySourceCode"></a><span data-ttu-id="29ea1-859">Zmień kod źródłowy</span><span class="sxs-lookup"><span data-stu-id="29ea1-859">Modify source code</span></span>

#### <a name="add-a-data-contract-class"></a><a name="DataContractClass"></a><span data-ttu-id="29ea1-860">Dodawanie klasy kontraktu danych</span><span class="sxs-lookup"><span data-stu-id="29ea1-860">Add a data contract class</span></span>

<span data-ttu-id="29ea1-861">Dodaj nową klasę **QuestionnairesErReportContract** do projektu programu Microsoft Visual Studio i wpisz kod określający kontrakt danych, który ma być używany do uruchamiania skonfigurowanego formatu ER.</span><span class="sxs-lookup"><span data-stu-id="29ea1-861">Add the new **QuestionnairesErReportContract** class to your Microsoft Visual Studio project, and write code that specifies the data contract that should be used to run the configured ER format.</span></span>
...
#### <a name="add-a-ui-builder-class"></a><a name="UIBuilderClass"></a><span data-ttu-id="29ea1-862">Dodaj klasę konstruktora UI</span><span class="sxs-lookup"><span data-stu-id="29ea1-862">Add a UI builder class</span></span>

<span data-ttu-id="29ea1-863">Dodaj nową klasę **QuestionnairesErReportUIBuilder** do projektu Visual Studio i wpisz kod, aby wygenerować okno dialogowe środowiska uruchomieniowego, które będzie używane do wyszukiwania identyfikatora mapowania formatu ER, który musi zostać uruchomiony.</span><span class="sxs-lookup"><span data-stu-id="29ea1-863">Add the new **QuestionnairesErReportUIBuilder** class to your Visual Studio project, and write code to generate a runtime dialog box that will be used to look up the format mapping ID of the ER format that must be run.</span></span> <span data-ttu-id="29ea1-864">Podany kod wyszukuje tylko formaty ER, które zawierają źródło danych typu **modelu danych**, które odwołują się do modelu danych **[Kwestionariuszy](#DataModeName)** przy użyciu definicji **[głównej](#RootDefinitionName)**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-864">The provided code looks up only ER formats that contain a data source of the **Data model** type that refers to the **[Questionnaires](#DataModeName)** data model by using the **[Root](#RootDefinitionName)** definition.</span></span>

> [!NOTE]
> <span data-ttu-id="29ea1-865">Alternatywnie możesz użyć punktów integracji ER do filtrowania formatów ER.</span><span class="sxs-lookup"><span data-stu-id="29ea1-865">Alternatively, you can use ER integration points to filter ER formats.</span></span> <span data-ttu-id="29ea1-866">Aby uzyskać więcej informacji, zobacz [API, aby wyświetlić wyszukiwanie mapowania formatu](er-apis-app10-0-11.md#api-to-show-a-format-mapping-lookup).</span><span class="sxs-lookup"><span data-stu-id="29ea1-866">For more information, see [API to show a format mapping lookup](er-apis-app10-0-11.md#api-to-show-a-format-mapping-lookup).</span></span>
...
#### <a name="add-a-data-provider-class"></a><a name="DataProviderClass"></a><span data-ttu-id="29ea1-867">Dodawanie klasy dostawcy danych</span><span class="sxs-lookup"><span data-stu-id="29ea1-867">Add a data provider class</span></span>

<span data-ttu-id="29ea1-868">Dodaj nową klasę **QuestionnairesErReportDP** do projektu programu Microsoft Visual Studio i napisz kod wprowadzający dostawcę danych, który powinien być używany do uruchamiania skonfigurowanego formatu ER.</span><span class="sxs-lookup"><span data-stu-id="29ea1-868">Add the new **QuestionnairesErReportDP** class to your Visual Studio project, and write code that introduces the data provider that should used to run the configured ER format.</span></span> <span data-ttu-id="29ea1-869">Podany kod zawiera tylko umowę dotyczącą danych dla tego dostawcy danych.</span><span class="sxs-lookup"><span data-stu-id="29ea1-869">The provided code includes only the data contract for this data provider.</span></span>
...
#### <a name="add-a-labels-file"></a><a name="LabelsFile"></a><span data-ttu-id="29ea1-870">Dodaj plik etykiet</span><span class="sxs-lookup"><span data-stu-id="29ea1-870">Add a labels file</span></span>

<span data-ttu-id="29ea1-871">Dodaj nowy plik etykiet **QuestionnairesErReportLabels\_en-US** do projektu Visual Studio, a następnie określ następujące etykiety dla nowych zasobów interfejsu użytkownika:</span><span class="sxs-lookup"><span data-stu-id="29ea1-871">Add the new **QuestionnairesErReportLabels\_en-US** labels file to your Visual Studio project, and specify the following labels for new UI resources:</span></span>

- <span data-ttu-id="29ea1-872">Etykieta **\@QuestionnairesReport** dla nowego elementu menu, zawierająca następujący tekst w amerykańskiej odmianie języka angielskiego (en-US): **Raport z kwestionariuszy (zasilany przez ER)**</span><span class="sxs-lookup"><span data-stu-id="29ea1-872">The **\@QuestionnairesReport** label for a new menu item that contains the following text in US English (en-US): **Questionnaires report (powered by ER)**</span></span>
- <span data-ttu-id="29ea1-873">Etykieta **\@QuestionnairesReportBatchJobDescription** dla stanowiska wsadowego, jeśli wybrany format ER jest zaplanowany do wykonania jako zadanie wsadowe</span><span class="sxs-lookup"><span data-stu-id="29ea1-873">The **\@QuestionnairesReportBatchJobDescription** label for a batch job title if a selected ER format is scheduled for execution as a batch job</span></span>

#### <a name="add-a-report-service-class"></a><a name="ServiceClass"></a><span data-ttu-id="29ea1-874">Dodawanie klasy usługi raportowania</span><span class="sxs-lookup"><span data-stu-id="29ea1-874">Add a report service class</span></span>

<span data-ttu-id="29ea1-875">Dodaj nową klasę **QuestionnairesErReportService** do projektu Visual Studio i wpisz kod wywołujący format ER, identyfikując go za pomocą identyfikatora mapowania formatu i dostarcza kontrakt danych jako parametr.</span><span class="sxs-lookup"><span data-stu-id="29ea1-875">Add the new **QuestionnairesErReportService** class to your Visual Studio project, and write code that calls an ER format, identifies it by a format mapping ID, and provides a data contract as a parameter.</span></span>
...
<span data-ttu-id="29ea1-876">Jeśli musisz użyć formatu ER, który uruchamia dane aplikacji, musisz skonfigurować źródło danych typu **Model danych** w mapowaniu formatu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-876">When you must use an ER format that runs application data, you must configure a data source of the **Data model** type in the format mapping.</span></span> <span data-ttu-id="29ea1-877">To źródło danych odwołuje się do określonej części określonego modelu danych za pomocą jednej definicji głównej.</span><span class="sxs-lookup"><span data-stu-id="29ea1-877">This data source refers to a specific part of the specified data model by using a single root definition.</span></span> <span data-ttu-id="29ea1-878">Po uruchomieniu formatu ER, wywołuje to źródło danych w celu uzyskania dostępu do odpowiedniego mapowania modelu ER skonfigurowanego dla danego modelu i definicji katalogu głównego.</span><span class="sxs-lookup"><span data-stu-id="29ea1-878">When the ER format is run, it calls this data source to access the appropriate ER model mapping that is configured for a given model and root definition.</span></span>

<span data-ttu-id="29ea1-879">Wszystkie informacje, które można przygotować w kodzie źródłowym i przechowywać w ramach kontraktu danych, można przekazać do działającego formatu ER przy użyciu mapowania modelu ER tego typu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-879">All the information that you might prepare in the source code and store as part of the data contract can be passed to the running ER format by using an ER model mapping of this type.</span></span> <span data-ttu-id="29ea1-880">W mapowaniu modelu ER należy skonfigurować źródło danych typu **Obiektu**, który odwołuje się do klasy **[QuestionnairesErReportContract](#DataContractClass)**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-880">In the ER model mapping, you must configure a data source of the **Object** type that refers to the **[QuestionnairesErReportContract](#DataContractClass)** class.</span></span> <span data-ttu-id="29ea1-881">Informacje, które można przygotować w kodzie źródłowym i dane w ramach kontraktu, można do działającego formatu ER przy użyciu mapowania modelu ER tego typu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-881">To identify a model mapping, you must specify a data source that calls this model mapping.</span></span> <span data-ttu-id="29ea1-882">W podanym kodzie to źródło danych określone przez stałą **ERModelDataSourceName**, która ma wartość **[modelu](#ModelDSName)**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-882">In the provided code, this data source specified by the **ERModelDataSourceName** constant that has the **[model](#ModelDSName)** value.</span></span> <span data-ttu-id="29ea1-883">Aby określić, które źródło danych jest używane do ujawnienia kontraktu danych w mapowaniu modeli, należy określić nazwę źródła danych.</span><span class="sxs-lookup"><span data-stu-id="29ea1-883">To identify which data source is used to expose the data contract in the model mapping, you must specify a data source name.</span></span> <span data-ttu-id="29ea1-884">W podanym kodzie ta nazwa jest określona przez stałą **ParametersDataSourceName**, która ma wartość <a name="DataContractDSName"></a>**RunTimeParameters**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-884">In the provided code, this name is specified by the **ParametersDataSourceName** constant that has <a name="DataContractDSName"></a>**RunTimeParameters** value.</span></span>

> [!NOTE]
> <span data-ttu-id="29ea1-885">W nowym środowisku może być konieczne odświeżenie metadanych ER, aby ten typ klasy był dostępny w projektancie mapowania modelu ER.</span><span class="sxs-lookup"><span data-stu-id="29ea1-885">In a new environment, you might have to refresh the ER metadata so that this type of class is available in the ER model mapping designer.</span></span> <span data-ttu-id="29ea1-886">Aby uzyskać więcej informacji, zobacz [Konfigurowanie struktury ER](electronic-reporting-er-configure-parameters.md#frequently-asked-questions).</span><span class="sxs-lookup"><span data-stu-id="29ea1-886">For more information, see [Configure the ER framework](electronic-reporting-er-configure-parameters.md#frequently-asked-questions).</span></span>

#### <a name="add-a-report-controller-class"></a><a name="ControllerClass"></a><span data-ttu-id="29ea1-887">Dodawanie klasy kontrolera raportowania</span><span class="sxs-lookup"><span data-stu-id="29ea1-887">Add a report controller class</span></span>

<span data-ttu-id="29ea1-888">Dodaj nową klasę **QuestionnairesErReportController** do projektu Visual Studio i wpisz kod uruchamiający format ER w trybie synchronicznym lub wsadowym, w zależności od preferowanego sposobu w oknie dialogowym, które jest oparte na logice dostarczonej klasy **QuestionnairesErReportUIBuilder**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-888">Add the new **QuestionnairesErReportController** class to your Visual Studio project, and write code that runs an ER format in either synchronous mode or batch mode, as you prefer, in the dialog box that is built based on the logic of the provided **QuestionnairesErReportUIBuilder** class.</span></span>
...
#### <a name="add-a-menu-item"></a><a name="MenuItem"></a><span data-ttu-id="29ea1-889">Dodaj element menu</span><span class="sxs-lookup"><span data-stu-id="29ea1-889">Add a menu item</span></span>

<span data-ttu-id="29ea1-890">Dodaj nowy element menu **QuestionnairesErReport** do projektu Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="29ea1-890">Add the new **QuestionnairesErReport** menu item to your Visual Studio project.</span></span> <span data-ttu-id="29ea1-891">We właściwości **Obiektu** ten element menu odwołuje się do klasy **QuestionnairesErReportController** i jest używany do określania uprawnień użytkownika do wybierania i uruchamiania formatu ER.</span><span class="sxs-lookup"><span data-stu-id="29ea1-891">In the **Object** property, this menu item refers to the **QuestionnairesErReportController** class, and it's used to specify a user permission to select and run an ER format.</span></span> <span data-ttu-id="29ea1-892">We właściwości **Etykieta** ten element menu odwołuje się do etykiety **\@QuestionnairesReport** utworzonej wcześniej, dzięki czemu w interfejsie aplikacji jest wyświetlany poprawny tekst.</span><span class="sxs-lookup"><span data-stu-id="29ea1-892">In the **Label** property, this menu item refers to the **\@QuestionnairesReport** label that you created earlier, so that correct text is presented in the application UI.</span></span>

#### <a name="add-a-menu-item-to-a-menu"></a><a name="Menu"></a><span data-ttu-id="29ea1-893">Dodawanie elementu menu do menu</span><span class="sxs-lookup"><span data-stu-id="29ea1-893">Add a menu item to a menu</span></span>

<span data-ttu-id="29ea1-894">Dodaj istniejące menu **KM** do projektu Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="29ea1-894">Add the existing **KM** menu to your Visual Studio project.</span></span> <span data-ttu-id="29ea1-895">Do tego menu należy dodać nowy element **QuestionnairesErReport** typu **Dane wyjściowe**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-895">You must add a new **QuestionnairesErReport** item of the **Output** type to this menu.</span></span> <span data-ttu-id="29ea1-896">Ten element musi odwoływać się do elementu menu **QuestionnairesErReport** opisanego w poprzedniej sekcji.</span><span class="sxs-lookup"><span data-stu-id="29ea1-896">This item must refer to the **QuestionnairesErReport** menu item that is described in the previous section.</span></span>

#### <a name="build-a-visual-studio-project"></a><a name="BuildVSProject"></a><span data-ttu-id="29ea1-897">Budowanie projektu Visual Studio</span><span class="sxs-lookup"><span data-stu-id="29ea1-897">Build a Visual Studio project</span></span>

<span data-ttu-id="29ea1-898">Umożliwia utworzenie projektu w celu udostępnienia nowego elementu menu użytkownikom.</span><span class="sxs-lookup"><span data-stu-id="29ea1-898">Build your project to make a new menu item available to users.</span></span>

### <a name="run-a-format-from-the-application"></a><a name="RunFormatFromApp"></a><span data-ttu-id="29ea1-899">Umożliwia uruchomienie formatu z aplikacji</span><span class="sxs-lookup"><span data-stu-id="29ea1-899">Run a format from the application</span></span>

1. <span data-ttu-id="29ea1-900">Przejdź do **Kwestionariusz** \> **Projektowanie** \> **Raport z kwestionariuszy (zasilany przez ER)**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-900">Go to **Questionnaire** \> **Design** \> **Questionnaires report (powered by ER)**.</span></span>
...
2. <span data-ttu-id="29ea1-902">W oknie dialogowym w polu **Mapowanie formatu** wybierz opcję **Raport kwestionariuszy**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-902">In the dialog box, in the **Format mapping** field, select **Questionnaires report**.</span></span>
3. <span data-ttu-id="29ea1-903">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-903">Select **OK**.</span></span>
...
5. <span data-ttu-id="29ea1-905">Wybierz przycisk **OK**, aby filtrować opcje.</span><span class="sxs-lookup"><span data-stu-id="29ea1-905">Select **OK** to confirm the filtering option.</span></span>
6. <span data-ttu-id="29ea1-906">Wybierz przycisk **OK**, aby uruchomić raport.</span><span class="sxs-lookup"><span data-stu-id="29ea1-906">Select **OK** to run the report.</span></span>

    ![Określenie kryteriów wyboru w oknie dialogowym Raport elektroniczny](./media/er-quick-start1-report-run-dialog-page.png)

7. <span data-ttu-id="29ea1-908">Przejrzyj wygenerowany raport.</span><span class="sxs-lookup"><span data-stu-id="29ea1-908">Review the generated report.</span></span>

## <a name="tune-a-designed-er-solution"></a><a name="TuneSolution"></a><span data-ttu-id="29ea1-909">Dostrajanie zaprojektowanego rozwiązania ER</span><span class="sxs-lookup"><span data-stu-id="29ea1-909">Tune a designed ER solution</span></span>

<span data-ttu-id="29ea1-910">Skonfigurowane rozwiązanie ER można zmodyfikować tak, aby korzystało z utworzonej przez siebie klasy dostawcy danych w celu uzyskania dostępu do szczegółów działającego formatu ER i wprowadzało nazwę tego formatu ER w wygenerowanym raporcie.</span><span class="sxs-lookup"><span data-stu-id="29ea1-910">You can modify the configured ER solution so that it uses the data provider class that you developed to access details of the running ER format, and so that it enters the name of this ER format in a generated report.</span></span>

### <a name="modify-a-model-mapping"></a><a name="ModifyModelMapping"></a><span data-ttu-id="29ea1-911">Modyfikowanie mapowania modelu</span><span class="sxs-lookup"><span data-stu-id="29ea1-911">Modify a model mapping</span></span>

#### <a name="add-data-sources-to-access-a-data-contract-object"></a><a name="AddDataSource1"></a><span data-ttu-id="29ea1-912">Dodaj źródła danych, aby uzyskać dostęp do obiektu kontraktu danych</span><span class="sxs-lookup"><span data-stu-id="29ea1-912">Add data sources to access a data contract object</span></span>

1. <span data-ttu-id="29ea1-913">Otwórz **Administracja organizacji** \> **Elektroniczne raportowanie** \> **Konfiguracje**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-913">Go to **Organization administration** \> **Electronic reporting** \> **Configurations**.</span></span>
2. <span data-ttu-id="29ea1-914">Na stronie **Konfiguracje** w drzewie konfiguracji w panelu po lewej wybierz pozycję **Model kwestionariusza**, a potem wybierz **Mapowanie kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-914">On the **Configurations** page, in the configuration tree, expand **Questionnaire model**, and then select **Questionnaire mapping**.</span></span>
3. <span data-ttu-id="29ea1-915">Wybierz opcję **Projektant**, aby otworzyć stronę **Modelowanie do mapowania źródła danych**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-915">Select **Designer** to open the **Model to datasource mapping** page.</span></span>
4. <span data-ttu-id="29ea1-916">Wybierz opcję **Projektant**, aby otworzyć wybrane mapowanie w konstruktorze mapowania modeli.</span><span class="sxs-lookup"><span data-stu-id="29ea1-916">Select **Designer** to open the selected mapping in the model mapping designer.</span></span>
5. <span data-ttu-id="29ea1-917">Na stronie **Projektant mapowania modelu** w okienku **Typy źródła danych** wybierz pozycję **Dynamics 365 for Operations\\Objekt**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-917">On the **Model mapping designer** page, in the **Data source types** pane, select **Dynamics 365 for Operations\\Object**.</span></span>
6. <span data-ttu-id="29ea1-918">W okienku **Źródła danych** wybierz **Dodaj źródło**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-918">In the **Data sources** pane, select **Add root**.</span></span>
7. <span data-ttu-id="29ea1-919">W oknie dialogowym w polu **Nazwa** wprowadź **[RunTimeParameters](#DataContractDSName)**, zgodnie z definicją w kodzie źródłowym klasy **QuestionnairesErReportService**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-919">In the dialog box, in the **Name** field, enter **[RunTimeParameters](#DataContractDSName)**, as defined in the source code of the **QuestionnairesErReportService** class.</span></span>
8. <span data-ttu-id="29ea1-920">W polu **Klasa** wprowadź **[QuestionnairesErReportContract](#DataContractClass)**, który został wcześniej zakodowany.</span><span class="sxs-lookup"><span data-stu-id="29ea1-920">In the **Class** field, enter **[QuestionnairesErReportContract](#DataContractClass)**, which was coded earlier.</span></span>
9. <span data-ttu-id="29ea1-921">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-921">Select **OK**.</span></span>
10. <span data-ttu-id="29ea1-922">Rozwiń **RunTimeParameters**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-922">Expand **RunTimeParameters**.</span></span>

<span data-ttu-id="29ea1-923">Dodane źródło danych zawiera informacje o identyfikatorze rekordu działającego mapowania formatu ER.</span><span class="sxs-lookup"><span data-stu-id="29ea1-923">The added data source provides information about the record ID of the running ER format mapping.</span></span>

![Dodano źródło danych w konstruktorze mapowania modelu ER](./media/er-quick-start1-mapping3.png)

#### <a name="add-a-data-source-to-access-er-format-mapping-records"></a><a name="AddDataSource2"></a><span data-ttu-id="29ea1-925">Dodaj źródło danych, aby uzyskać dostęp do rekordów mapowania formatu ER</span><span class="sxs-lookup"><span data-stu-id="29ea1-925">Add a data source to access ER format mapping records</span></span>

<span data-ttu-id="29ea1-926">Kontynuuj edycję wybranego mapowania modelu, dodając źródło danych w celu uzyskania dostępu do rekordów mapowania formatu ER.</span><span class="sxs-lookup"><span data-stu-id="29ea1-926">Continue to edit the selected model mapping by adding a data source to access ER format mapping records.</span></span>

1. <span data-ttu-id="29ea1-927">Na stronie **Projektant mapowania modelu** w okienku **Typy źródła danych** wybierz pozycję **Dynamics 365 for Operations\\Rekordy tabeli**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-927">On the **Model mapping designer** page, in the **Data source types** pane, select **Dynamics 365 for Operations\\Table records**.</span></span>
2. <span data-ttu-id="29ea1-928">W okienku **Źródła danych** wybierz **Dodaj źródło**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-928">In the **Data sources** pane, select **Add root**.</span></span>
3. <span data-ttu-id="29ea1-929">W oknie dialogowym rozwijanym w polu **Nazwa** wprowadź **ER1**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-929">In the dialog box, in the **Name** field, enter **ER1**.</span></span>
4. <span data-ttu-id="29ea1-930">W polu **Tabela** wprowadź **ERFormatMappingTable**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-930">In the **Table** field, enter **ERFormatMappingTable**.</span></span>
5. <span data-ttu-id="29ea1-931">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-931">Select **OK**.</span></span>

#### <a name="add-a-data-source-to-access-a-format-mapping-record-of-a-running-er-format"></a><a name="AddDataSource3"></a><span data-ttu-id="29ea1-932">Dodaj źródło danych, aby uzyskać dostęp do rekordu mapowania formatu działającego formatu ER</span><span class="sxs-lookup"><span data-stu-id="29ea1-932">Add a data source to access a format mapping record of a running ER format</span></span>

<span data-ttu-id="29ea1-933">Kontynuuj edycję wybranego mapowania modelu, dodając źródło danych, aby uzyskać dostęp do rekordu mapowania formatu działającego formatu ER.</span><span class="sxs-lookup"><span data-stu-id="29ea1-933">Continue to edit the selected model mapping by adding a data source to access the format mapping record of the running ER format.</span></span>

1. <span data-ttu-id="29ea1-934">Na stronie **Projektant mapowania modelu** w okienku **Typy źródła danych** wybierz **Funkcje\\Pole obliczeniowe**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-934">On the **Model mapping designer** page, in the **Data source types** pane, select **Functions\\Calculated field**.</span></span>
2. <span data-ttu-id="29ea1-935">W okienku **Źródła danych** wybierz **Dodaj źródło**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-935">In the **Data sources** pane, select **Add root**.</span></span>
3. <span data-ttu-id="29ea1-936">W oknie dialogowym rozwijanym w polu **Nazwa** wprowadź **ER2**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-936">In the dialog box, in the **Name** field, enter **ER2**.</span></span>
4. <span data-ttu-id="29ea1-937">Wybierz opcję **Edytuj formułę**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-937">Select **Edit formula**.</span></span>
5. <span data-ttu-id="29ea1-938">W edytorze formuł w polu **Formuła** wprowadź **FIRSTORNULL (FILTER(ER1, ER1.RecId = RunTimeParameters.parmFormatMapping))**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-938">In the formula editor, in the **Formula** field, enter **FIRSTORNULL (FILTER(ER1, ER1.RecId = RunTimeParameters.parmFormatMapping))**.</span></span>
6. <span data-ttu-id="29ea1-939">Wybierz przycisk **Zapisz** i zamknij edytor formuł.</span><span class="sxs-lookup"><span data-stu-id="29ea1-939">Select **Save**, and close the formula editor.</span></span>
7. <span data-ttu-id="29ea1-940">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-940">Select **OK**.</span></span>

#### <a name="enter-the-name-of-the-running-er-format-in-the-data-model"></a><a name="AddBinding"></a><span data-ttu-id="29ea1-941">Umożliwia wprowadzenie nazwy uruchomionego formatu ER w modelu danych</span><span class="sxs-lookup"><span data-stu-id="29ea1-941">Enter the name of the running ER format in the data model</span></span>

<span data-ttu-id="29ea1-942">Kontynuuj edytowanie wybranego mapowania modelu, tak aby nazwa uruchomionego formatu ER była wprowadzana w modelu danych.</span><span class="sxs-lookup"><span data-stu-id="29ea1-942">Continue to edit the selected model mapping so that the name of the running ER format is entered in the data model.</span></span>

1. <span data-ttu-id="29ea1-943">Na stronie **Projektant mapowania modelu** w okienku **Model danych** rozwiń **ExecutionContext**, a następnie wybierz **ExecutionContext\\FormatName**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-943">On the **Model mapping designer** page, in the **Data model** pane, expand **ExecutionContext**, and then select **ExecutionContext\\FormatName**.</span></span>
2. <span data-ttu-id="29ea1-944">W okienku **Model danych** wybierz opcję **Edytuj**, aby skonfigurować powiązanie danych dla pola wybranego modelu danych.</span><span class="sxs-lookup"><span data-stu-id="29ea1-944">In the **Data model** pane, select **Edit** to configure a data binding for the selected data model's field.</span></span>
3. <span data-ttu-id="29ea1-945">W edytorze formuł w polu **Formuła** wprowadź **FIRSTORNULL (ER2.'\>Relations'.Format).Name**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-945">In the formula editor, in the **Formula** field, enter **FIRSTORNULL (ER2.'\>Relations'.Format).Name**.</span></span>
4. <span data-ttu-id="29ea1-946">Wybierz przycisk **Zapisz** i zamknij edytor formuł.</span><span class="sxs-lookup"><span data-stu-id="29ea1-946">Select **Save**, and close the formula editor.</span></span>

<span data-ttu-id="29ea1-947">Ponieważ użyto pola **FormatName**, skonfigurowane mapowanie modelu ujawnia teraz nazwę formatu ER, który wywołuje to mapowanie modelu podczas wykonywania.</span><span class="sxs-lookup"><span data-stu-id="29ea1-947">Because you used the **FormatName** field, the configured model mapping now exposes the name of an ER format that calls this model mapping during execution.</span></span>
...
#### <a name="complete-the-design-of-the-model-mapping"></a><a name="CompleteModelMapping2"></a><span data-ttu-id="29ea1-949">Umożliwia zakończenie projektu mapowania modelu</span><span class="sxs-lookup"><span data-stu-id="29ea1-949">Complete the design of the model mapping</span></span>

1. <span data-ttu-id="29ea1-950">Na stronie **Projektant mapowania modelu** wybierz opcję **Zapisz**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-950">On the **Model mapping designer** page, select **Save**.</span></span>
2. <span data-ttu-id="29ea1-951">Zamknij stronę.</span><span class="sxs-lookup"><span data-stu-id="29ea1-951">Close the page.</span></span>
3. <span data-ttu-id="29ea1-952">Zamknij stronę mapowania modelu.</span><span class="sxs-lookup"><span data-stu-id="29ea1-952">Close the model mappings page.</span></span>
4. <span data-ttu-id="29ea1-953">Na stronie **Konfiguracje** w drzewie konfiguracji upewnij się, że wybrana została konfiguracja **Mapowania kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-953">On the **Configurations** page, in the configuration tree, make sure that the **Questionnaire mapping** configuration is still selected.</span></span> <span data-ttu-id="29ea1-954">Następnie na skróconej karcie **wersje** szybkie wybierz wersję konfiguracji o stanie **Wersja robocza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-954">Then, on the **Versions** FastTab, select the configuration version that has a status of **Draft**.</span></span>
5. <span data-ttu-id="29ea1-955">Wybierz **Zmień status** \> **Zakończone**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-955">Select **Change status** \> **Complete**.</span></span>

<span data-ttu-id="29ea1-956">Stan wersja 1.2 tej konfiguracji zostanie zmieniony z wersji **Roboczej** na **Ukończoną**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-956">The status of version 1.2 of this configuration is changed from **Draft** to **Completed**.</span></span> <span data-ttu-id="29ea1-957">Wersja 1.2 nie może być już zmieniana.</span><span class="sxs-lookup"><span data-stu-id="29ea1-957">Version 1.2 can no longer be changed.</span></span> <span data-ttu-id="29ea1-958">Ta wersja zawiera skonfigurowany model mapowania i może być używana jako podstawa dla innych konfiguracji ER.</span><span class="sxs-lookup"><span data-stu-id="29ea1-958">This version contains the configured model mapping and can be used as the basis for other ER configurations.</span></span> <span data-ttu-id="29ea1-959">Wersja 1.3 tej konfiguracji jest utworzona i ma stan **Wersja robocza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-959">Version 1.3 of this configuration is created and has a status of **Draft**.</span></span> <span data-ttu-id="29ea1-960">Tę wersję można edytować, aby skorygować model mapowania **Kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-960">You can edit this version to adjust the **Questionnaire** model mapping.</span></span>

### <a name="modify-a-format"></a><a name="ModifyFormat"></a><span data-ttu-id="29ea1-961">Modyfikowanie formatu</span><span class="sxs-lookup"><span data-stu-id="29ea1-961">Modify a format</span></span>

<span data-ttu-id="29ea1-962">Skonfigurowany format ER można zmodyfikować, tak aby jego nazwa była wyświetlana w stopce raportu generowanego po uruchomieniu formatu ER.</span><span class="sxs-lookup"><span data-stu-id="29ea1-962">You can modify the configured ER format so that its name is shown in the footer of a report that is generated when the ER format is run.</span></span>

#### <a name="add-a-new-format-element"></a><a name="AddFormatElement"></a><span data-ttu-id="29ea1-963">Dodaj nowy element formatu</span><span class="sxs-lookup"><span data-stu-id="29ea1-963">Add a new format element</span></span>

1. <span data-ttu-id="29ea1-964">Otwórz **Administracja organizacji** \> **Elektroniczne raportowanie** \> **Konfiguracje**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-964">Go to **Organization administration** \> **Electronic reporting** \> **Configurations**.</span></span>
2. <span data-ttu-id="29ea1-965">Na stronie **Konfiguracje** w drzewie konfiguracji w panelu po lewej wybierz pozycję **Model kwestionariusza**, a potem wybierz **Raport kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-965">On the **Configurations** page, in the configuration tree, expand **Questionnaire model**, and then select **Questionnaire report**.</span></span>
3. <span data-ttu-id="29ea1-966">Wybierz opcję **Konstruktor**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-966">Select **Designer**.</span></span>
4. <span data-ttu-id="29ea1-967">Na stronie **Projektant formatów** wybierz element główny **Raport**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-967">On the **Format designer** page, select the **Report** root item.</span></span>
5. <span data-ttu-id="29ea1-968">Wybierz przycisk **Dodaj**, aby dodać nowy element formatu zagnieżdżonego dla wybranego elementu głównego **Raportu**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-968">Select **Add** to add a new nested format element for the selected **Report** root item.</span></span>
6. <span data-ttu-id="29ea1-969">Wybierz **Excel\\Stopka**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-969">Select **Excel\\Footer**.</span></span>
7. <span data-ttu-id="29ea1-970">W polu **Nazwa** wprowadź nazwę **Stopka**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-970">In the **Name** field, enter **Footer**.</span></span>
8. <span data-ttu-id="29ea1-971">Wybierz opcję **Raport\Stopka**, a następnie wybierz **Dodaj**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-971">Select **Report\Footer**, and then select **Add**.</span></span>
9. <span data-ttu-id="29ea1-972">Wybierz **Tekst\\Ciąg**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-972">Select **Text\\String**.</span></span>

#### <a name="bind-the-added-format-element"></a><a name="BindAddedFormatElement"></a><span data-ttu-id="29ea1-973">Powiąż dodany element formatu</span><span class="sxs-lookup"><span data-stu-id="29ea1-973">Bind the added format element</span></span>

1. <span data-ttu-id="29ea1-974">Na stronie **Projektant formatów** na karcie **Mapowanie** w drzewie formatu dla aktywnego elementu **Stopka\\Ciąg** wybierz **Edytuj formułę**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-974">On the **Format designer** page, on the **Mapping** tab, in the format tree, for the active **Footer\\String** element, select **Edit formula**.</span></span>
2. <span data-ttu-id="29ea1-975">W edytorze formuł, w polu **Formuła** wprowadź **CONCATENATE ("\&C\&10", FORMAT("Generated by'\%1' ER solution", model.ExecutionContext.FormatName))**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-975">In the formula editor, in the **Formula** field, enter **CONCATENATE ("\&C\&10", FORMAT("Generated by'\%1' ER solution", model.ExecutionContext.FormatName))**.</span></span>
3. <span data-ttu-id="29ea1-976">Wybierz przycisk **Zapisz** i zamknij edytor formuł.</span><span class="sxs-lookup"><span data-stu-id="29ea1-976">Select **Save**, and close the formula editor.</span></span>
4. <span data-ttu-id="29ea1-977">Wybierz opcję **Zapisz**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-977">Select **Save**.</span></span>

<span data-ttu-id="29ea1-978">Skonfigurowany format został zmodyfikowany, tak aby jego nazwa była wprowadzana do stopki wygenerowanego raportu przy użyciu elementu **Stopka\\Ciąg**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-978">The configured format has now been modified so that its name will be entered in the footer of a generated report by using the **Footer\\String** element.</span></span>
...
#### <a name="complete-the-format-design"></a><a name="CompleteFormat2"></a><span data-ttu-id="29ea1-980">Zakończ projektowanie formatu</span><span class="sxs-lookup"><span data-stu-id="29ea1-980">Complete the format design</span></span>

1. <span data-ttu-id="29ea1-981">Zamknij stronę **Projektowanie formuły**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-981">Close the **Format designer** page.</span></span>
2. <span data-ttu-id="29ea1-982">Na stronie **Konfiguracje** w drzewie konfiguracji upewnij się, że wybrana została konfiguracja **Raport kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-982">On the **Configurations** page, in the configuration tree, make sure that the **Questionnaire report** configuration is still selected.</span></span> <span data-ttu-id="29ea1-983">Następnie na skróconej karcie **wersje** szybkie wybierz wersję konfiguracji o stanie **Wersja robocza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-983">Then, on the **Versions** FastTab, select the configuration version that has a status of **Draft**.</span></span>
3. <span data-ttu-id="29ea1-984">Wybierz **Zmień status** \> **Zakończone**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-984">Select **Change status** \> **Complete**.</span></span>

<span data-ttu-id="29ea1-985">Stan wersja 1.2 tej konfiguracji zostanie zmieniony z wersji **Roboczej** na **Ukończoną**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-985">The status of version 1.2 of this configuration is changed from **Draft** to **Completed**.</span></span> <span data-ttu-id="29ea1-986">Wersja 1.2 nie może być już zmieniana.</span><span class="sxs-lookup"><span data-stu-id="29ea1-986">Version 1.2 can no longer be changed.</span></span> <span data-ttu-id="29ea1-987">Ta wersja zawiera skonfigurowany format i może być używana jako podstawa dla innych konfiguracji ER.</span><span class="sxs-lookup"><span data-stu-id="29ea1-987">This version contains the configured format and can be used as the basis for other ER configurations.</span></span> <span data-ttu-id="29ea1-988">Wersja 1.3 tej konfiguracji jest utworzona i ma stan **Wersja robocza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-988">Version 1.3 of this configuration is created and has a status of **Draft**.</span></span> <span data-ttu-id="29ea1-989">Tę wersję można edytować, aby skorygować raport **Kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-989">You can edit this version to adjust the **Questionnaire** report.</span></span>

### <a name="run-a-format-from-the-application"></a><a name="RunFormatFromApp2"></a><span data-ttu-id="29ea1-990">Umożliwia uruchomienie formatu z aplikacji</span><span class="sxs-lookup"><span data-stu-id="29ea1-990">Run a format from the application</span></span>

1. <span data-ttu-id="29ea1-991">Przejdź do **Kwestionariusz** \> **Projektowanie** \> **Raport z kwestionariuszy (zasilany przez ER)**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-991">Go to **Questionnaire** \> **Design** \> **Questionnaires report (powered by ER)**.</span></span>
2. <span data-ttu-id="29ea1-992">W oknie dialogowym w polu **Mapowanie formatu** wybierz opcję **Raport kwestionariuszy**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-992">In the dialog box, in the **Format mapping** field, select **Questionnaires report**.</span></span>
3. <span data-ttu-id="29ea1-993">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-993">Select **OK**.</span></span>
4. <span data-ttu-id="29ea1-994">W oknie dialogowym **Parametry ER**, na skróconej karcie **Rekordy do uwzględnienia**, skonfiguruj opcję filtrowania tak, aby uwzględniony był tylko kwestionariusz **SBCCrsExam**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-994">In the **ER parameters** dialog box, on the **Records to include** FastTab, configure the filtering option so that only the **SBCCrsExam** questionnaire is included.</span></span>
5. <span data-ttu-id="29ea1-995">Wybierz przycisk **OK**, aby filtrować opcje.</span><span class="sxs-lookup"><span data-stu-id="29ea1-995">Select **OK** to confirm the filtering option.</span></span>
6. <span data-ttu-id="29ea1-996">Wybierz przycisk **OK**, aby uruchomić raport.</span><span class="sxs-lookup"><span data-stu-id="29ea1-996">Select **OK** to run the report.</span></span>
7. <span data-ttu-id="29ea1-997">Przejrzyj wygenerowany raport w formacie Excel.</span><span class="sxs-lookup"><span data-stu-id="29ea1-997">Review the generated report in Excel format.</span></span>

<span data-ttu-id="29ea1-998">Należy zauważyć, że stopka wygenerowanego raportu zawiera nazwę formatu ER użytego do jego wygenerowania.</span><span class="sxs-lookup"><span data-stu-id="29ea1-998">Notice that the footer of the generated report contains the name of the ER format that was used to generate it.</span></span>

![Wygenerowany raport w formacie Excel](./media/er-quick-start1-report4.png)

### <a name="run-a-format-from-er"></a><a name="RunFormatFromER3"></a><span data-ttu-id="29ea1-1000">Uruchamianie formatu od ER</span><span class="sxs-lookup"><span data-stu-id="29ea1-1000">Run a format from ER</span></span>

1. <span data-ttu-id="29ea1-1001">Otwórz **Administracja organizacji** \> **Elektroniczne raportowanie** \> **Konfiguracje**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1001">Go to **Organization administration** \> **Electronic reporting** \> **Configurations**.</span></span>
2. <span data-ttu-id="29ea1-1002">Na stronie **Konfiguracje** w drzewie konfiguracji w panelu po lewej wybierz pozycję **Model kwestionariusza**, a potem wybierz **Raport kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1002">On the **Configurations** page, in the configuration tree, expand **Questionnaire model**, and then select **Questionnaire report**.</span></span>
3. <span data-ttu-id="29ea1-1003">W okienku akcji wybierz opcję **Uruchom**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1003">On the Action Pane, select **Run**.</span></span>
4. <span data-ttu-id="29ea1-1004">W oknie dialogowym **Parametry raportu elektronicznego**, na skróconej karcie **Rekordy do uwzględnienia**, skonfiguruj opcję filtrowania tak, aby uwzględniony był tylko kwestionariusz **SBCCrsExam**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1004">In the **Electronic report parameters** dialog box, on the **Records to include** FastTab, configure the filtering option so that only the **SBCCrsExam** questionnaire is included.</span></span>
5. <span data-ttu-id="29ea1-1005">Wybierz przycisk **OK**, aby filtrować opcje.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1005">Select **OK** to confirm the filtering option.</span></span>
6. <span data-ttu-id="29ea1-1006">Wybierz przycisk **OK**, aby uruchomić raport.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1006">Select **OK** to run the report.</span></span>
7. <span data-ttu-id="29ea1-1007">Przejrzyj wygenerowany raport w formacie Excel.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1007">Review the generated report in Excel format.</span></span>

<span data-ttu-id="29ea1-1008">Zwróć uwagę, że stopka wygenerowanego raportu nie zawiera nazwy formatu ER, który został użyty do jego wygenerowania, ponieważ obiekt kontraktu danych nie został przekazany do uruchomionego mapowania modelu, gdy został wywołany przez format ER, który został uruchomiony z ER.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1008">Notice that the footer of the generated report doesn't contain the name of ER format that was used to generate it, because the data contract object wasn't passed to the running model mapping when it was called by the ER format that was run from ER.</span></span>

### <a name="configure-a-format-destination-for-on-screen-preview"></a><a name="ConfigureDestination"></a><span data-ttu-id="29ea1-1009">Skonfiguruj miejsce docelowe formatu dla podglądu na ekranie</span><span class="sxs-lookup"><span data-stu-id="29ea1-1009">Configure a format destination for on-screen preview</span></span>

1. <span data-ttu-id="29ea1-1010">Wybierz kolejno opcje **Administrowanie organizacją** \> **Raportowanie elektroniczne** \> **Aplikacja docelowa raportowania elektronicznego**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1010">Go to **Organization administration** \> **Electronic reporting** \> **Electronic reporting destination**.</span></span>
2. <span data-ttu-id="29ea1-1011">Na stronie **Aplikacja docelowa raportowania elektronicznego** dodaj rekord docelowy dla skonfigurowanego formatu ER **Raport kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1011">On the **Electronic reporting destination** page, add a destination record for the configured **Questionnaire report** ER format.</span></span>
3. <span data-ttu-id="29ea1-1012">Na skróconej karcie **Lokalizacji docelowej pliku** skonfiguruj **Ekran**, czyli [miejsce docelowe](er-destination-type-screen.md), dla składnika formatu **Raportu**, który został [dodany](#AddFormatRootElement) jako element główny skonfigurowanego formatu ER **Raportu kwestionariusza**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1012">On the **File destination** FastTab, set up the **Screen** [destination](er-destination-type-screen.md) for the **Report** format component that has been [added](#AddFormatRootElement) as the root element of the configured **Questionnaire report** ER format.</span></span>
4. <span data-ttu-id="29ea1-1013">Na skróconej karcie **Ustawienia konwersji PDF** skonfiguruj lokalizację docelową w celu przekonwertowania raportu na [format PDF](electronic-reporting-destinations.md#OutputConversionToPDF), w którym jest używana **Pozioma** orientacja strony.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1013">On the **PDF conversion settings** FastTab, configure the destination to convert a report to [PDF format](electronic-reporting-destinations.md#OutputConversionToPDF) that uses the **Landscape** page orientation.</span></span>
...
### <a name="run-a-format-from-the-application-to-preview-it-as-a-pdf-document"></a><a name="RunFormatFromApp3"></a><span data-ttu-id="29ea1-1015">Umożliwia uruchomienie formatu z aplikacji w celu wyświetlenia podglądu go jako dokumentu PDF</span><span class="sxs-lookup"><span data-stu-id="29ea1-1015">Run a format from the application to preview it as a PDF document</span></span>

1. <span data-ttu-id="29ea1-1016">Przejdź do **Kwestionariusz** \> **Projektowanie** \> **Raport z kwestionariuszy (zasilany przez ER)**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1016">Go to **Questionnaire** \> **Design** \> **Questionnaires report (powered by ER)**.</span></span>
2. <span data-ttu-id="29ea1-1017">W oknie dialogowym w polu **Mapowanie formatu** wybierz opcję **Raport kwestionariuszy**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1017">In the dialog box, in the **Format mapping** field, select **Questionnaires report**.</span></span>
3. <span data-ttu-id="29ea1-1018">Kliknij przycisk **OK**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1018">Select **OK**.</span></span>
4. <span data-ttu-id="29ea1-1019">W oknie dialogowym **Parametry raportu elektronicznego**, na skróconej karcie **Rekordy do uwzględnienia**, skonfiguruj opcję filtrowania tak, aby uwzględniony był tylko kwestionariusz **SBCCrsExam**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1019">In the **Electronic report parameters** dialog box, on the **Records to include** FastTab, configure the filtering option so that only the **SBCCrsExam** questionnaire is included.</span></span>
5. <span data-ttu-id="29ea1-1020">Wybierz przycisk **OK**, aby filtrować opcje.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1020">Select **OK** to confirm the filtering option.</span></span>

    <span data-ttu-id="29ea1-1021">Na skróconej karcie **Miejsca docelowe** zwróć uwagę, że pole **Dane wyjściowe** jest ustawione na **Ekran**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1021">On the **Destinations** FastTab, notice that the **Output** field is set to **Screen**.</span></span> <span data-ttu-id="29ea1-1022">Jeśli chcesz zmienić skonfigurowany cel, wybierz opcję **Zmień**.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1022">If you want to change the configured destination, select **Change**.</span></span>
...
6. <span data-ttu-id="29ea1-1024">Wybierz przycisk **OK**, aby uruchomić raport.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1024">Select **OK** to run the report.</span></span>
7. <span data-ttu-id="29ea1-1025">Przejrzyj wygenerowany raport w formacie PDF.</span><span class="sxs-lookup"><span data-stu-id="29ea1-1025">Review the generated report in PDF format.</span></span>

    ![Podgląd wygenerowanego raportu w formacie PDF na ekranie](./media/er-quick-start1-preview-PDF.png)

## <a name="additional-resources"></a><a name="References"></a><span data-ttu-id="29ea1-1027">Dodatkowe zasoby</span><span class="sxs-lookup"><span data-stu-id="29ea1-1027">Additional resources</span></span>

- [<span data-ttu-id="29ea1-1028">Raportowanie elektroniczne — omówienie</span><span class="sxs-lookup"><span data-stu-id="29ea1-1028">Electronic Reporting overview</span></span>](general-electronic-reporting.md)
- [<span data-ttu-id="29ea1-1029">Język formuł raportowania elektronicznego</span><span class="sxs-lookup"><span data-stu-id="29ea1-1029">Electronic reporting formula language</span></span>](er-formula-language.md)
- [<span data-ttu-id="29ea1-1030">Projektowanie raportów wielojęzycznych</span><span class="sxs-lookup"><span data-stu-id="29ea1-1030">Design multilingual reports</span></span>](er-design-multilingual-reports.md)
- [<span data-ttu-id="29ea1-1031">Interfejs API struktury modułu Raportowanie elektroniczne</span><span class="sxs-lookup"><span data-stu-id="29ea1-1031">ER framework API</span></span>](er-apis-app73.md)
- [<span data-ttu-id="29ea1-1032">Funkcja CASE</span><span class="sxs-lookup"><span data-stu-id="29ea1-1032">CASE function</span></span>](er-functions-logical-case.md)
- [<span data-ttu-id="29ea1-1033">Funkcja CONCATENATE</span><span class="sxs-lookup"><span data-stu-id="29ea1-1033">CONCATENATE function</span></span>](er-functions-text-concatenate.md)
- [<span data-ttu-id="29ea1-1034">Funkcja DATETIMEFORMAT</span><span class="sxs-lookup"><span data-stu-id="29ea1-1034">DATETIMEFORMAT function</span></span>](er-functions-datetime-datetimeformat.md)
- [<span data-ttu-id="29ea1-1035">Funkcja FILTER</span><span class="sxs-lookup"><span data-stu-id="29ea1-1035">FILTER function</span></span>](er-functions-list-filter.md)
- [<span data-ttu-id="29ea1-1036">Funkcja FIRSTORNULL</span><span class="sxs-lookup"><span data-stu-id="29ea1-1036">FIRSTORNULL function</span></span>](er-functions-list-firstornull.md)
- [<span data-ttu-id="29ea1-1037">Funkcja FORMAT</span><span class="sxs-lookup"><span data-stu-id="29ea1-1037">FORMAT function</span></span>](er-functions-text-format.md)
- [<span data-ttu-id="29ea1-1038">Funkcja IF</span><span class="sxs-lookup"><span data-stu-id="29ea1-1038">IF function</span></span>](er-functions-logical-if.md)
- [<span data-ttu-id="29ea1-1039">Funkcja ORDERBY</span><span class="sxs-lookup"><span data-stu-id="29ea1-1039">ORDERBY function</span></span>](er-functions-list-orderby.md)
- [<span data-ttu-id="29ea1-1040">Funkcja SESSIONNOW</span><span class="sxs-lookup"><span data-stu-id="29ea1-1040">SESSIONNOW function</span></span>](er-functions-datetime-sessionnow.md)

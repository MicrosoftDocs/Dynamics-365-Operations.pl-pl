...
W tym temacie opisano sposób wykrywania i usuwania problemów z wydajnością w [konfiguracjach](general-electronic-reporting.md#Configuration) [raportowania elektronicznego (ER)](general-electronic-reporting.md).

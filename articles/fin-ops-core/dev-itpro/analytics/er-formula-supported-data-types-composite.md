...
description: Ten artykuł zawiera ogólne informacje o funkcjach danych złożonych obsługiwanych w formułach Raportowania elektronicznego (ER).
author: kfend
ms.date: 06/02/2021
...
Ten artykuł zawiera ogólne informacje o funkcjach danych złożonych obsługiwanych w wyrażeniach [Raportowania elektronicznego (ER)](general-electronic-reporting.md). Typy danych złożonych to [klasa](#class), [kontener](#container), [rekord](#record), [lista rekordów](#record-list) i [obiekt](#object).

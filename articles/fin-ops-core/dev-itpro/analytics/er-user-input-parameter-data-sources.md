...
description: Ten temat wyjaśnia, jak używać źródeł danych USER INPUT PARAMETER do określania parametrów dla raportów, które generujesz.
author: NickSelin
ms.date: 04/20/2022
ms.topic: article
ms.prod: ''

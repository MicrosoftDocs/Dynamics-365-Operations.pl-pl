...
description: W tym artykule opisano, co się znajduje w pakiecie zawartości usługi Power BI Wyniki sprzedaży i rentowności.
author: Henrikan
ms.date: 12/18/2017
ms.topic: article
ms.prod: ''
...
W tym artykule opisano, co się znajduje w pakiecie zawartości **Wyniki sprzedaży i rentowności** usługi Microsoft Power BI. Wyjaśniono, jak uzyskać dostęp do raportów programu Power BI, oraz zamieszczono informacje o modelu danych i jednostkach użytych do zbudowania pakietu.

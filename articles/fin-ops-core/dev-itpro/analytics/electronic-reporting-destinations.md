...
> [!NOTE]
> Serwer usługi Simple Mail Transfer Protocol (SMTP) musi być skonfigurowany i dostępny. Serwer SMTP można określić w **Administrowanie systemem** &gt; **Ustawienia** &gt; **E-mail** &gt; **Parametry poczty e-mail**.
...
> [!NOTE]
> Można wybrać typ dokumentu dla archiwum zadań w **Administrowanie organizacją** &gt; **Obszary robocze** &gt; **Raportowanie elektroniczne** &gt; **Parametry raportowania elektronicznego**.

...
1. Aby skonfigurować połączenie podwójnego zapisywania między wystąpieniami Finance and Operations oraz z Common Data Service lub z inną aplikacją Dynamics 365, zaloguj się do aplikacji Finance and Operations jako administrator. 
...
4. Włącz mapowanie jednostki **Cdm_companies**. Spowoduje to zsynchronizowanie firm z poziomu aplikacji Finance and Operations do Common Data Service.  
    > [!div class="mx-imgBorder"]
...
6. Po zakończeniu inicjowania firmy i gdy system jest gotowy do synchronizacji na żywo, włącz mapowania jednostek.  

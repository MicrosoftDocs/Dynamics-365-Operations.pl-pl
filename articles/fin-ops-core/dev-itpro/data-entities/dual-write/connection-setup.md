...
---
# <a name="guidance-for-how-to-set-up-dual-write"></a>Wskazówki dotyczące konfigurowania podwójnego zapisu
...
Aby zapoznać się z przykładem i alternatywnym podejściem, zajrzyj do [Przykładu](#example).
...
Aby zapoznać się z przykładem, należy zapoznać się z formularzem [Włączanie odbiorcy v3 — Mapa encji kontaktów](enable-entity-map.md#example-enabling-the-customers-v3contacts-entity-map)

## <a name="product-default-order-settings-v2-to-msdyn_productspecificdefaultordersettings"></a>Ustawienia domyślne zamówień produktów (wersja 2) do msdyn_productspecificdefaultordersettings

...
Każda firma współpracuje z podstawowym zbiorem danych finansowych, na przykład w roku obrachunkowym, walucie, w której firma prowadzi działalność, na kontach, w których firma jest odpowiedzialna za działalność lub wychodzi z, stawek podatkowych i przekazów. Te dane znajdują się w aplikacjach Finance and Operations. Są one jednak dostępne dla Common Data Service, więc aplikacje oparte na modelu w Microsoft Dynamics 365 mogą mieć jedno źródło dla danych finansowych i podatkowych. W ten sposób dane są jednorodne w całym ekosystemie firmy. 

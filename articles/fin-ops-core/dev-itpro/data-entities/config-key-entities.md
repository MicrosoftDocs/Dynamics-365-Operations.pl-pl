...
description: W tym artykule opisano relację między kluczami konfiguracji i jednostkami danych.
author: peakerbl
ms.date: 05/10/2019
ms.topic: article
ms.prod: ''
...
Aby dowiedzieć się więcej o kluczach konfiguracji, zobacz [Raport kodów licencji i kluczy konfiguracji](../sysadmin/license-codes-configuration-keys-report.md).

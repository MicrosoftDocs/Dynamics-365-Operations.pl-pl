...
description: W tym artykule opisano, jak przeprowadzić import danych przy użyciu szablonów jednostki danych programu Excel do Finanse i Działania.
author: peakerbl
ms.date: 01/01/2018
ms.topic: article
ms.prod: ''

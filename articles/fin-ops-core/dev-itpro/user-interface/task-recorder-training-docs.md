...
description: W tym artykule wyjaśniono, czym jest Rejestrator zadań i przewodniki po zadaniach, jak tworzyć nagrania oraz jak dostosowywać przewodniki po zadaniach Microsoft i umieszczać je w pomocy.
author: jasongre
ms.date: 03/24/2020
ms.topic: article
ms.prod: ''
...
W tym artykule wyjaśniono, czym jest Rejestrator zadań i przewodniki po zadaniach, jak tworzyć nagrania zadań oraz jak dostosowywać przewodniki po zadaniach Microsoft i umieszczać je w Pomocy.

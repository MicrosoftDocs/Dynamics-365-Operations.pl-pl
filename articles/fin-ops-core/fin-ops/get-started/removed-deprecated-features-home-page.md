...
ms.locfileid: "5574372"
---
# <a name="removed-or-deprecated-features-home-page"></a>Usunięte lub wycofane funkcje na stronie głównej

[!include[banner](../includes/banner.md)]

## <a name="removed-or-deprecated-features-in-finance-and-operations-apps"></a>Usunięte lub wycofane funkcje w aplikacji Finance and Operations
Poniższe tematy zawierają informacje dotyczące usuniętych lub przestarzałych funkcji aplikacji Finance and Operations:

- [Usunięte lub przestarzałe funkcje w rozwiązaniu Dynamics 365 Commerce](../../../commerce/get-started/removed-deprecated-features-commerce.md)
...
Poniższy temat zawiera informacje o przestarzałych elementach w Microsoft Power Platform:

- [Nadchodzą ważne zmiany (przestarzałe elementy) oraz Power Apps, Power Automate i aplikacje dotyczące relacji z klientami](https://docs.microsoft.com/power-platform/important-changes-coming)

...
description: Ten artykuł przedstawia listę przewodników po zadaniach, które znajdują się bibliotekach narzędzia Microsoft BPM według stanu na koniec lutego 2016 r.
author: josaw1
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8861742"
---
# <a name="new-task-guides-february-2016"></a>Nowe przewodniki po zadaniach (luty 2016 r.)

[!include [banner](../includes/banner.md)]

Ten artykuł przedstawia listę przewodników po zadaniach, które znajdują się bibliotekach narzędzia Microsoft BPM według stanu na koniec lutego 2016 r. Są tu ujednolicone biblioteki APQC (z lutego 2016 r.) dla systemu Microsoft Dynamics AX oraz biblioteki ułatwiające rozpoczęcie pracy (z lutego 2016 r.).
...
| Księgowanie faktury niezależnej z dokumentem płatności                                                           | Dania                         |
| Księgowanie faktury projektu z dokumentem płatności                                                             | Dania                         |
| Księgowanie faktury sprzedaży z dokumentem płatności                                                               | Dania                         |
...
| Konfigurowani formatu dokumentu płatności dla faktur projektu                                                         | Dania                         |
| Tworzenie i eksport płatności dostawcy przy użyciu formatu płatności SEPA                                          | Europa                          |
...
| Importowanie konfiguracji polecenia przelewu SEPA                                                              | Europa                          |
| Importowanie konfiguracji polecenia zapłaty SEPA                                                                 | Europa                          |
| Konfigurowanie kont bankowych firmy dla poleceń przelewu SEPA                                                 | Europa                          |
| Konfigurowanie kont bankowych firmy dla poleceń zapłaty SEPA                                                    | Europa                          |
| Konfigurowanie odbiorców i kont bankowych odbiorców dla poleceń zapłaty SEPA                                     | Europa                          |
| Konfigurowanie metody płatności przelewu SEPA                                                      | Europa                          |
| Konfigurowanie metody płatności polecenia zapłaty SEPA                                                         | Europa                          |
| Konfigurowanie dostawców i kont bankowych dostawców dla poleceń przelewu SEPA                                      | Europa                          |
| FR-00002 Wyciągi z kont odbiorców i dostawców                                                        | Francja                          |
...
| Tworzenie konta odbiorcy i dołączanie deklaracji na fakturze                                             | Islandia                         |
| IS-00005 Raport uzgodnienia VAT                                                                     | Islandia                         |
| Konfigurowanie deklaracji faktury od dostawcy                                                              | Islandia                         |
| Konfigurowanie obowiązkowych odwołań do płatności                                                                    | Islandia                         |
| Aktualizowanie deklaracji faktury od dostawcy i generowanie raportu                                             | Islandia                         |
| Nabycie środka trwałego ze zobowiązaniami do wycofania środków trwałych                                                | Japonia                           |
| Nabycie środków trwałych, roszczenia dotacji rządowych i rozliczenie wpisu redukcji                         | Japonia                           |
...
| Zmienianie metody amortyzacji w trakcie użytkowania środka trwałego dla modelu wartości                                   | Japonia                           |
...
| Tworzenie profilu amortyzacji przyspieszonej i przypisanie go do modelu ewidencji                                   | Japonia                           |
...
| Tworzenie i potwierdzanie skonsolidowanej faktury odbiorcy                                                     | Japonia                           |
...
| Tworzenie trwałych amortyzacji ryczałtu metodą równego podziału                                       | Japonia                           |
...
| Rozliczanie skonsolidowanych faktur dla odbiorcy przy użyciu transakcji rozliczania                                     | Japonia                           |
...
| MY-00010 GST — Generowanie plików GAF w wymaganym formacie                                               | Singapur, Malezja i Tajlandia |
...
| GB-00002 Tworzenie zamówienia zakupu zawierającego towary podlegające zwrotowi podatku VAT                     | Zjednoczone Królestwo                  |
| GB-00002 Tworzenie zamówienia sprzedaży zawierającego towary podlegające podatkowi VAT od opłaty zwrotnej                        | Zjednoczone Królestwo                  |
| GB-00002 Konfigurowanie grup podatków dla towaru dla opłaty zwrotnej VAT                                           | Zjednoczone Królestwo                  |
...
| Wprowadzenie do funkcji lokalizacji systemu AX      | Globalna         |

...
Aby zasubskrybować kanał RSS wszystkich aktualizacji zawartości dokumentacji technicznej Microsoft Docs w aplikacjach finansowych i operacyjnych, użyj następującego łącza:
...
- [Łańcuch dostaw](/api/search/rss?$filter=scopes%2fany(t%3A%20t%20eq%20%27dynamics365-supplychain%27)&locale=en-us)  
- [Zarządzanie umiejętnościami](/api/search/rss?$filter=scopes%2fany(t%3A%20t%20eq%20%27dynamics365-talent%27)&locale=en-us)  

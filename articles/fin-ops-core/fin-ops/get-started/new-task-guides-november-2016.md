...
| \*Sprawdzanie ciągłości załącznika (Chiny)                                                                                               | Chiny                             |
...
| Wiersz BPM                                                     | Kraj/region |
|--------------------------------------------------------------|----------------|
| \*Dodawanie do swojego arkusza wydajności i wysyłanie pochwały innej osobie | Globalna         |
...
| \*Tworzenie konwencji nazewnictwa identyfikatorów produktów dla wstępnie zdefiniowanych wariantów produktu | Globalna         |
| \*Tworzenie konwencji nazewnictwa identyfikatorów produktów dla skonfigurowanych wariantów produktu | Globalna         |
...
| \*Tworzenie elementu menu urządzenia przenośnego dla konsolidacji na podstawie numerów identyfikacyjnych          | Globalna         |
...
| \*Konfigurowanie zmiany alokacji pozycji na potrzeby pobierania w niedomiarze                                    | Globalne         |

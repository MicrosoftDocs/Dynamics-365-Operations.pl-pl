...
description: W tym artykule wyjaśniono, jak utworzyć przepływ pracy.
author: ChrisGarty
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
...
3. Wykonaj procedury opisane w artykule [Konfigurowanie właściwości przepływu pracy](configure-workflow-properties.md).

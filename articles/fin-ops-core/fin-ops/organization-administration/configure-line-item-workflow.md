...
description: W tym artykule wyjaśniono sposób konfigurowania elementu przepływu pracy dla pozycji w wierszu.
author: ChrisGarty
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
...
W tym artykule wyjaśniono sposób konfigurowania elementu przepływu pracy dla pozycji w wierszu.

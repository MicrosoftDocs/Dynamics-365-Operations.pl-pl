...
description: W tym artykule wyjaśniono sposób konfigurowania różnych właściwości przepływu pracy.
author: ChrisGarty
ms.date: 07/07/2020
ms.topic: article
ms.prod: ''
...
W tym artykule wyjaśniono sposób konfigurowania różnych właściwości przepływu pracy.

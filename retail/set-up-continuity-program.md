...
3.  Tworzenie produktu nadrzędnego, który reprezentuje program ciągłości, który został utworzony w zadaniu 2. Po dodaniu tego produktu do zamówienia sprzedaży, **ciągłość** otwierania strony. Tej strony można następnie użyć do tworzenia rzeczywistego zamówienia sprzedaży ciągłej. Produkt nadrzędny nie określa poszczególnych produktów, które użytkownik otrzymuje w każdej wysyłce.

...
Następujące trzy produkty są ściśle związane ze sobą:

- Microsoft Dynamics 365 for Finance and Operations Enterprise Edition
- Microsoft Dynamics 365 for Retail
- Microsoft Dynamics 365 for Talent

Te same funkcje mogą być dostępne we wszystkich trzech produktach. W związku z tym w tematach związanych głównie z rozwiązaniem Retail będzie używana nazwa produktu Microsoft Dynamics 365 for Retail. W tematach związanych głównie z rozwiązaniem Talent będzie używana nazwa produktu Microsoft Dynamics 365 for Talent. I wreszcie w tematach związanych z podstawowym produktem (Finance and Operations) będzie używana nazwa produktu Microsoft Dynamics 365 for Finance and Operations Enterprise Edition. Tematów, które zostały napisane dla jednego produktu, można używać w odniesieniu do tych samych funkcji w powiązanym produkcie.
...
## <a name="workforce-management"></a>Zarządzanie pracownikami
Aby zachować rentowność w świecie malejących marż, sprzedawcy detaliczni ciągle starają się zmniejszać koszty operacyjne. Dla większości sprzedawców detalicznych koszty związane z pracownikami sklepów stanowią znaczną część kosztów operacyjnych. Dlatego utrzymanie pod kontrolą tego kosztu umożliwia sprzedawcom detalicznym znaczną poprawę wyników. Ponadto dobrze wyposażeni i produktywni pracownicy sami starają się podnosić poziom obsługi klienta.

Rozwiązanie Retail umożliwia menedżerom sklepów tworzenie i publikowanie zmian i harmonogramów dla pracowników sklepów, dołączanie do zmian adnotacji z instrukcjami i kopiowanie harmonogramów z zeszłego tygodnia do bieżącego tygodnia. Ponadto menedżerowie mają wgląd w przesyłane przez pracowników sklepów detalicznych wnioski dotyczące nieobecności i mogą zatwierdzać lub odrzucać te wnioski. Mają także wgląd w żądania „zamiany zmiany” i „oferty zmiany” i także mogą zatwierdzać lub odrzucać te wnioski.

Pracownicy sklepu mają wgląd w zmiany i przypisane harmonogramy, wraz z instrukcjami dotyczącymi zmian, a także widzą, którzy ze współpracowników są przypisani do poszczególnych zmian. Mogą także przesyłać wnioski dotyczące nieobecności, żądania zamiany zmiany ze współpracownikami oraz żądania ofert zmian.
...
- [Rozwiązanie Microsoft Dynamics 365 for Retail dla programistów i profesjonalistów IT](/dynamics365/unified-operations/dev-itpro/dev-tools/developer-home-page)

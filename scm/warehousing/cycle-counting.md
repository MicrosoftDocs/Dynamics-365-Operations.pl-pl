...
Istnieje kilka metod przetwarzania pracy inwentaryzacji ciągłej za pomocą programu Dynamics 365 for Operations na urządzeniu przenośnym:

-   **Sterowane przez użytkownika** ─ Pracownik może określić identyfikator pracy inwentaryzacji ciągłej mającej stan **Otwarte**.
-   **Sterowane przez system** — Program Dynamics 365 for Operations przypisuje identyfikator pracy inwentaryzacji ciągłej do pracownika.

...
description: "W tym temacie opisano podstawowe pojęcia i terminy, które należy poznać, aby skonfigurować i używać sterowania produkcją."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
W tym temacie opisano podstawowe pojęcia i terminy, które należy poznać, aby skonfigurować i używać sterowania produkcją. 

Uruchomienie produkcji jest przeznaczone głównie do użycia przez firmy produkcyjne. Pracownicy mogą rejestrować czas i zużycie towarów dla zadań produkcji przy użyciu strony **Rejestracja zadania**. Wszystkie rejestracje zostały zatwierdzone, a później są przenoszone do odpowiednich modułów. Ciągłe zatwierdzanie i przenoszenie rejestracji pozwala menedżerom łatwo śledzić koszty rzeczywiste w zleceniach produkcyjnych.
...
| Okres                          | opis                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Wykonywanie produkcji       | Funkcja, która jest używana do rejestrowania czasu, zużycie materiałów, koszty zadań produkcyjnych, projektów i działań pośrednich. Rejestracja jest wykonywana w kliencie rejestracji uruchomienia produkcji.                                                                                                                                                                                                                                                                                                                                                                                                   |
...
-   **Rejestrowanie opłat w ramach projektu i elementy projektu** (dostępne z modułu Czas i frekwencja) – pracowników można zarejestrować opłaty (koszty), które są skojarzone z projektem w arkusz opłat projektu, takie jak przebieg i Mostek opłat drogowych. Pracowników można również zarejestrować zużycie towarów w projektach. Jest to wykonywane w arkuszu towarów projektu.

...
Do wykonania Lean manufacturing dla systemu Dynamics AX wybieramy podejście produkcji przepływu i działania, który umożliwia produkcji prostych i złożonych scenariuszy modeluje się w pojedynczej, skalowalnej architekturze. Bliżej przyjrzeć się pojęcia działalności ujawnia nowe proste dla tych użytkowników, którzy go potrzebują: produkcją i logistyki pracowników. Dzięki funkcji raportowania według zadań opartych na działaniach zamiast na transakcjach magazynowych, jednolity interfejs użytkownika dla wszystkich rodzajów modelu Lean Manufacturing przenoszą złożoność biznesową z interfejsu użytkownika tam gdzie jest jej miejsce: do przepływu produkcji jako podstawy Lean Manufacturing.

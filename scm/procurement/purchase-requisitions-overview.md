...
W tym artykule opisano przepływ pracy zapotrzebowania na zakup oraz różne stany, jakie może przyjmować zapotrzebowanie na zakup.
...
Zanim prześlesz zapotrzebowania na zakupu do przeglądu, przepływy pracy muszą zostać skonfigurowany w programie Microsoft Dynamics 365 for Operations. Przepływ pracy jest używany do przenoszenia zapotrzebowania na zakup przez proces przeglądu, z początkowego stanu **Wersja robocza**do stanu finalnego **Zatwierdzono**.
...
[![Nagłówek zapotrzebowania na zakup i Stanów](./media/purchasereq_headerline_statuses.jpg)](./media/purchasereq_headerline_statuses.jpg)
...
<td>Wersja robocza</td>
<td>Zapotrzebowanie na zakup i wiersz zapotrzebowania na zakup zostały utworzone, ale nie zostały przesłane do przeglądu. Zapotrzebowania na zakup i wiersze zapotrzebowania, które znajdują się w stanie <strong>Wersja robocza</strong> mogą być modyfikowane. Zapotrzebowanie na zakup lub wiersz zapotrzebowania na zakup ma również stan <strong>Wersja robocza</strong>, jeśli zostały wycofane, ale nie zostały ponownie przesłane do przeglądu. <strong>Uwaga:</strong> zapotrzebowania na zakup można przesyłać lub wycofywać na poziomie dokumentu. Jednak nie można przesłać ani wycofać pojedynczego wiersza zapotrzebowania na zakup.</td>
</tr>
<tr class="even">
...
<li><strong>Odrzucone</strong> – wiersza zapotrzebowania na zakup został odrzucony. Wiersze zapotrzebowania zakupu, które zostały odrzucone mogą być modyfikowane i ponownie przesłany.</li>
</ul>
...
Cele zapotrzebowania uelastyczniają proces wypełniania zapotrzebowań. Podczas tworzenia zapotrzebowania można przypisać mu jeden z dwóch celów: zużycie lub uzupełnienie. W zależności od celu zapotrzebowania i ustawieniach organizacji zapotrzebowanie na żądanie mogą być spełnione przez zamówienie zakupu, zlecenie przesunięcia, zlecenie produkcyjne lub kanban.  
...
Zapotrzebowanie, którego celem jest zużycie, reprezentuje popyt na towary lub usługi, które będą używane wewnętrznie przez organizację. Popyt, który jest tworzony przez ten rodzaj zapotrzebowania, zawsze jest zaspokajany przez zamówienie zakupu. Jeśli program Microsoft Dynamics 365 for Operations jest skonfigurowany do automatycznego generowania zamówień zakupu, zamówienia zakupu są tworzone po zatwierdzeniu zapotrzebowania na zakup.
...
Można umieścić zapotrzebowania na zakup wstrzymane przez zaznaczenie **wstrzymane** pole wyboru na **szczegóły zapotrzebowania na zakup** strony. Przetwarzanie zapotrzebowania na zakup można kontynuować dopiero po usunięciu blokady przez wyczyszczenie pola wyboru.  
...
[![Przebieg procesu konsolidacji popytu](./media/demand-consolidation.gif)](./media/demand-consolidation.gif)  

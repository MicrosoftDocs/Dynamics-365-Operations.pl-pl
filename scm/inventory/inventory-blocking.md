...
## Blokując towary poprzez tworzenie zlecenia kontroli jakości
...
## Blokując towary za pomocą procesu, który generuje zlecenia kontroli jakości.
...
## przez blokowanie towarów za pomocą blokowania stanu magazynu

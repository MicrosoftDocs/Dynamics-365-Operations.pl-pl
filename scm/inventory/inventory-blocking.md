...
description: "Ten artykuł zawiera omówienie mechanizmu blokowania zapasów, który jest częścią procesu kontroli jakości w systemie Microsoft Dynamics AX. Używając blokowania, można zapobiec przetwarzaniu i zużywaniu zapasów."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article

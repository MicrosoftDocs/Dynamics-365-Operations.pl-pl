...
## <a name="2-review-and-change-the-new-costing-version-for-the-conversion-record"></a>2. Przejrzyj i zmień nowej wersji wyceny dla rekordu konwersji
...
## <a name="3-identify-the-items-to-convert-to-standard-cost"></a>3. zidentyfikować elementy do konwersji na koszt standardowy
...
## <a name="4-enter-or-calculate-the-pending-standard-cost-for-each-item-that-is-being-converted"></a>4. Wpisz lub obliczyć oczekujące cenę ewidencyjną dla każdego elementu, który jest konwertowany
...
## <a name="5-check-and-resolve-any-issues-for-the-items-that-are-being-converted"></a>5. Sprawdź i rozwiąż wszelkie problemy dla elementów, które są konwertowana
...
## <a name="6-change-the-status-of-the-conversion-record-to-ready"></a>6. Zmień stan rekordu konwersji gotowości
...
## <a name="7-back-up-the-database-before-conversion"></a>7. Wykonaj kopię zapasową bazy danych przed konwersją
Kopia zapasowa pozwoli przywrócić bazę danych w przypadku wystąpienia błędów w procesie konwersji.

## <a name="8-perform-the-conversion-when-the-conversion-record-has-a-ready-status"></a>8. wykonać konwersji, gdy rekordu konwersji znajduje się w stanie gotowości
...
## <a name="9-validate-and-reconcile-the-inventory-values-for-the-converted-items"></a>9. Sprawdź poprawność i uzgodnić wartości zapasów dla towarów konwertowanych

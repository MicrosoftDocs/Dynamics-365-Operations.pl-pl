---
title: "Konfigurowanie produktów, które mogą być produkowane lub zamówione"
description: "Produkty mogą być pozyskiwany na różne sposoby — mogą być produkowane (wyprodukowanych) lub zamówione (zakupione). W tym artykule opisano niektóre typowe kwestie do rozważenia podczas konfigurowania dla produktów obsługi pozyskiwania z wielu źródeł."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="set-up-products-that-can-be-produced-or-procured"></a>Konfigurowanie produktów, które mogą być produkowane lub zamówione

Produkty mogą być pozyskiwany na różne sposoby — mogą być produkowane (wyprodukowanych) lub zamówione (zakupione). W tym artykule opisano niektóre typowe kwestie do rozważenia podczas konfigurowania dla produktów obsługi pozyskiwania z wielu źródeł. 

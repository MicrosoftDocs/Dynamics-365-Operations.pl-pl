...
-   Upewnij się, że **obsługiwana liczba miejsc dziesiętnych** jednostki miary jest zgodna z wymaganiami określonymi w mapowaniu **CDS -\> Miejsce docelowe**. Jeśli wymagane są różne wartości dla różnych jednostek miary, można to zrobić za pomocą **mapy wartości** z ustawienia Jednostka, na przykład [Sztuka: 0] i [Funt: 2].

    -   Wartość domyślna w szablonie to 0.
